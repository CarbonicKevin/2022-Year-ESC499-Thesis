...
set design_name rfsoc_sam_16384
...
xilinx.com:ip:SpectrumAnalyser16384:1.1\
...
proc create_hier_cell_channel_20 { parentCell nameHier } {
  ...
  set spectrum_analyser [ create_bd_cell -type ip -vlnv xilinx.com:ip:SpectrumAnalyser16384:1.1 spectrum_analyser ]

  # Create interface connections
  connect_bd_intf_net -intf_net AXI4_Lite_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins axi_interconnect/S00_AXI]
  connect_bd_intf_net -intf_net SpectrumAnalyser16384_0_AXI4_Master [get_bd_intf_pins M_AXI] [get_bd_intf_pins spectrum_analyser/AXI4_Master]
...
proc create_hier_cell_radio { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net SpectrumAnalyser16384_AXI4_Master [get_bd_intf_pins M_AXI] [get_bd_intf_pins receiver/M_AXI]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net SpectrumAnalyser16384_AXI4_Master [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins radio/M_AXI]
