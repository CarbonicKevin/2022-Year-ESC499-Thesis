-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_src_SDFCommutator3.vhd
...
ENTITY SpectrumAnalyser8192_src_SDFCommutator3 IS
...
END SpectrumAnalyser8192_src_SDFCommutator3;


ARCHITECTURE rtl OF SpectrumAnalyser8192_src_SDFCommutator3 IS
...
BEGIN
  u_dataXMEM_re_0_3 : SpectrumAnalyser8192_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_3 : SpectrumAnalyser8192_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 19
                 )
    PORT MAP( clk => clk,
