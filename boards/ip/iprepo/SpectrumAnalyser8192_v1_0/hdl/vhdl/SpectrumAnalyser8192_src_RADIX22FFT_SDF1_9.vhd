-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_src_RADIX22FFT_SDF1_9.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_src_RADIX22FFT_SDF1_9
...
ENTITY SpectrumAnalyser8192_src_RADIX22FFT_SDF1_9 IS
...
END SpectrumAnalyser8192_src_RADIX22FFT_SDF1_9;


ARCHITECTURE rtl OF SpectrumAnalyser8192_src_RADIX22FFT_SDF1_9 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser8192_src_Complex4Multiply_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser8192_src_SDFCommutator9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_9_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser8192_src_Complex4Multiply_block2
    USE ENTITY work.SpectrumAnalyser8192_src_Complex4Multiply_block2(rtl);
  ...
  FOR ALL : SpectrumAnalyser8192_src_SDFCommutator9
    USE ENTITY work.SpectrumAnalyser8192_src_SDFCommutator9(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser8192_src_Complex4Multiply_block2
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_9 : SpectrumAnalyser8192_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_9 : SpectrumAnalyser8192_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 25
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_9 : SpectrumAnalyser8192_src_SDFCommutator9
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_9_vld_dly => din_9_vld_dly,
