-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_src_TWDLROM_13_1.vhd
...
ENTITY SpectrumAnalyser8192_src_TWDLROM_13_1 IS
...
END SpectrumAnalyser8192_src_TWDLROM_13_1;


ARCHITECTURE rtl OF SpectrumAnalyser8192_src_TWDLROM_13_1 IS
  ...
  SIGNAL twdl_13_re_tmp                   : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_13_im_tmp                   : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    IF (dout_12_1_vld AND hdlcoder_to_stdlogic(Radix22TwdlMapping_cnt > to_unsigned(16#3FF#, 11))) = '1' THEN 
      Radix22TwdlMapping_phase_next <= Radix22TwdlMapping_phase + to_unsigned(16#1#, 2);
    END IF;
    IF dout_12_1_vld = '1' THEN 
      Radix22TwdlMapping_cnt_next <= Radix22TwdlMapping_cnt + to_unsigned(16#400#, 11);
    END IF;
  ...
  BEGIN
    ...
    ELSE 
      ...
      END CASE;
    END IF;
    twdl_13_re_tmp <= twdlIn_re;
    twdl_13_im_tmp <= twdlIn_im;
  END PROCESS Radix22TwdlOctCorr_output;


  twdl_13_re <= std_logic_vector(twdl_13_re_tmp);

  twdl_13_im <= std_logic_vector(twdl_13_im_tmp);
