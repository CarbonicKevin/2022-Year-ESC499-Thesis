-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_src_RADIX22FFT_SDF1_13.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_src_RADIX22FFT_SDF1_13
...
ENTITY SpectrumAnalyser8192_src_RADIX22FFT_SDF1_13 IS
...
END SpectrumAnalyser8192_src_RADIX22FFT_SDF1_13;


ARCHITECTURE rtl OF SpectrumAnalyser8192_src_RADIX22FFT_SDF1_13 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser8192_src_Complex4Multiply_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser8192_src_SDFCommutator13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_13_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser8192_src_Complex4Multiply_block4
    USE ENTITY work.SpectrumAnalyser8192_src_Complex4Multiply_block4(rtl);

  FOR ALL : SpectrumAnalyser8192_src_SDFCommutator13
    USE ENTITY work.SpectrumAnalyser8192_src_SDFCommutator13(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser8192_src_Complex4Multiply_block4
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_13 : SpectrumAnalyser8192_src_SDFCommutator13
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_13_vld_dly => din_13_vld_dly,
