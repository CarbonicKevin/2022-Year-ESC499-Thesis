-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_src_RADIX22FFT_SDF1_5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_src_RADIX22FFT_SDF1_5
...
ENTITY SpectrumAnalyser8192_src_RADIX22FFT_SDF1_5 IS
...
END SpectrumAnalyser8192_src_RADIX22FFT_SDF1_5;


ARCHITECTURE rtl OF SpectrumAnalyser8192_src_RADIX22FFT_SDF1_5 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser8192_src_Complex4Multiply_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser8192_src_SDFCommutator5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_5_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser8192_src_Complex4Multiply_block
    USE ENTITY work.SpectrumAnalyser8192_src_Complex4Multiply_block(rtl);
  ...
  FOR ALL : SpectrumAnalyser8192_src_SDFCommutator5
    USE ENTITY work.SpectrumAnalyser8192_src_SDFCommutator5(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser8192_src_Complex4Multiply_block
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_5 : SpectrumAnalyser8192_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_5 : SpectrumAnalyser8192_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 21
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_5 : SpectrumAnalyser8192_src_SDFCommutator5
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_5_vld_dly => din_5_vld_dly,
