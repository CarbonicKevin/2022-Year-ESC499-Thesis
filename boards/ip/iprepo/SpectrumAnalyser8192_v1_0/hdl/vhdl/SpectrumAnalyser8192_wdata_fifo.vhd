-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_wdata_fifo.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_wdata_fifo
-- Source Path: SpectrumAnalyser8192/SpectrumAnalyser8192_axi4_master_wr/SpectrumAnalyser8192_wdata_fifo
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser8192_wdata_fifo IS
...
END SpectrumAnalyser8192_wdata_fifo;


ARCHITECTURE rtl OF SpectrumAnalyser8192_wdata_fifo IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser8192_SimpleDualPortRAM_generic
  ...
  FOR ALL : SpectrumAnalyser8192_SimpleDualPortRAM_generic
    USE ENTITY work.SpectrumAnalyser8192_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_SpectrumAnalyser8192_wdata_fifo_classic_ram : SpectrumAnalyser8192_SimpleDualPortRAM_generic
