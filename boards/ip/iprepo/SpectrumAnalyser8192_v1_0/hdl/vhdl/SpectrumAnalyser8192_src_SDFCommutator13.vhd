-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_src_SDFCommutator13.vhd
...
ENTITY SpectrumAnalyser8192_src_SDFCommutator13 IS
...
END SpectrumAnalyser8192_src_SDFCommutator13;


ARCHITECTURE rtl OF SpectrumAnalyser8192_src_SDFCommutator13 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser8192_src_SimpleDualPortRAM_generic
  ...
  FOR ALL : SpectrumAnalyser8192_src_SimpleDualPortRAM_generic
    USE ENTITY work.SpectrumAnalyser8192_src_SimpleDualPortRAM_generic(rtl);

  -- Signals
  SIGNAL xf_re_signed                     : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL xf_im_signed                     : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL dinXTwdlf_re_signed              : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL dinXTwdlf_im_signed              : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL btf1_re_signed                   : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL btf1_im_signed                   : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL btf2_re_signed                   : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL btf2_im_signed                   : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL SDFCummutator_out_re             : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFCummutator_out_im             : signed(28 DOWNTO 0);  -- sfix29
  ...
  SIGNAL SDFCummutator_wrData_re_reg      : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFCummutator_wrData_im_reg      : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFCummutator_wrEnb_reg          : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg     : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFCummutator_wrXData_im_reg     : signed(28 DOWNTO 0);  -- sfix29
  ...
  SIGNAL SDFCummutator_btf1_re_dly        : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFCummutator_btf1_im_dly        : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFCummutator_btf1_vld_dly       : std_logic;
  SIGNAL SDFCummutator_out_re_next        : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL SDFCummutator_out_im_next        : signed(28 DOWNTO 0);  -- sfix29_En15
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(28 DOWNTO 0);  -- sfix29_En15
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL SDFCummutator_btf1_vld_dly_next  : std_logic;
  SIGNAL wrData_re_tmp                    : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL wrData_im_tmp                    : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL xData_re                         : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL xData_im                         : signed(28 DOWNTO 0);  -- sfix29_En15
  ...
  SIGNAL dout0_re                         : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL dout0_im                         : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(28 DOWNTO 0);  -- ufix29
  SIGNAL xX_re_signed                     : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL xX_im                            : std_logic_vector(28 DOWNTO 0);  -- ufix29
  SIGNAL xX_im_signed                     : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL SDFOutmux_btf2Pipe_re            : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFOutmux_btf2Pipe_im            : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL SDFOutmux_btfPipe_vld            : std_logic;
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_13_re_tmp                   : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL dout_13_im_tmp                   : signed(28 DOWNTO 0);  -- sfix29_En15

BEGIN
  u_dataXMEM_re_0_13 : SpectrumAnalyser8192_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_13 : SpectrumAnalyser8192_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 29
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      SDFCummutator_out_re <= to_signed(16#00000000#, 29);
      SDFCummutator_out_im <= to_signed(16#00000000#, 29);
      SDFCummutator_wrData_re_reg <= to_signed(16#00000000#, 29);
      SDFCummutator_wrData_im_reg <= to_signed(16#00000000#, 29);
      SDFCummutator_wrEnb_reg <= '0';
      SDFCummutator_out_vld <= '0';
      SDFCummutator_wrState <= to_unsigned(16#0#, 3);
      SDFCummutator_wrAddr_reg <= '0';
      SDFCummutator_wrXData_re_reg <= to_signed(16#00000000#, 29);
      SDFCummutator_wrXData_im_reg <= to_signed(16#00000000#, 29);
      ...
      SDFCummutator_btf1_re_dly <= to_signed(16#00000000#, 29);
      SDFCummutator_btf1_im_dly <= to_signed(16#00000000#, 29);
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      ...
      WHEN "100" =>
        ...
        END IF;
      WHEN OTHERS => 
        SDFCummutator_wrXData_re_reg_next <= to_signed(16#00000000#, 29);
        SDFCummutator_wrXData_im_reg_next <= to_signed(16#00000000#, 29);
        SDFCummutator_xWrAddr_next <= to_unsigned(16#0#, 3);
        SDFCummutator_xRdAddr_next <= to_unsigned(16#0#, 3);
        SDFCummutator_wrxEnb_reg_next <= '0';
        SDFCummutator_XState_next <= to_unsigned(16#0#, 3);
  ...
  BEGIN
    IF reset = '1' THEN
      SDFOutmux_btf2Pipe_re <= to_signed(16#00000000#, 29);
      SDFOutmux_btf2Pipe_im <= to_signed(16#00000000#, 29);
  ...
  BEGIN
    ...
    END IF;
    dout_13_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_13_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_13_vld <= SDFOutmux_btfPipe_vld;
