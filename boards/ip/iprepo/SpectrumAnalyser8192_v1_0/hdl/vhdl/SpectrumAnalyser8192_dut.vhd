-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_dut
-- Source Path: SpectrumAnalyser8192/SpectrumAnalyser8192_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser8192_dut IS
...
END SpectrumAnalyser8192_dut;


ARCHITECTURE rtl OF SpectrumAnalyser8192_dut IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser8192_src_Spectrum_Analyser
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser8192_src_Spectrum_Analyser
    USE ENTITY work.SpectrumAnalyser8192_src_Spectrum_Analyser(rtl);
...
BEGIN
  u_SpectrumAnalyser8192_src_Spectrum_Analyser : SpectrumAnalyser8192_src_Spectrum_Analyser
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
