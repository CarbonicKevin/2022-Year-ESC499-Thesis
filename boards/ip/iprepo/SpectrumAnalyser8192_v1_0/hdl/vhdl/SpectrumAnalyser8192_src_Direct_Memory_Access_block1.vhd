-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_src_Direct_Memory_Access_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_src_Direct_Memory_Access_block1
...
ENTITY SpectrumAnalyser8192_src_Direct_Memory_Access_block1 IS
...
END SpectrumAnalyser8192_src_Direct_Memory_Access_block1;


ARCHITECTURE rtl OF SpectrumAnalyser8192_src_Direct_Memory_Access_block1 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser8192_src_EdgeDetection
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser8192_src_DDR_Read_Controller
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser8192_src_EdgeDetection
    USE ENTITY work.SpectrumAnalyser8192_src_EdgeDetection(rtl);

  FOR ALL : SpectrumAnalyser8192_src_DDR_Read_Controller
    USE ENTITY work.SpectrumAnalyser8192_src_DDR_Read_Controller(rtl);
...
BEGIN
  u_EdgeDetection : SpectrumAnalyser8192_src_EdgeDetection
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_DDR_Read_Controller : SpectrumAnalyser8192_src_DDR_Read_Controller
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
