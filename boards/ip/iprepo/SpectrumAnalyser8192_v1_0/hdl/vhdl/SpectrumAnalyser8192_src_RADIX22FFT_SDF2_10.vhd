-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_src_RADIX22FFT_SDF2_10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_src_RADIX22FFT_SDF2_10
...
ENTITY SpectrumAnalyser8192_src_RADIX22FFT_SDF2_10 IS
...
END SpectrumAnalyser8192_src_RADIX22FFT_SDF2_10;


ARCHITECTURE rtl OF SpectrumAnalyser8192_src_RADIX22FFT_SDF2_10 IS
  ...
  COMPONENT SpectrumAnalyser8192_src_SDFCommutator10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_9_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser8192_src_SDFCommutator10
    USE ENTITY work.SpectrumAnalyser8192_src_SDFCommutator10(rtl);
...
BEGIN
  u_dataMEM_im_0_10 : SpectrumAnalyser8192_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_10 : SpectrumAnalyser8192_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 26
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_10 : SpectrumAnalyser8192_src_SDFCommutator10
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
