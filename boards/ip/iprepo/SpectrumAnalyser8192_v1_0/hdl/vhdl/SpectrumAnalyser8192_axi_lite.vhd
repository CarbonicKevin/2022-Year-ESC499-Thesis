-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_axi_lite
-- Source Path: SpectrumAnalyser8192/SpectrumAnalyser8192_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser8192_axi_lite IS
...
END SpectrumAnalyser8192_axi_lite;


ARCHITECTURE rtl OF SpectrumAnalyser8192_axi_lite IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser8192_addr_decoder
  ...
  COMPONENT SpectrumAnalyser8192_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : SpectrumAnalyser8192_addr_decoder
    USE ENTITY work.SpectrumAnalyser8192_addr_decoder(rtl);

  FOR ALL : SpectrumAnalyser8192_axi_lite_module
    USE ENTITY work.SpectrumAnalyser8192_axi_lite_module(rtl);
...
BEGIN
  u_SpectrumAnalyser8192_addr_decoder_inst : SpectrumAnalyser8192_addr_decoder
  ...
  u_SpectrumAnalyser8192_axi_lite_module_inst : SpectrumAnalyser8192_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
