-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_src_TWDLROM_7_1.vhd
...
ENTITY SpectrumAnalyser8192_src_TWDLROM_7_1 IS
...
END SpectrumAnalyser8192_src_TWDLROM_7_1;


ARCHITECTURE rtl OF SpectrumAnalyser8192_src_TWDLROM_7_1 IS
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    IF (dout_6_1_vld AND hdlcoder_to_stdlogic(Radix22TwdlMapping_cnt > to_unsigned(16#7EF#, 11))) = '1' THEN 
      Radix22TwdlMapping_phase_next <= Radix22TwdlMapping_phase + to_unsigned(16#1#, 2);
    END IF;
    IF dout_6_1_vld = '1' THEN 
      Radix22TwdlMapping_cnt_next <= Radix22TwdlMapping_cnt + to_unsigned(16#010#, 11);
    END IF;
