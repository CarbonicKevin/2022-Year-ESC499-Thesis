-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_axi_lite_module
-- Source Path: SpectrumAnalyser8192/SpectrumAnalyser8192_axi_lite/SpectrumAnalyser8192_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser8192_axi_lite_module IS
...
END SpectrumAnalyser8192_axi_lite_module;


ARCHITECTURE rtl OF SpectrumAnalyser8192_axi_lite_module IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser8192_reset_hold
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser8192_reset_hold
    USE ENTITY work.SpectrumAnalyser8192_reset_hold(rtl);
...
BEGIN
  u_SpectrumAnalyser8192_reset_hold_inst : SpectrumAnalyser8192_reset_hold
    PORT MAP( clk => clk,
              reset => reset,
