-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_axi4_stream_real_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_axi4_stream_real_slave
-- Source Path: SpectrumAnalyser8192/SpectrumAnalyser8192_axi4_stream_real_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser8192_axi4_stream_real_slave IS
...
END SpectrumAnalyser8192_axi4_stream_real_slave;


ARCHITECTURE rtl OF SpectrumAnalyser8192_axi4_stream_real_slave IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser8192_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser8192_fifo_data
    USE ENTITY work.SpectrumAnalyser8192_fifo_data(rtl);
...
BEGIN
  u_SpectrumAnalyser8192_fifo_data_inst : SpectrumAnalyser8192_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
