-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192
-- Source Path: SpectrumAnalyser8192
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser8192 IS
...
END SpectrumAnalyser8192;


ARCHITECTURE rtl OF SpectrumAnalyser8192 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser8192_axi4_stream_imag_slave
  ...
  COMPONENT SpectrumAnalyser8192_axi4_stream_real_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Real_Slave_TDATA    :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
  ...
  COMPONENT SpectrumAnalyser8192_reset_sync
    PORT( clk                             :   IN    std_logic;  -- ufix1
  ...
  COMPONENT SpectrumAnalyser8192_axi4_master_wr
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          AXI4_Master_Wr_AWREADY          :   IN    std_logic;  -- ufix1
          AXI4_Master_Wr_WREADY           :   IN    std_logic;  -- ufix1
  ...
  COMPONENT SpectrumAnalyser8192_axi_lite
  ...
  COMPONENT SpectrumAnalyser8192_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser8192_axi4_master_rd
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          AXI4_Master_Rd_RDATA            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          AXI4_Master_Rd_RLAST            :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : SpectrumAnalyser8192_axi4_stream_imag_slave
    USE ENTITY work.SpectrumAnalyser8192_axi4_stream_imag_slave(rtl);

  FOR ALL : SpectrumAnalyser8192_axi4_stream_real_slave
    USE ENTITY work.SpectrumAnalyser8192_axi4_stream_real_slave(rtl);

  FOR ALL : SpectrumAnalyser8192_reset_sync
    USE ENTITY work.SpectrumAnalyser8192_reset_sync(rtl);

  FOR ALL : SpectrumAnalyser8192_axi4_master_wr
    USE ENTITY work.SpectrumAnalyser8192_axi4_master_wr(rtl);

  FOR ALL : SpectrumAnalyser8192_axi_lite
    USE ENTITY work.SpectrumAnalyser8192_axi_lite(rtl);

  FOR ALL : SpectrumAnalyser8192_dut
    USE ENTITY work.SpectrumAnalyser8192_dut(rtl);

  FOR ALL : SpectrumAnalyser8192_axi4_master_rd
    USE ENTITY work.SpectrumAnalyser8192_axi4_master_rd(rtl);
...
BEGIN
  u_SpectrumAnalyser8192_axi4_stream_imag_slave_inst : SpectrumAnalyser8192_axi4_stream_imag_slave
  ...
  u_SpectrumAnalyser8192_axi4_stream_real_slave_inst : SpectrumAnalyser8192_axi4_stream_real_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyser8192_reset_sync_inst : SpectrumAnalyser8192_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_SpectrumAnalyser8192_axi4_master_wr_inst : SpectrumAnalyser8192_axi4_master_wr
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_SpectrumAnalyser8192_axi_lite_inst : SpectrumAnalyser8192_axi_lite
  ...
  u_SpectrumAnalyser8192_dut_inst : SpectrumAnalyser8192_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_SpectrumAnalyser8192_axi4_master_rd_inst : SpectrumAnalyser8192_axi4_master_rd
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"89548E26");
