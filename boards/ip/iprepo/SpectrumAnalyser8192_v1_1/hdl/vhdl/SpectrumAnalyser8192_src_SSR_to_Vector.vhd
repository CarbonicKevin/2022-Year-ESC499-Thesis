-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_src_SSR_to_Vector.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_src_SSR_to_Vector
...
ENTITY SpectrumAnalyser8192_src_SSR_to_Vector IS
  PORT( SSR                               :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
        Vector                            :   OUT   vector_of_std_logic_vector16(0 TO 7)  -- uint16 [8]
        );
END SpectrumAnalyser8192_src_SSR_to_Vector;


ARCHITECTURE rtl OF SpectrumAnalyser8192_src_SSR_to_Vector IS
