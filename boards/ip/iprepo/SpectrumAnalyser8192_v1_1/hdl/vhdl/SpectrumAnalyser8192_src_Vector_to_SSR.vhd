-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_src_Vector_to_SSR.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_src_Vector_to_SSR
...
ENTITY SpectrumAnalyser8192_src_Vector_to_SSR IS
  PORT( Vector                            :   IN    vector_of_std_logic_vector16(0 TO 7);  -- uint16 [8]
        SSR                               :   OUT   std_logic_vector(127 DOWNTO 0)  -- ufix128
        );
END SpectrumAnalyser8192_src_Vector_to_SSR;


ARCHITECTURE rtl OF SpectrumAnalyser8192_src_Vector_to_SSR IS
