-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_src_Preprocessing_Window.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_src_Preprocessing_Window
...
ENTITY SpectrumAnalyser8192_src_Preprocessing_Window IS
...
END SpectrumAnalyser8192_src_Preprocessing_Window;


ARCHITECTURE rtl OF SpectrumAnalyser8192_src_Preprocessing_Window IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser8192_src_Direct_Memory_Access_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser8192_src_DualPortRAM_generic
  ...
  FOR ALL : SpectrumAnalyser8192_src_Direct_Memory_Access_block1
    USE ENTITY work.SpectrumAnalyser8192_src_Direct_Memory_Access_block1(rtl);

  FOR ALL : SpectrumAnalyser8192_src_DualPortRAM_generic
    USE ENTITY work.SpectrumAnalyser8192_src_DualPortRAM_generic(rtl);
...
BEGIN
  u_Direct_Memory_Access : SpectrumAnalyser8192_src_Direct_Memory_Access_block1
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Dual_Port_RAM_System : SpectrumAnalyser8192_src_DualPortRAM_generic
