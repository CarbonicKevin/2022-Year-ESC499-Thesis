-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser8192_wlast_fifo.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser8192_wlast_fifo
-- Source Path: SpectrumAnalyser8192/SpectrumAnalyser8192_axi4_master_wr/SpectrumAnalyser8192_wlast_fifo
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser8192_wlast_fifo IS
...
END SpectrumAnalyser8192_wlast_fifo;


ARCHITECTURE rtl OF SpectrumAnalyser8192_wlast_fifo IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser8192_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : SpectrumAnalyser8192_SimpleDualPortRAM_singlebit
    USE ENTITY work.SpectrumAnalyser8192_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_SpectrumAnalyser8192_wlast_fifo_classic_ram_singlebit : SpectrumAnalyser8192_SimpleDualPortRAM_singlebit
