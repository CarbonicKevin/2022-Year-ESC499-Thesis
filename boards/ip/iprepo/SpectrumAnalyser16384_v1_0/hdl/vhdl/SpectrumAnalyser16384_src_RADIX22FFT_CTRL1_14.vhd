-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_14.vhd
...
ENTITY SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_14 IS
...
END SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_14;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_14 IS
...
BEGIN
  ...
  SDFController_output : PROCESS (SDFController_multjState, SDFController_rdAddr_reg, SDFController_rdState,
       SDFController_wrState, dinXTwdl_14_1_vld, dout_13_1_vld)
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_14_Enb <= '0';
        IF (hdlcoder_to_stdlogic(SDFController_wrState = to_unsigned(16#3#, 2)) AND dout_13_1_vld) = '1' THEN 
    ...
    CASE SDFController_wrState IS
      ...
      WHEN OTHERS => 
        ...
        proc_14_enb <= '0';
    END CASE;
    rd_14_Addr <= SDFController_rdAddr_reg;
