-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_RADIX22FFT_SDF2_14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_RADIX22FFT_SDF2_14
...
ENTITY SpectrumAnalyser16384_src_RADIX22FFT_SDF2_14 IS
...
END SpectrumAnalyser16384_src_RADIX22FFT_SDF2_14;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_RADIX22FFT_SDF2_14 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser16384_src_SDFCommutator14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_13_1_vld                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser16384_src_SDFCommutator14
    USE ENTITY work.SpectrumAnalyser16384_src_SDFCommutator14(rtl);
...
BEGIN
  u_SDFCOMMUTATOR_14 : SpectrumAnalyser16384_src_SDFCommutator14
    PORT MAP( clk => clk,
              reset => reset,
