-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_DDR_Communication.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_DDR_Communication
...
ENTITY SpectrumAnalyser16384_src_DDR_Communication IS
...
END SpectrumAnalyser16384_src_DDR_Communication;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_DDR_Communication IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser16384_src_HDL_FIFO
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser16384_src_Write_Controller
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          valid                           :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser16384_src_HDL_FIFO
    USE ENTITY work.SpectrumAnalyser16384_src_HDL_FIFO(rtl);

  FOR ALL : SpectrumAnalyser16384_src_Write_Controller
    USE ENTITY work.SpectrumAnalyser16384_src_Write_Controller(rtl);
...
BEGIN
  u_HDL_FIFO : SpectrumAnalyser16384_src_HDL_FIFO
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Write_Controller : SpectrumAnalyser16384_src_Write_Controller
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              valid => Valid_Out,
