-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_axi4_master_rd.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_axi4_master_rd
-- Source Path: SpectrumAnalyser16384/SpectrumAnalyser16384_axi4_master_rd
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser16384_axi4_master_rd IS
...
END SpectrumAnalyser16384_axi4_master_rd;


ARCHITECTURE rtl OF SpectrumAnalyser16384_axi4_master_rd IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser16384_rd_addr_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser16384_rd_len_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser16384_rdata_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : SpectrumAnalyser16384_rd_addr_fifo
    USE ENTITY work.SpectrumAnalyser16384_rd_addr_fifo(rtl);

  FOR ALL : SpectrumAnalyser16384_rd_len_fifo
    USE ENTITY work.SpectrumAnalyser16384_rd_len_fifo(rtl);

  FOR ALL : SpectrumAnalyser16384_rdata_fifo
    USE ENTITY work.SpectrumAnalyser16384_rdata_fifo(rtl);
...
BEGIN
  u_SpectrumAnalyser16384_rd_addr_fifo_inst : SpectrumAnalyser16384_rd_addr_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyser16384_rd_len_fifo_inst : SpectrumAnalyser16384_rd_len_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyser16384_rdata_fifo_inst : SpectrumAnalyser16384_rdata_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
