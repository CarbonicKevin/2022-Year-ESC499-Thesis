-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_nfp_convert_sfix_30_En15_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_nfp_convert_sfix_30_En15_to_single
...
-- Options/nfp_convert_sfix_30_En15_to_singl
-- Hierarchy Level: 5
-- 
...
ENTITY SpectrumAnalyser16384_src_nfp_convert_sfix_30_En15_to_single IS
...
END SpectrumAnalyser16384_src_nfp_convert_sfix_30_En15_to_single;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_nfp_convert_sfix_30_En15_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(29 DOWNTO 0);  -- sfix30_En15
  SIGNAL Delay_out1                       : signed(29 DOWNTO 0);  -- sfix30_En15
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(29 DOWNTO 0);  -- ufix30_En15
  SIGNAL Unary_Minus_cast                 : signed(30 DOWNTO 0);  -- sfix31_En15
  SIGNAL Unary_Minus_cast_1               : signed(30 DOWNTO 0);  -- sfix31_En15
  SIGNAL Unary_Minus_out1                 : signed(29 DOWNTO 0);  -- sfix30_En15
  SIGNAL Unary_Minus_out1_dtc             : unsigned(29 DOWNTO 0);  -- ufix30_En15
  SIGNAL Switch_out1                      : unsigned(29 DOWNTO 0);  -- ufix30_En15
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(16#00000000#, 30) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(16#00000000#, 30) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(Delay_out1, 31);
  Unary_Minus_cast_1 <=  - (Unary_Minus_cast);
  Unary_Minus_out1 <= Unary_Minus_cast_1(29 DOWNTO 0);
