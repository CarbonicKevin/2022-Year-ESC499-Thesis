-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_RADIX22FFT_SDF1_13.vhd
...
ENTITY SpectrumAnalyser16384_src_RADIX22FFT_SDF1_13 IS
...
END SpectrumAnalyser16384_src_RADIX22FFT_SDF1_13;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_RADIX22FFT_SDF1_13 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser16384_src_Complex4Multiply_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser16384_src_SDFCommutator13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_13_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser16384_src_Complex4Multiply_block4
    USE ENTITY work.SpectrumAnalyser16384_src_Complex4Multiply_block4(rtl);

  FOR ALL : SpectrumAnalyser16384_src_SDFCommutator13
    USE ENTITY work.SpectrumAnalyser16384_src_SDFCommutator13(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser16384_src_Complex4Multiply_block4
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_13 : SpectrumAnalyser16384_src_SDFCommutator13
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_13_vld_dly => din_13_vld_dly,
