-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_RADIX22FFT_SDF1_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_RADIX22FFT_SDF1_1
...
ENTITY SpectrumAnalyser16384_src_RADIX22FFT_SDF1_1 IS
...
END SpectrumAnalyser16384_src_RADIX22FFT_SDF1_1;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_RADIX22FFT_SDF1_1 IS
  ...
  COMPONENT SpectrumAnalyser16384_src_SDFCommutator1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser16384_src_SDFCommutator1
    USE ENTITY work.SpectrumAnalyser16384_src_SDFCommutator1(rtl);
...
BEGIN
  u_dataMEM_im_0_1 : SpectrumAnalyser16384_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_1 : SpectrumAnalyser16384_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 13,
                 DataWidth => 17
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_1 : SpectrumAnalyser16384_src_SDFCommutator1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
