-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_Vector_to_SSR_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_Vector_to_SSR_block
...
ENTITY SpectrumAnalyser16384_src_Vector_to_SSR_block IS
  PORT( Vector                            :   IN    vector_of_std_logic_vector16(0 TO 7);  -- uint16 [8]
        SSR                               :   OUT   std_logic_vector(127 DOWNTO 0)  -- ufix128
        );
END SpectrumAnalyser16384_src_Vector_to_SSR_block;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_Vector_to_SSR_block IS
