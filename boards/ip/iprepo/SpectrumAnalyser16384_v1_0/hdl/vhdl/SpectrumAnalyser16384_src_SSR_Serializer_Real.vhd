-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_SSR_Serializer_Real.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_SSR_Serializer_Real
...
ENTITY SpectrumAnalyser16384_src_SSR_Serializer_Real IS
...
END SpectrumAnalyser16384_src_SSR_Serializer_Real;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_SSR_Serializer_Real IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser16384_src_SSR_to_Vector_block2
    PORT( SSR                             :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
          Vector                          :   OUT   vector_of_std_logic_vector16(0 TO 7)  -- uint16 [8]
          );
  END COMPONENT;

  COMPONENT SpectrumAnalyser16384_src_SSR1_to_SSR8_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser16384_src_SSR2_to_SSR8_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Data_In                         :   IN    vector_of_std_logic_vector16(0 TO 7);  -- uint16 [8]
  ...
  COMPONENT SpectrumAnalyser16384_src_SSR4_to_SSR8_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Data_In                         :   IN    vector_of_std_logic_vector16(0 TO 7);  -- uint16 [8]
  ...
  COMPONENT SpectrumAnalyser16384_src_Vector_to_SSR_block
  ...
  FOR ALL : SpectrumAnalyser16384_src_SSR_to_Vector_block2
    USE ENTITY work.SpectrumAnalyser16384_src_SSR_to_Vector_block2(rtl);

  FOR ALL : SpectrumAnalyser16384_src_SSR1_to_SSR8_block
    USE ENTITY work.SpectrumAnalyser16384_src_SSR1_to_SSR8_block(rtl);

  FOR ALL : SpectrumAnalyser16384_src_SSR2_to_SSR8_block
    USE ENTITY work.SpectrumAnalyser16384_src_SSR2_to_SSR8_block(rtl);

  FOR ALL : SpectrumAnalyser16384_src_SSR4_to_SSR8_block
    USE ENTITY work.SpectrumAnalyser16384_src_SSR4_to_SSR8_block(rtl);

  FOR ALL : SpectrumAnalyser16384_src_Vector_to_SSR_block
    USE ENTITY work.SpectrumAnalyser16384_src_Vector_to_SSR_block(rtl);
...
BEGIN
  u_SSR_to_Vector : SpectrumAnalyser16384_src_SSR_to_Vector_block2
    PORT MAP( SSR => Data_In,  -- ufix128
              Vector => SSR_to_Vector_out1  -- uint16 [8]
              );

  u_SSR1_to_SSR8 : SpectrumAnalyser16384_src_SSR1_to_SSR8_block
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SSR2_to_SSR8 : SpectrumAnalyser16384_src_SSR2_to_SSR8_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              Data_In => SSR_to_Vector_out1,  -- uint16 [8]
  ...
  u_SSR4_to_SSR8 : SpectrumAnalyser16384_src_SSR4_to_SSR8_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              Data_In => SSR_to_Vector_out1,  -- uint16 [8]
  ...
  u_Vector_to_SSR : SpectrumAnalyser16384_src_Vector_to_SSR_block
