-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_12.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_12
...
ENTITY SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_12 IS
...
END SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_12;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_12 IS
  ...
  SIGNAL rd_12_Addr_tmp                   : unsigned(1 DOWNTO 0);  -- ufix2
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_12_Enb <= '0';
        IF (dout_11_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3#, 2))) = '1' THEN 
