-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_SSR_Subset_Converter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_SSR_Subset_Converter
...
ENTITY SpectrumAnalyser16384_src_SSR_Subset_Converter IS
...
END SpectrumAnalyser16384_src_SSR_Subset_Converter;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_SSR_Subset_Converter IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser16384_src_SSR_Serializer_Real
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser16384_src_SSR_Packet_Generator_Real
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser16384_src_SSR_Deserializer_Real
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser16384_src_SSR_Serializer_Imag
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          SSR_Control                     :   IN    std_logic_vector(3 DOWNTO 0);  -- ufix4
  ...
  COMPONENT SpectrumAnalyser16384_src_SSR_Packet_Generator_Imag
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Frame_Drop                      :   IN    std_logic_vector(3 DOWNTO 0);  -- ufix4
  ...
  COMPONENT SpectrumAnalyser16384_src_SSR_Deserializer_Imag
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser16384_src_SSR_Serializer_Real
    USE ENTITY work.SpectrumAnalyser16384_src_SSR_Serializer_Real(rtl);

  FOR ALL : SpectrumAnalyser16384_src_SSR_Packet_Generator_Real
    USE ENTITY work.SpectrumAnalyser16384_src_SSR_Packet_Generator_Real(rtl);

  FOR ALL : SpectrumAnalyser16384_src_SSR_Deserializer_Real
    USE ENTITY work.SpectrumAnalyser16384_src_SSR_Deserializer_Real(rtl);

  FOR ALL : SpectrumAnalyser16384_src_SSR_Serializer_Imag
    USE ENTITY work.SpectrumAnalyser16384_src_SSR_Serializer_Imag(rtl);

  FOR ALL : SpectrumAnalyser16384_src_SSR_Packet_Generator_Imag
    USE ENTITY work.SpectrumAnalyser16384_src_SSR_Packet_Generator_Imag(rtl);

  FOR ALL : SpectrumAnalyser16384_src_SSR_Deserializer_Imag
    USE ENTITY work.SpectrumAnalyser16384_src_SSR_Deserializer_Imag(rtl);
...
BEGIN
  u_SSR_Serializer_Real : SpectrumAnalyser16384_src_SSR_Serializer_Real
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SSR_Packet_Generator_Real : SpectrumAnalyser16384_src_SSR_Packet_Generator_Real
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_SSR_Deserializer_Real : SpectrumAnalyser16384_src_SSR_Deserializer_Real
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_SSR_Serializer_Imag : SpectrumAnalyser16384_src_SSR_Serializer_Imag
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              SSR_Control => std_logic_vector(Bit_Slice_out1),  -- ufix4
  ...
  u_SSR_Packet_Generator_Imag : SpectrumAnalyser16384_src_SSR_Packet_Generator_Imag
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              Frame_Drop => std_logic_vector(Bit_Slice_out1),  -- ufix4
  ...
  u_SSR_Deserializer_Imag : SpectrumAnalyser16384_src_SSR_Deserializer_Imag
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
