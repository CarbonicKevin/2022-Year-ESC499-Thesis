-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_RADIX22FFT_SDF2_4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_RADIX22FFT_SDF2_4
...
ENTITY SpectrumAnalyser16384_src_RADIX22FFT_SDF2_4 IS
...
END SpectrumAnalyser16384_src_RADIX22FFT_SDF2_4;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_RADIX22FFT_SDF2_4 IS
  ...
  COMPONENT SpectrumAnalyser16384_src_SDFCommutator4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser16384_src_SDFCommutator4
    USE ENTITY work.SpectrumAnalyser16384_src_SDFCommutator4(rtl);
...
BEGIN
  u_dataMEM_im_0_4 : SpectrumAnalyser16384_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_4 : SpectrumAnalyser16384_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 20
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_4 : SpectrumAnalyser16384_src_SDFCommutator4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
