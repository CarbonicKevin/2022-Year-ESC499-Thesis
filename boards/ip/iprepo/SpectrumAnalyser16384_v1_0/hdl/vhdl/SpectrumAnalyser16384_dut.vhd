-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_dut
-- Source Path: SpectrumAnalyser16384/SpectrumAnalyser16384_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser16384_dut IS
...
END SpectrumAnalyser16384_dut;


ARCHITECTURE rtl OF SpectrumAnalyser16384_dut IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser16384_src_Spectrum_Analyser
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser16384_src_Spectrum_Analyser
    USE ENTITY work.SpectrumAnalyser16384_src_Spectrum_Analyser(rtl);
...
BEGIN
  u_SpectrumAnalyser16384_src_Spectrum_Analyser : SpectrumAnalyser16384_src_Spectrum_Analyser
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
