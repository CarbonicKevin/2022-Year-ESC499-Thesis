-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_RADIX22FFT_SDF2_10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_RADIX22FFT_SDF2_10
...
ENTITY SpectrumAnalyser16384_src_RADIX22FFT_SDF2_10 IS
...
END SpectrumAnalyser16384_src_RADIX22FFT_SDF2_10;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_RADIX22FFT_SDF2_10 IS
  ...
  COMPONENT SpectrumAnalyser16384_src_SDFCommutator10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_9_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser16384_src_SDFCommutator10
    USE ENTITY work.SpectrumAnalyser16384_src_SDFCommutator10(rtl);
  ...
  SIGNAL x_im_signed                      : signed(25 DOWNTO 0);  -- sfix26_En15
  ...
  SIGNAL x_re_signed                      : signed(25 DOWNTO 0);  -- sfix26_En15
...
BEGIN
  u_dataMEM_im_0_10 : SpectrumAnalyser16384_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_10 : SpectrumAnalyser16384_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 26
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_10 : SpectrumAnalyser16384_src_SDFCommutator10
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
