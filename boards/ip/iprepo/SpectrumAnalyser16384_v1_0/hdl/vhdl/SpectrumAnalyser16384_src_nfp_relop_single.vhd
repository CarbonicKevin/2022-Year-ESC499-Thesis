-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_nfp_relop_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_nfp_relop_single
...
ENTITY SpectrumAnalyser16384_src_nfp_relop_single IS
...
END SpectrumAnalyser16384_src_nfp_relop_single;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_nfp_relop_single IS
...
BEGIN
  ...
  Logical_Operator_out1_1 <= Logical_Operator2_out1_1 OR Delay1_out1;
  ...
  Switch6_out1 <= Delay6_out1_1 WHEN Logical_Operator_out1_1 = '0' ELSE
      Constant6_out1;
