-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_axi_lite_module
-- Source Path: SpectrumAnalyser16384/SpectrumAnalyser16384_axi_lite/SpectrumAnalyser16384_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser16384_axi_lite_module IS
...
END SpectrumAnalyser16384_axi_lite_module;


ARCHITECTURE rtl OF SpectrumAnalyser16384_axi_lite_module IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser16384_reset_hold
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser16384_reset_hold
    USE ENTITY work.SpectrumAnalyser16384_reset_hold(rtl);
...
BEGIN
  u_SpectrumAnalyser16384_reset_hold_inst : SpectrumAnalyser16384_reset_hold
    PORT MAP( clk => clk,
              reset => reset,
