-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_RADIX2FFT_bitNatural.vhd
...
ENTITY SpectrumAnalyser16384_src_RADIX2FFT_bitNatural IS
...
END SpectrumAnalyser16384_src_RADIX2FFT_bitNatural;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_RADIX2FFT_bitNatural IS
  ...
  SIGNAL wrStateMachineBitNatural_wrAddrCnt : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL wrStateMachineBitNatural_wrState_next : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL wrStateMachineBitNatural_wrAddrCnt_next : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL WrEnb                            : std_logic;
  SIGNAL wrAddr                           : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL sampleIdx                        : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL rdAddr                           : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL memOut_im                        : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL memOut_im_signed                 : signed(29 DOWNTO 0);  -- sfix30_En15
  SIGNAL memOut_re                        : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL memOut_re_signed                 : signed(29 DOWNTO 0);  -- sfix30_En15
  SIGNAL rdStateMachineBitNatural_rdState : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL rdStateMachineBitNatural_rdAddrCnt : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL rdStateMachineBitNatural_doutVldReg1 : std_logic;
  SIGNAL rdStateMachineBitNatural_doutVldReg2 : std_logic;
  SIGNAL rdStateMachineBitNatural_doutReReg : signed(29 DOWNTO 0);  -- sfix30
  SIGNAL rdStateMachineBitNatural_doutImReg : signed(29 DOWNTO 0);  -- sfix30
  ...
  SIGNAL rdStateMachineBitNatural_rdAddrCnt_next : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL rdStateMachineBitNatural_doutVldReg1_next : std_logic;
  SIGNAL rdStateMachineBitNatural_doutVldReg2_next : std_logic;
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(29 DOWNTO 0);  -- sfix30_En15
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(29 DOWNTO 0);  -- sfix30_En15
  ...
  SIGNAL dout_re1_tmp                     : signed(29 DOWNTO 0);  -- sfix30_En15
  SIGNAL dout_im1_tmp                     : signed(29 DOWNTO 0);  -- sfix30_En15
  SIGNAL startOutW                        : std_logic;
  SIGNAL endOutW                          : std_logic;

BEGIN
  u_dataMEM_im_1 : SpectrumAnalyser16384_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_1 : SpectrumAnalyser16384_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 14,
                 DataWidth => 30
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      wrStateMachineBitNatural_wrAddrCnt <= to_unsigned(16#0000#, 14);
  ...
  wrStateMachineBitNatural_output : PROCESS (dout_14_1_vld, wrStateMachineBitNatural_wrAddrCnt,
    ...
    CASE wrStateMachineBitNatural_wrState IS
      WHEN "00" =>
        IF dout_14_1_vld = '1' THEN 
          ...
          wrStateMachineBitNatural_wrAddrCnt_next <= to_unsigned(16#0001#, 14);
        ELSE 
          wrStateMachineBitNatural_wrState_next <= to_unsigned(16#0#, 2);
          wrStateMachineBitNatural_wrAddrCnt_next <= to_unsigned(16#0000#, 14);
        END IF;
      WHEN "01" =>
        IF dout_14_1_vld = '1' THEN 
          IF wrStateMachineBitNatural_wrAddrCnt = to_unsigned(16#3FFF#, 14) THEN 
            wrStateMachineBitNatural_wrAddrCnt_next <= to_unsigned(16#0000#, 14);
            wrStateMachineBitNatural_wrState_next <= to_unsigned(16#2#, 2);
          ELSE 
            wrStateMachineBitNatural_wrAddrCnt_next <= wrStateMachineBitNatural_wrAddrCnt + to_unsigned(16#0001#, 14);
            wrStateMachineBitNatural_wrState_next <= to_unsigned(16#1#, 2);
          END IF;
        END IF;
      WHEN "10" =>
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdStateMachineBitNatural_rdAddrCnt <= to_unsigned(16#0000#, 14);
      rdStateMachineBitNatural_doutVldReg1 <= '0';
      rdStateMachineBitNatural_doutVldReg2 <= '0';
      rdStateMachineBitNatural_doutReReg <= to_signed(16#00000000#, 30);
      rdStateMachineBitNatural_doutImReg <= to_signed(16#00000000#, 30);
  ...
  BEGIN
    ...
    CASE rdStateMachineBitNatural_rdState IS
      WHEN "00" =>
        ...
        ELSE 
          rdStateMachineBitNatural_rdAddrCnt_next <= to_unsigned(16#0000#, 14);
          rdStateMachineBitNatural_rdState_next <= to_unsigned(16#0#, 2);
          rdStateMachineBitNatural_endOutReg1_next <= '0';
        END IF;
      WHEN "01" =>
        rdStateMachineBitNatural_doutVldReg1_next <= '1';
        IF rdStateMachineBitNatural_rdAddrCnt = to_unsigned(16#3FFF#, 14) THEN 
          rdStateMachineBitNatural_rdAddrCnt_next <= to_unsigned(16#0000#, 14);
          rdStateMachineBitNatural_rdState_next <= to_unsigned(16#2#, 2);
          rdStateMachineBitNatural_endOutReg1_next <= '1';
        ELSE 
          rdStateMachineBitNatural_rdAddrCnt_next <= rdStateMachineBitNatural_rdAddrCnt + to_unsigned(16#0001#, 14);
          rdStateMachineBitNatural_rdState_next <= to_unsigned(16#1#, 2);
          rdStateMachineBitNatural_endOutReg1_next <= '0';
        END IF;
      WHEN "10" =>
