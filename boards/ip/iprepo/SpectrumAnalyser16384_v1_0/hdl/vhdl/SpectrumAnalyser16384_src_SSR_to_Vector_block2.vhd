-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_SSR_to_Vector_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_SSR_to_Vector_block2
...
ENTITY SpectrumAnalyser16384_src_SSR_to_Vector_block2 IS
  PORT( SSR                               :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
        Vector                            :   OUT   vector_of_std_logic_vector16(0 TO 7)  -- uint16 [8]
        );
END SpectrumAnalyser16384_src_SSR_to_Vector_block2;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_SSR_to_Vector_block2 IS
