-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_axi4_stream_imag_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_axi4_stream_imag_slave
-- Source Path: SpectrumAnalyser16384/SpectrumAnalyser16384_axi4_stream_imag_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser16384_axi4_stream_imag_slave IS
...
END SpectrumAnalyser16384_axi4_stream_imag_slave;


ARCHITECTURE rtl OF SpectrumAnalyser16384_axi4_stream_imag_slave IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser16384_fifo_data_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser16384_fifo_data_block
    USE ENTITY work.SpectrumAnalyser16384_fifo_data_block(rtl);
...
BEGIN
  u_SpectrumAnalyser16384_fifo_data_inst : SpectrumAnalyser16384_fifo_data_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
