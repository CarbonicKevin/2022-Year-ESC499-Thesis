-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_axi4_stream_real_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_axi4_stream_real_slave
-- Source Path: SpectrumAnalyser16384/SpectrumAnalyser16384_axi4_stream_real_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser16384_axi4_stream_real_slave IS
...
END SpectrumAnalyser16384_axi4_stream_real_slave;


ARCHITECTURE rtl OF SpectrumAnalyser16384_axi4_stream_real_slave IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser16384_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser16384_fifo_data
    USE ENTITY work.SpectrumAnalyser16384_fifo_data(rtl);
...
BEGIN
  u_SpectrumAnalyser16384_fifo_data_inst : SpectrumAnalyser16384_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
