-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_RADIX22FFT_SDF1_7.vhd
...
ENTITY SpectrumAnalyser16384_src_RADIX22FFT_SDF1_7 IS
...
END SpectrumAnalyser16384_src_RADIX22FFT_SDF1_7;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_RADIX22FFT_SDF1_7 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser16384_src_Complex4Multiply_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser16384_src_SDFCommutator7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser16384_src_Complex4Multiply_block1
    USE ENTITY work.SpectrumAnalyser16384_src_Complex4Multiply_block1(rtl);
  ...
  FOR ALL : SpectrumAnalyser16384_src_SDFCommutator7
    USE ENTITY work.SpectrumAnalyser16384_src_SDFCommutator7(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser16384_src_Complex4Multiply_block1
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_7 : SpectrumAnalyser16384_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_7 : SpectrumAnalyser16384_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 7,
                 DataWidth => 23
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_7 : SpectrumAnalyser16384_src_SDFCommutator7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_7_vld_dly => din_7_vld_dly,
