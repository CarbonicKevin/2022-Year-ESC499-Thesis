-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_11
...
ENTITY SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_11 IS
...
END SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_11;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_RADIX22FFT_CTRL1_11 IS
  ...
  SIGNAL rd_11_Addr_tmp                   : unsigned(2 DOWNTO 0);  -- ufix3
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_11_Enb <= '0';
        IF (dinXTwdl_11_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7#, 3))) = '1' THEN 
