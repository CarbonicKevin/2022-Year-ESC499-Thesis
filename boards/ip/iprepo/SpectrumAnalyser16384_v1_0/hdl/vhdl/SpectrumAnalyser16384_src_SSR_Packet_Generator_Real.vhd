-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser16384_src_SSR_Packet_Generator_Real.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser16384_src_SSR_Packet_Generator_Real
...
ENTITY SpectrumAnalyser16384_src_SSR_Packet_Generator_Real IS
...
END SpectrumAnalyser16384_src_SSR_Packet_Generator_Real;


ARCHITECTURE rtl OF SpectrumAnalyser16384_src_SSR_Packet_Generator_Real IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser16384_src_TLAST_Generator_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser16384_src_Frame_Dropper_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser16384_src_TLAST_Generator_block
    USE ENTITY work.SpectrumAnalyser16384_src_TLAST_Generator_block(rtl);

  FOR ALL : SpectrumAnalyser16384_src_Frame_Dropper_block
    USE ENTITY work.SpectrumAnalyser16384_src_Frame_Dropper_block(rtl);
...
BEGIN
  u_TLAST_Generator : SpectrumAnalyser16384_src_TLAST_Generator_block
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Frame_Dropper : SpectrumAnalyser16384_src_Frame_Dropper_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
