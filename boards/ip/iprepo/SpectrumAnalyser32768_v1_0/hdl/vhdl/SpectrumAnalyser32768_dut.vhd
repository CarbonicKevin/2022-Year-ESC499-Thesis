-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_dut
-- Source Path: SpectrumAnalyser32768/SpectrumAnalyser32768_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser32768_dut IS
...
END SpectrumAnalyser32768_dut;


ARCHITECTURE rtl OF SpectrumAnalyser32768_dut IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_src_Spectrum_Analyser
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser32768_src_Spectrum_Analyser
    USE ENTITY work.SpectrumAnalyser32768_src_Spectrum_Analyser(rtl);
...
BEGIN
  u_SpectrumAnalyser32768_src_Spectrum_Analyser : SpectrumAnalyser32768_src_Spectrum_Analyser
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
