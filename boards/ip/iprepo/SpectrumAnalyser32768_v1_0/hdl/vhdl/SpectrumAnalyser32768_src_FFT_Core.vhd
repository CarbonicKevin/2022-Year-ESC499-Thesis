-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_FFT_Core.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_src_FFT_Core
...
ENTITY SpectrumAnalyser32768_src_FFT_Core IS
...
END SpectrumAnalyser32768_src_FFT_Core;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_FFT_Core IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_src_FFT_HDL_Optimized_32768
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser32768_src_FFT_HDL_Optimized_32768
    USE ENTITY work.SpectrumAnalyser32768_src_FFT_HDL_Optimized_32768(rtl);
...
BEGIN
  u_FFT_HDL_Optimized_32768 : SpectrumAnalyser32768_src_FFT_HDL_Optimized_32768
    PORT MAP( clk => clk,
              reset => reset,
  ...
  Compare_To_Constant_out1 <= '1' WHEN Selector_unsigned = to_unsigned(16#0F#, 8) ELSE
      '0';

  AND1_out1 <= Valid_In AND Compare_To_Constant_out1;

  Start <= FFT_HDL_Optimized_32768_out2;

  End_rsvd <= FFT_HDL_Optimized_32768_out3;

  Valid_Out <= FFT_HDL_Optimized_32768_out4;

  Data_Out_re <= FFT_HDL_Optimized_32768_out1_re;

  Data_Out_im <= FFT_HDL_Optimized_32768_out1_im;
