-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_axi_lite_module
-- Source Path: SpectrumAnalyser32768/SpectrumAnalyser32768_axi_lite/SpectrumAnalyser32768_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser32768_axi_lite_module IS
...
END SpectrumAnalyser32768_axi_lite_module;


ARCHITECTURE rtl OF SpectrumAnalyser32768_axi_lite_module IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_reset_hold
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser32768_reset_hold
    USE ENTITY work.SpectrumAnalyser32768_reset_hold(rtl);
...
BEGIN
  u_SpectrumAnalyser32768_reset_hold_inst : SpectrumAnalyser32768_reset_hold
    PORT MAP( clk => clk,
              reset => reset,
