-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_RADIX22FFT_SDF1_15.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_src_RADIX22FFT_SDF1_15
...
ENTITY SpectrumAnalyser32768_src_RADIX22FFT_SDF1_15 IS
...
END SpectrumAnalyser32768_src_RADIX22FFT_SDF1_15;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_RADIX22FFT_SDF1_15 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_src_Complex4Multiply_block5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser32768_src_SDFCommutator15
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_15_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser32768_src_Complex4Multiply_block5
    USE ENTITY work.SpectrumAnalyser32768_src_Complex4Multiply_block5(rtl);

  FOR ALL : SpectrumAnalyser32768_src_SDFCommutator15
    USE ENTITY work.SpectrumAnalyser32768_src_SDFCommutator15(rtl);

  -- Signals
  SIGNAL din_15_re_dly_signed             : signed(29 DOWNTO 0);  -- sfix30_En15
  SIGNAL din_re                           : signed(30 DOWNTO 0);  -- sfix31_En15
  SIGNAL din_15_im_dly_signed             : signed(29 DOWNTO 0);  -- sfix30_En15
  ...
  SIGNAL dinXTwdl_15_vld_1                : std_logic;
  ...
  SIGNAL dout_15_re_tmp                   : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL dout_15_im_tmp                   : std_logic_vector(30 DOWNTO 0);  -- ufix31

BEGIN
  u_MUL4 : SpectrumAnalyser32768_src_Complex4Multiply_block5
    PORT MAP( clk => clk,
              reset => reset,
              ...
              dinXTwdl_15_vld => dinXTwdl_15_vld_1
              );

  u_SDFCOMMUTATOR_15 : SpectrumAnalyser32768_src_SDFCommutator15
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_15_vld_dly => din_15_vld_dly,
              ...
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_15_re => dout_15_re_tmp,  -- sfix31_En15
              dout_15_im => dout_15_im_tmp,  -- sfix31_En15
              dout_15_vld => dout_15_vld
              );

  din_15_re_dly_signed <= signed(din_15_re_dly);

  din_re <= resize(din_15_re_dly_signed, 31);

  din_15_im_dly_signed <= signed(din_15_im_dly);

  din_im <= resize(din_15_im_dly_signed, 31);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_16_0 = '1' THEN
        ...
        xf_im <= x_im;
        xf_vld <= x_vld;
        Radix22ButterflyG1_dinXtwdl_vld_dly1 <= proc_15_enb AND dinXTwdl_15_vld_1;
      END IF;
    END IF;
  END PROCESS Radix22ButterflyG1_process;

  dinxTwdlf_vld <= ( NOT proc_15_enb) AND dinXTwdl_15_vld_1;
  Radix22ButterflyG1_add_cast <= resize(x_re, 32);
  ...
  Radix22ButterflyG1_sub_cast <= resize(x_re, 32);
  ...
  Radix22ButterflyG1_add_cast_2 <= resize(x_im, 32);
  ...
  Radix22ButterflyG1_sub_cast_2 <= resize(x_im, 32);
  ...
  dout_15_re <= dout_15_re_tmp;

  dout_15_im <= dout_15_im_tmp;
