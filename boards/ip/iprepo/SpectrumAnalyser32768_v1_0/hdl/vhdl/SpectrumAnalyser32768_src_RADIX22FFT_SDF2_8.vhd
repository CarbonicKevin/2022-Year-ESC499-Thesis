-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_RADIX22FFT_SDF2_8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_src_RADIX22FFT_SDF2_8
...
ENTITY SpectrumAnalyser32768_src_RADIX22FFT_SDF2_8 IS
...
END SpectrumAnalyser32768_src_RADIX22FFT_SDF2_8;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_RADIX22FFT_SDF2_8 IS
  ...
  COMPONENT SpectrumAnalyser32768_src_SDFCommutator8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser32768_src_SDFCommutator8
    USE ENTITY work.SpectrumAnalyser32768_src_SDFCommutator8(rtl);
...
BEGIN
  u_dataMEM_im_0_8 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_8 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 7,
                 DataWidth => 24
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_8 : SpectrumAnalyser32768_src_SDFCommutator8
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
