-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_SDFCommutator13.vhd
...
ENTITY SpectrumAnalyser32768_src_SDFCommutator13 IS
...
END SpectrumAnalyser32768_src_SDFCommutator13;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_SDFCommutator13 IS
  ...
  SIGNAL dout_13_1_re_tmp                 : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL dout_13_1_im_tmp                 : signed(28 DOWNTO 0);  -- sfix29_En15

BEGIN
  u_dataXMEM_re_0_13 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_13 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 29
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    ...
    END IF;
    dout_13_1_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_13_1_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_13_1_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_13_1_re <= std_logic_vector(dout_13_1_re_tmp);

  dout_13_1_im <= std_logic_vector(dout_13_1_im_tmp);
