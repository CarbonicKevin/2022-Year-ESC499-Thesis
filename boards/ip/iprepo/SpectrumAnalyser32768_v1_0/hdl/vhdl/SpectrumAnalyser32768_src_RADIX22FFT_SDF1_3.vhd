-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_RADIX22FFT_SDF1_3.vhd
...
ENTITY SpectrumAnalyser32768_src_RADIX22FFT_SDF1_3 IS
...
END SpectrumAnalyser32768_src_RADIX22FFT_SDF1_3;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_RADIX22FFT_SDF1_3 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_src_Complex4Multiply
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser32768_src_SDFCommutator3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_3_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser32768_src_Complex4Multiply
    USE ENTITY work.SpectrumAnalyser32768_src_Complex4Multiply(rtl);
  ...
  FOR ALL : SpectrumAnalyser32768_src_SDFCommutator3
    USE ENTITY work.SpectrumAnalyser32768_src_SDFCommutator3(rtl);
  ...
  SIGNAL wrAddr                           : std_logic_vector(11 DOWNTO 0);  -- ufix12
...
BEGIN
  u_MUL4 : SpectrumAnalyser32768_src_Complex4Multiply
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_3 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_3 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 12,
                 DataWidth => 19
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_3 : SpectrumAnalyser32768_src_SDFCommutator3
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_3_vld_dly => din_3_vld_dly,
