-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_axi_lite
-- Source Path: SpectrumAnalyser32768/SpectrumAnalyser32768_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser32768_axi_lite IS
...
END SpectrumAnalyser32768_axi_lite;


ARCHITECTURE rtl OF SpectrumAnalyser32768_axi_lite IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_addr_decoder
  ...
  COMPONENT SpectrumAnalyser32768_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : SpectrumAnalyser32768_addr_decoder
    USE ENTITY work.SpectrumAnalyser32768_addr_decoder(rtl);

  FOR ALL : SpectrumAnalyser32768_axi_lite_module
    USE ENTITY work.SpectrumAnalyser32768_axi_lite_module(rtl);
...
BEGIN
  u_SpectrumAnalyser32768_addr_decoder_inst : SpectrumAnalyser32768_addr_decoder
  ...
  u_SpectrumAnalyser32768_axi_lite_module_inst : SpectrumAnalyser32768_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
