-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_RADIX22FFT_CTRL1_1_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_src_RADIX22FFT_CTRL1_1_block
...
ENTITY SpectrumAnalyser32768_src_RADIX22FFT_CTRL1_1_block IS
...
END SpectrumAnalyser32768_src_RADIX22FFT_CTRL1_1_block;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_RADIX22FFT_CTRL1_1_block IS
...
BEGIN
  ...
  SDFController_output : PROCESS (SDFController_multjState, SDFController_rdAddr_reg, SDFController_rdState,
       SDFController_wrState, dinXTwdl_15_vld, dinXTwdl_15_vld_1)
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_15_Enb <= '0';
        IF (hdlcoder_to_stdlogic(SDFController_wrState = to_unsigned(16#3#, 2)) AND dinXTwdl_15_vld) = '1' THEN 
          SDFController_rdState_next <= to_unsigned(16#1#, 2);
          rd_15_Enb <= dinXTwdl_15_vld_1;
        END IF;
      WHEN "01" =>
        rd_15_Enb <= dinXTwdl_15_vld_1;
        IF dinXTwdl_15_vld_1 = '1' THEN 
          SDFController_rdState_next <= to_unsigned(16#0#, 2);
        END IF;
      WHEN OTHERS => 
        SDFController_rdState_next <= to_unsigned(16#0#, 2);
