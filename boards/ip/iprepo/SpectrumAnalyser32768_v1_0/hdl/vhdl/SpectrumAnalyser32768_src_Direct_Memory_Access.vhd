-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_Direct_Memory_Access.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_src_Direct_Memory_Access
...
ENTITY SpectrumAnalyser32768_src_Direct_Memory_Access IS
...
END SpectrumAnalyser32768_src_Direct_Memory_Access;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_Direct_Memory_Access IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_src_DDR_Communication
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Length                          :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  FOR ALL : SpectrumAnalyser32768_src_DDR_Communication
    USE ENTITY work.SpectrumAnalyser32768_src_DDR_Communication(rtl);
...
BEGIN
  u_DDR_Communication : SpectrumAnalyser32768_src_DDR_Communication
    PORT MAP( clk => clk,
              reset => reset,
