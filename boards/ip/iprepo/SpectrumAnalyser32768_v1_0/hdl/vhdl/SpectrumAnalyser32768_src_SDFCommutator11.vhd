-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_SDFCommutator11.vhd
...
ENTITY SpectrumAnalyser32768_src_SDFCommutator11 IS
...
END SpectrumAnalyser32768_src_SDFCommutator11;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_SDFCommutator11 IS
  ...
  SIGNAL dout_11_1_re_tmp                 : signed(26 DOWNTO 0);  -- sfix27_En15
  SIGNAL dout_11_1_im_tmp                 : signed(26 DOWNTO 0);  -- sfix27_En15

BEGIN
  u_dataXMEM_re_0_11 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_11 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 27
                 )
    PORT MAP( clk => clk,
