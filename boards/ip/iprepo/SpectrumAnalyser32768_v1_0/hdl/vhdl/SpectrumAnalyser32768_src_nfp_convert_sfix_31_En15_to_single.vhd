-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_nfp_convert_sfix_31_En15_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_src_nfp_convert_sfix_31_En15_to_single
...
-- Options/nfp_convert_sfix_31_En15_to_singl
-- Hierarchy Level: 5
-- 
...
ENTITY SpectrumAnalyser32768_src_nfp_convert_sfix_31_En15_to_single IS
...
END SpectrumAnalyser32768_src_nfp_convert_sfix_31_En15_to_single;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_nfp_convert_sfix_31_En15_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(30 DOWNTO 0);  -- sfix31_En15
  SIGNAL Delay_out1                       : signed(30 DOWNTO 0);  -- sfix31_En15
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(30 DOWNTO 0);  -- ufix31_En15
  SIGNAL Unary_Minus_cast                 : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL Unary_Minus_cast_1               : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL Unary_Minus_out1                 : signed(30 DOWNTO 0);  -- sfix31_En15
  SIGNAL Unary_Minus_out1_dtc             : unsigned(30 DOWNTO 0);  -- ufix31_En15
  SIGNAL Switch_out1                      : unsigned(30 DOWNTO 0);  -- ufix31_En15
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(16#00000000#, 31) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(16#00000000#, 31) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(Delay_out1, 32);
  Unary_Minus_cast_1 <=  - (Unary_Minus_cast);
  Unary_Minus_out1 <= Unary_Minus_cast_1(30 DOWNTO 0);
