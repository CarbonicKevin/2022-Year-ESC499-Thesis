-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_RADIX22FFT_SDF1_13.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_src_RADIX22FFT_SDF1_13
...
ENTITY SpectrumAnalyser32768_src_RADIX22FFT_SDF1_13 IS
...
END SpectrumAnalyser32768_src_RADIX22FFT_SDF1_13;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_RADIX22FFT_SDF1_13 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_src_Complex4Multiply_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser32768_src_SDFCommutator13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_13_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser32768_src_Complex4Multiply_block4
    USE ENTITY work.SpectrumAnalyser32768_src_Complex4Multiply_block4(rtl);
  ...
  FOR ALL : SpectrumAnalyser32768_src_SDFCommutator13
    USE ENTITY work.SpectrumAnalyser32768_src_SDFCommutator13(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser32768_src_Complex4Multiply_block4
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_13 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_13 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 2,
                 DataWidth => 29
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_13 : SpectrumAnalyser32768_src_SDFCommutator13
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_13_vld_dly => din_13_vld_dly,
