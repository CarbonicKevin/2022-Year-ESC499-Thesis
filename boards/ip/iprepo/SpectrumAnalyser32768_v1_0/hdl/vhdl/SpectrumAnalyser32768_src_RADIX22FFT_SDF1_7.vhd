-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_RADIX22FFT_SDF1_7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_src_RADIX22FFT_SDF1_7
...
ENTITY SpectrumAnalyser32768_src_RADIX22FFT_SDF1_7 IS
...
END SpectrumAnalyser32768_src_RADIX22FFT_SDF1_7;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_RADIX22FFT_SDF1_7 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_src_Complex4Multiply_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser32768_src_SDFCommutator7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser32768_src_Complex4Multiply_block1
    USE ENTITY work.SpectrumAnalyser32768_src_Complex4Multiply_block1(rtl);
  ...
  FOR ALL : SpectrumAnalyser32768_src_SDFCommutator7
    USE ENTITY work.SpectrumAnalyser32768_src_SDFCommutator7(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser32768_src_Complex4Multiply_block1
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_7 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_7 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 23
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_7 : SpectrumAnalyser32768_src_SDFCommutator7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_7_vld_dly => din_7_vld_dly,
