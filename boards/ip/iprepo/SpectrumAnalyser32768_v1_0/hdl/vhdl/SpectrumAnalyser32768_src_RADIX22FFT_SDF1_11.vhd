-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_RADIX22FFT_SDF1_11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_src_RADIX22FFT_SDF1_11
...
ENTITY SpectrumAnalyser32768_src_RADIX22FFT_SDF1_11 IS
...
END SpectrumAnalyser32768_src_RADIX22FFT_SDF1_11;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_RADIX22FFT_SDF1_11 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_src_Complex4Multiply_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser32768_src_SDFCommutator11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_11_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser32768_src_Complex4Multiply_block3
    USE ENTITY work.SpectrumAnalyser32768_src_Complex4Multiply_block3(rtl);
  ...
  FOR ALL : SpectrumAnalyser32768_src_SDFCommutator11
    USE ENTITY work.SpectrumAnalyser32768_src_SDFCommutator11(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser32768_src_Complex4Multiply_block3
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_11 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_11 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 27
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_11 : SpectrumAnalyser32768_src_SDFCommutator11
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_11_vld_dly => din_11_vld_dly,
