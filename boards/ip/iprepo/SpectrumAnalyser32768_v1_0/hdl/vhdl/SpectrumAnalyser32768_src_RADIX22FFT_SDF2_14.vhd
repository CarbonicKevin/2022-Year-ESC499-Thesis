-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_RADIX22FFT_SDF2_14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_src_RADIX22FFT_SDF2_14
...
ENTITY SpectrumAnalyser32768_src_RADIX22FFT_SDF2_14 IS
...
END SpectrumAnalyser32768_src_RADIX22FFT_SDF2_14;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_RADIX22FFT_SDF2_14 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_src_SDFCommutator14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_13_1_vld                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser32768_src_SDFCommutator14
    USE ENTITY work.SpectrumAnalyser32768_src_SDFCommutator14(rtl);
...
BEGIN
  u_SDFCOMMUTATOR_14 : SpectrumAnalyser32768_src_SDFCommutator14
    PORT MAP( clk => clk,
              reset => reset,
