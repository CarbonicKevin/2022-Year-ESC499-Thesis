-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_DDR_Communication.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_src_DDR_Communication
...
ENTITY SpectrumAnalyser32768_src_DDR_Communication IS
...
END SpectrumAnalyser32768_src_DDR_Communication;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_DDR_Communication IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_src_HDL_FIFO
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser32768_src_Write_Controller
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          valid                           :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser32768_src_HDL_FIFO
    USE ENTITY work.SpectrumAnalyser32768_src_HDL_FIFO(rtl);

  FOR ALL : SpectrumAnalyser32768_src_Write_Controller
    USE ENTITY work.SpectrumAnalyser32768_src_Write_Controller(rtl);
...
BEGIN
  u_HDL_FIFO : SpectrumAnalyser32768_src_HDL_FIFO
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Write_Controller : SpectrumAnalyser32768_src_Write_Controller
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              valid => Valid_Out,
