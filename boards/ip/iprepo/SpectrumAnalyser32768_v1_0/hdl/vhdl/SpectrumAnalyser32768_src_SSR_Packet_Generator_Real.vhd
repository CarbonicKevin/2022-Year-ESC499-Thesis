-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_SSR_Packet_Generator_Real.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_src_SSR_Packet_Generator_Real
...
ENTITY SpectrumAnalyser32768_src_SSR_Packet_Generator_Real IS
...
END SpectrumAnalyser32768_src_SSR_Packet_Generator_Real;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_SSR_Packet_Generator_Real IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_src_TLAST_Generator_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser32768_src_Frame_Dropper_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser32768_src_TLAST_Generator_block
    USE ENTITY work.SpectrumAnalyser32768_src_TLAST_Generator_block(rtl);

  FOR ALL : SpectrumAnalyser32768_src_Frame_Dropper_block
    USE ENTITY work.SpectrumAnalyser32768_src_Frame_Dropper_block(rtl);
...
BEGIN
  u_TLAST_Generator : SpectrumAnalyser32768_src_TLAST_Generator_block
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Frame_Dropper : SpectrumAnalyser32768_src_Frame_Dropper_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
