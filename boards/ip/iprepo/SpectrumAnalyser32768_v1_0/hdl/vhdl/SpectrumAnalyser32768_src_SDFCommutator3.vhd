-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_SDFCommutator3.vhd
...
ENTITY SpectrumAnalyser32768_src_SDFCommutator3 IS
...
END SpectrumAnalyser32768_src_SDFCommutator3;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_SDFCommutator3 IS
...
BEGIN
  u_dataXMEM_re_0_3 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_3 : SpectrumAnalyser32768_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 19
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    ...
    CASE SDFCummutator_mem_btf_switch IS
      ...
      WHEN "01" =>
        SDFCummutator_mem_btf_switch_next <= to_unsigned(16#1#, 2);
        SDFCummutator_rdEnb_xmem_next <= '0';
        IF (hdlcoder_to_stdlogic(SDFCummutator_rdCnt = to_unsigned(16#FFF#, 12)) AND btf_vld) = '1' THEN 
