-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_axi4_stream_imag_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_axi4_stream_imag_slave
-- Source Path: SpectrumAnalyser32768/SpectrumAnalyser32768_axi4_stream_imag_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser32768_axi4_stream_imag_slave IS
...
END SpectrumAnalyser32768_axi4_stream_imag_slave;


ARCHITECTURE rtl OF SpectrumAnalyser32768_axi4_stream_imag_slave IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_fifo_data_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser32768_fifo_data_block
    USE ENTITY work.SpectrumAnalyser32768_fifo_data_block(rtl);
...
BEGIN
  u_SpectrumAnalyser32768_fifo_data_inst : SpectrumAnalyser32768_fifo_data_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
