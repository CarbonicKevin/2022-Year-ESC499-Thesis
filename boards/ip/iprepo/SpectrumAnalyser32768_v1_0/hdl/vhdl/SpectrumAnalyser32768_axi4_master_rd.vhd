-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_axi4_master_rd.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_axi4_master_rd
-- Source Path: SpectrumAnalyser32768/SpectrumAnalyser32768_axi4_master_rd
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser32768_axi4_master_rd IS
...
END SpectrumAnalyser32768_axi4_master_rd;


ARCHITECTURE rtl OF SpectrumAnalyser32768_axi4_master_rd IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_rd_addr_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser32768_rd_len_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser32768_rdata_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : SpectrumAnalyser32768_rd_addr_fifo
    USE ENTITY work.SpectrumAnalyser32768_rd_addr_fifo(rtl);

  FOR ALL : SpectrumAnalyser32768_rd_len_fifo
    USE ENTITY work.SpectrumAnalyser32768_rd_len_fifo(rtl);

  FOR ALL : SpectrumAnalyser32768_rdata_fifo
    USE ENTITY work.SpectrumAnalyser32768_rdata_fifo(rtl);
...
BEGIN
  u_SpectrumAnalyser32768_rd_addr_fifo_inst : SpectrumAnalyser32768_rd_addr_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyser32768_rd_len_fifo_inst : SpectrumAnalyser32768_rd_len_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyser32768_rdata_fifo_inst : SpectrumAnalyser32768_rdata_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
