-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser32768_src_SSR_Serializer_Imag.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser32768_src_SSR_Serializer_Imag
...
ENTITY SpectrumAnalyser32768_src_SSR_Serializer_Imag IS
...
END SpectrumAnalyser32768_src_SSR_Serializer_Imag;


ARCHITECTURE rtl OF SpectrumAnalyser32768_src_SSR_Serializer_Imag IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser32768_src_SSR_to_Vector_block1
    PORT( SSR                             :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
          Vector                          :   OUT   vector_of_std_logic_vector16(0 TO 7)  -- uint16 [8]
          );
  END COMPONENT;

  COMPONENT SpectrumAnalyser32768_src_SSR1_to_SSR8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser32768_src_SSR2_to_SSR8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Data_In                         :   IN    vector_of_std_logic_vector16(0 TO 7);  -- uint16 [8]
  ...
  COMPONENT SpectrumAnalyser32768_src_SSR4_to_SSR8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Data_In                         :   IN    vector_of_std_logic_vector16(0 TO 7);  -- uint16 [8]
  ...
  COMPONENT SpectrumAnalyser32768_src_Vector_to_SSR
  ...
  FOR ALL : SpectrumAnalyser32768_src_SSR_to_Vector_block1
    USE ENTITY work.SpectrumAnalyser32768_src_SSR_to_Vector_block1(rtl);

  FOR ALL : SpectrumAnalyser32768_src_SSR1_to_SSR8
    USE ENTITY work.SpectrumAnalyser32768_src_SSR1_to_SSR8(rtl);

  FOR ALL : SpectrumAnalyser32768_src_SSR2_to_SSR8
    USE ENTITY work.SpectrumAnalyser32768_src_SSR2_to_SSR8(rtl);

  FOR ALL : SpectrumAnalyser32768_src_SSR4_to_SSR8
    USE ENTITY work.SpectrumAnalyser32768_src_SSR4_to_SSR8(rtl);

  FOR ALL : SpectrumAnalyser32768_src_Vector_to_SSR
    USE ENTITY work.SpectrumAnalyser32768_src_Vector_to_SSR(rtl);
...
BEGIN
  u_SSR_to_Vector : SpectrumAnalyser32768_src_SSR_to_Vector_block1
    PORT MAP( SSR => Data_In,  -- ufix128
              Vector => SSR_to_Vector_out1  -- uint16 [8]
              );

  u_SSR1_to_SSR8 : SpectrumAnalyser32768_src_SSR1_to_SSR8
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SSR2_to_SSR8 : SpectrumAnalyser32768_src_SSR2_to_SSR8
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              Data_In => SSR_to_Vector_out1,  -- uint16 [8]
  ...
  u_SSR4_to_SSR8 : SpectrumAnalyser32768_src_SSR4_to_SSR8
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              Data_In => SSR_to_Vector_out1,  -- uint16 [8]
  ...
  u_Vector_to_SSR : SpectrumAnalyser32768_src_Vector_to_SSR
