-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_RADIX2FFT_bitNatural.vhd
...
ENTITY SpectrumAnalyser65536_src_RADIX2FFT_bitNatural IS
...
END SpectrumAnalyser65536_src_RADIX2FFT_bitNatural;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_RADIX2FFT_bitNatural IS
  ...
  SIGNAL wrStateMachineBitNatural_wrAddrCnt : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL wrStateMachineBitNatural_wrState_next : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL wrStateMachineBitNatural_wrAddrCnt_next : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL WrEnb                            : std_logic;
  SIGNAL wrAddr                           : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL sampleIdx                        : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL rdAddr                           : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL memOut_im                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL memOut_im_signed                 : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL memOut_re                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL memOut_re_signed                 : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL rdStateMachineBitNatural_rdState : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL rdStateMachineBitNatural_rdAddrCnt : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL rdStateMachineBitNatural_doutVldReg1 : std_logic;
  SIGNAL rdStateMachineBitNatural_doutVldReg2 : std_logic;
  SIGNAL rdStateMachineBitNatural_doutReReg : signed(31 DOWNTO 0);  -- sfix32
  SIGNAL rdStateMachineBitNatural_doutImReg : signed(31 DOWNTO 0);  -- sfix32
  ...
  SIGNAL rdStateMachineBitNatural_rdAddrCnt_next : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL rdStateMachineBitNatural_doutVldReg1_next : std_logic;
  SIGNAL rdStateMachineBitNatural_doutVldReg2_next : std_logic;
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(31 DOWNTO 0);  -- sfix32_En15
  ...
  SIGNAL dout_re1_tmp                     : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL dout_im1_tmp                     : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL startOutW                        : std_logic;
  SIGNAL endOutW                          : std_logic;

BEGIN
  u_dataMEM_im_1 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_1 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 16,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      wrStateMachineBitNatural_wrAddrCnt <= to_unsigned(16#0000#, 16);
  ...
  wrStateMachineBitNatural_output : PROCESS (dout_16_1_vld, wrStateMachineBitNatural_wrAddrCnt,
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdStateMachineBitNatural_rdAddrCnt <= to_unsigned(16#0000#, 16);
      rdStateMachineBitNatural_doutVldReg1 <= '0';
      rdStateMachineBitNatural_doutVldReg2 <= '0';
      rdStateMachineBitNatural_doutReReg <= to_signed(0, 32);
      rdStateMachineBitNatural_doutImReg <= to_signed(0, 32);
  ...
  BEGIN
    ...
    CASE rdStateMachineBitNatural_rdState IS
      WHEN "00" =>
        ...
        ELSE 
          rdStateMachineBitNatural_rdAddrCnt_next <= to_unsigned(16#0000#, 16);
          rdStateMachineBitNatural_rdState_next <= to_unsigned(16#0#, 2);
          rdStateMachineBitNatural_endOutReg1_next <= '0';
        END IF;
      WHEN "01" =>
        rdStateMachineBitNatural_doutVldReg1_next <= '1';
        IF rdStateMachineBitNatural_rdAddrCnt = to_unsigned(16#FFFF#, 16) THEN 
          rdStateMachineBitNatural_rdAddrCnt_next <= to_unsigned(16#0000#, 16);
          rdStateMachineBitNatural_rdState_next <= to_unsigned(16#2#, 2);
          rdStateMachineBitNatural_endOutReg1_next <= '1';
        ELSE 
          rdStateMachineBitNatural_rdAddrCnt_next <= rdStateMachineBitNatural_rdAddrCnt + to_unsigned(16#0001#, 16);
          rdStateMachineBitNatural_rdState_next <= to_unsigned(16#1#, 2);
          rdStateMachineBitNatural_endOutReg1_next <= '0';
        END IF;
      WHEN "10" =>
