-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_RADIX22FFT_SDF1_15.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_RADIX22FFT_SDF1_15
...
ENTITY SpectrumAnalyser65536_src_RADIX22FFT_SDF1_15 IS
...
END SpectrumAnalyser65536_src_RADIX22FFT_SDF1_15;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_RADIX22FFT_SDF1_15 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_Complex4Multiply_block5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_SDFCommutator15
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_15_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_src_Complex4Multiply_block5
    USE ENTITY work.SpectrumAnalyser65536_src_Complex4Multiply_block5(rtl);

  FOR ALL : SpectrumAnalyser65536_src_SDFCommutator15
    USE ENTITY work.SpectrumAnalyser65536_src_SDFCommutator15(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser65536_src_Complex4Multiply_block5
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_15 : SpectrumAnalyser65536_src_SDFCommutator15
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_15_vld_dly => din_15_vld_dly,
