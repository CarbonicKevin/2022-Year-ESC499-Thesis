-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_SSR_Deserializer_Real.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_SSR_Deserializer_Real
...
ENTITY SpectrumAnalyser65536_src_SSR_Deserializer_Real IS
...
END SpectrumAnalyser65536_src_SSR_Deserializer_Real;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_SSR_Deserializer_Real IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_Subsystem_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Set                             :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_HDL_FIFO_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_Subsystem1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Set                             :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_SSR_to_Vector_block
    PORT( SSR                             :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
          Vector                          :   OUT   vector_of_std_logic_vector16(0 TO 7)  -- uint16 [8]
          );
  END COMPONENT;

  COMPONENT SpectrumAnalyser65536_src_HDL_FIFO1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_src_Subsystem_block
    USE ENTITY work.SpectrumAnalyser65536_src_Subsystem_block(rtl);

  FOR ALL : SpectrumAnalyser65536_src_HDL_FIFO_block1
    USE ENTITY work.SpectrumAnalyser65536_src_HDL_FIFO_block1(rtl);

  FOR ALL : SpectrumAnalyser65536_src_Subsystem1_block
    USE ENTITY work.SpectrumAnalyser65536_src_Subsystem1_block(rtl);

  FOR ALL : SpectrumAnalyser65536_src_SSR_to_Vector_block
    USE ENTITY work.SpectrumAnalyser65536_src_SSR_to_Vector_block(rtl);

  FOR ALL : SpectrumAnalyser65536_src_HDL_FIFO1_block
    USE ENTITY work.SpectrumAnalyser65536_src_HDL_FIFO1_block(rtl);
...
BEGIN
  u_Subsystem : SpectrumAnalyser65536_src_Subsystem_block
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_HDL_FIFO : SpectrumAnalyser65536_src_HDL_FIFO_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_Subsystem1 : SpectrumAnalyser65536_src_Subsystem1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              Set => Delay_out1,
  ...
  u_SSR_to_Vector : SpectrumAnalyser65536_src_SSR_to_Vector_block
    PORT MAP( SSR => HDL_FIFO_out1,  -- ufix128
              Vector => SSR_to_Vector_out1  -- uint16 [8]
              );

  u_HDL_FIFO1 : SpectrumAnalyser65536_src_HDL_FIFO1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
