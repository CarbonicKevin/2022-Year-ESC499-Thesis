-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_FFT_and_Spectrum_Processing.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_FFT_and_Spectrum_Processing
...
ENTITY SpectrumAnalyser65536_src_FFT_and_Spectrum_Processing IS
...
END SpectrumAnalyser65536_src_FFT_and_Spectrum_Processing;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_FFT_and_Spectrum_Processing IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_Convert_Data
  ...
  COMPONENT SpectrumAnalyser65536_src_FFT_Core
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_Spectrum_Options
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Units_rsvd                      :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  FOR ALL : SpectrumAnalyser65536_src_Convert_Data
    USE ENTITY work.SpectrumAnalyser65536_src_Convert_Data(rtl);

  FOR ALL : SpectrumAnalyser65536_src_FFT_Core
    USE ENTITY work.SpectrumAnalyser65536_src_FFT_Core(rtl);

  FOR ALL : SpectrumAnalyser65536_src_Spectrum_Options
    USE ENTITY work.SpectrumAnalyser65536_src_Spectrum_Options(rtl);
  ...
  SIGNAL FFT_Core_out1_re                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL FFT_Core_out1_im                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_Convert_Data : SpectrumAnalyser65536_src_Convert_Data
  ...
  u_FFT_Core : SpectrumAnalyser65536_src_FFT_Core
    PORT MAP( clk => clk,
              reset => reset,
              ...
              Data_Out_re => FFT_Core_out1_re,  -- sfix32_En15
              Data_Out_im => FFT_Core_out1_im,  -- sfix32_En15
              Start => FFT_Core_out2,
              End_rsvd => FFT_Core_out3,
              Valid_Out => FFT_Core_out4
              );

  u_Spectrum_Options : SpectrumAnalyser65536_src_Spectrum_Options
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              ...
              Vrms => Vrms,  -- uint32
              Data_In_re => FFT_Core_out1_re,  -- sfix32_En15
              Data_In_im => FFT_Core_out1_im,  -- sfix32_En15
