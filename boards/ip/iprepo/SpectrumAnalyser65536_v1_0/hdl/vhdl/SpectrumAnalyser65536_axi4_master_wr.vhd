-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_axi4_master_wr.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_axi4_master_wr
-- Source Path: SpectrumAnalyser65536/SpectrumAnalyser65536_axi4_master_wr
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser65536_axi4_master_wr IS
...
END SpectrumAnalyser65536_axi4_master_wr;


ARCHITECTURE rtl OF SpectrumAnalyser65536_axi4_master_wr IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_wdata_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_wr_addr_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT SpectrumAnalyser65536_wr_data_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT SpectrumAnalyser65536_wr_len_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT SpectrumAnalyser65536_wlast_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_wdata_fifo
    USE ENTITY work.SpectrumAnalyser65536_wdata_fifo(rtl);

  FOR ALL : SpectrumAnalyser65536_wr_addr_fifo
    USE ENTITY work.SpectrumAnalyser65536_wr_addr_fifo(rtl);

  FOR ALL : SpectrumAnalyser65536_wr_data_fifo
    USE ENTITY work.SpectrumAnalyser65536_wr_data_fifo(rtl);

  FOR ALL : SpectrumAnalyser65536_wr_len_fifo
    USE ENTITY work.SpectrumAnalyser65536_wr_len_fifo(rtl);

  FOR ALL : SpectrumAnalyser65536_wlast_fifo
    USE ENTITY work.SpectrumAnalyser65536_wlast_fifo(rtl);
...
BEGIN
  u_SpectrumAnalyser65536_wdata_fifo_inst : SpectrumAnalyser65536_wdata_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyser65536_wr_addr_fifo_inst : SpectrumAnalyser65536_wr_addr_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyser65536_wr_data_fifo_inst : SpectrumAnalyser65536_wr_data_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyser65536_wr_len_fifo_inst : SpectrumAnalyser65536_wr_len_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyser65536_wlast_fifo_inst : SpectrumAnalyser65536_wlast_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
