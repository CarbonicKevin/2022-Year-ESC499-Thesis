-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_FFT_Core.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_FFT_Core
...
ENTITY SpectrumAnalyser65536_src_FFT_Core IS
...
END SpectrumAnalyser65536_src_FFT_Core;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_FFT_Core IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_FFT_HDL_Optimized_65536
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_src_FFT_HDL_Optimized_65536
    USE ENTITY work.SpectrumAnalyser65536_src_FFT_HDL_Optimized_65536(rtl);
...
BEGIN
  u_FFT_HDL_Optimized_65536 : SpectrumAnalyser65536_src_FFT_HDL_Optimized_65536
    PORT MAP( clk => clk,
              reset => reset,
  ...
  Compare_To_Constant_out1 <= '1' WHEN Selector_unsigned = to_unsigned(16#10#, 8) ELSE
      '0';

  AND1_out1 <= Valid_In AND Compare_To_Constant_out1;

  Start <= FFT_HDL_Optimized_65536_out2;

  End_rsvd <= FFT_HDL_Optimized_65536_out3;

  Valid_Out <= FFT_HDL_Optimized_65536_out4;

  Data_Out_re <= FFT_HDL_Optimized_65536_out1_re;

  Data_Out_im <= FFT_HDL_Optimized_65536_out1_im;
