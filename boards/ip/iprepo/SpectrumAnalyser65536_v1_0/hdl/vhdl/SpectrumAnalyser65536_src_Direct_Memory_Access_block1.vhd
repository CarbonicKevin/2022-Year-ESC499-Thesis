-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_Direct_Memory_Access_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_Direct_Memory_Access_block1
...
ENTITY SpectrumAnalyser65536_src_Direct_Memory_Access_block1 IS
...
END SpectrumAnalyser65536_src_Direct_Memory_Access_block1;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_Direct_Memory_Access_block1 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_EdgeDetection
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_DDR_Read_Controller
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_src_EdgeDetection
    USE ENTITY work.SpectrumAnalyser65536_src_EdgeDetection(rtl);

  FOR ALL : SpectrumAnalyser65536_src_DDR_Read_Controller
    USE ENTITY work.SpectrumAnalyser65536_src_DDR_Read_Controller(rtl);
...
BEGIN
  u_EdgeDetection : SpectrumAnalyser65536_src_EdgeDetection
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_DDR_Read_Controller : SpectrumAnalyser65536_src_DDR_Read_Controller
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
