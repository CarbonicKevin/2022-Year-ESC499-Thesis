-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_RADIX22FFT_SDF2_2.vhd
...
ENTITY SpectrumAnalyser65536_src_RADIX22FFT_SDF2_2 IS
...
END SpectrumAnalyser65536_src_RADIX22FFT_SDF2_2;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_RADIX22FFT_SDF2_2 IS
  ...
  COMPONENT SpectrumAnalyser65536_src_SDFCommutator2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_src_SDFCommutator2
    USE ENTITY work.SpectrumAnalyser65536_src_SDFCommutator2(rtl);
...
BEGIN
  u_dataMEM_im_0_2 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_2 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 14,
                 DataWidth => 18
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_2 : SpectrumAnalyser65536_src_SDFCommutator2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
