-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_SDFCommutator1.vhd
...
ENTITY SpectrumAnalyser65536_src_SDFCommutator1 IS
  PORT( clk                               :   IN    std_logic;
        ...
        wrAddr                            :   OUT   std_logic_vector(14 DOWNTO 0);  -- ufix15
        wrEnb                             :   OUT   std_logic;
...
END SpectrumAnalyser65536_src_SDFCommutator1;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_SDFCommutator1 IS
  ...
  SIGNAL SDFCummutator_wrAddr_reg_next    : unsigned(14 DOWNTO 0);  -- ufix15
  ...
  SIGNAL SDFCummutator_rdCnt_next         : unsigned(14 DOWNTO 0);  -- ufix15
  ...
  SIGNAL wrAddr_tmp                       : unsigned(14 DOWNTO 0);  -- ufix15
...
BEGIN
  u_dataXMEM_re_0_1 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_1 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 17
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      SDFCummutator_wrAddr_reg <= to_unsigned(16#0000#, 15);
      SDFCummutator_rdCnt <= to_unsigned(16#0000#, 15);
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      WHEN "000" =>
        ...
        IF ((SDFCummutator_wrEnb_xmem AND hdlcoder_to_stdlogic(SDFCummutator_wrAddr_reg = to_unsigned(16#7FF7#, 15))) AND SDFCummutator_wrEnb_reg) = '1' THEN 
    ...
    CASE SDFCummutator_mem_btf_switch IS
      WHEN "00" =>
        ...
        SDFCummutator_rdCnt_next <= to_unsigned(16#0000#, 15);
      ...
      WHEN "01" =>
        SDFCummutator_mem_btf_switch_next <= to_unsigned(16#1#, 2);
        SDFCummutator_rdEnb_xmem_next <= '0';
        IF (hdlcoder_to_stdlogic(SDFCummutator_rdCnt = to_unsigned(16#7FFF#, 15)) AND btf_vld) = '1' THEN 
          SDFCummutator_mem_btf_switch_next <= to_unsigned(16#2#, 2);
        END IF;
        IF btf_vld = '1' THEN 
          SDFCummutator_rdCnt_next <= SDFCummutator_rdCnt + to_unsigned(16#0001#, 15);
        END IF;
      ...
      WHEN "10" =>
        SDFCummutator_mem_btf_switch_next <= to_unsigned(16#2#, 2);
        IF (hdlcoder_to_stdlogic(SDFCummutator_rdCnt = to_unsigned(16#7FF7#, 15)) AND xf_vld) = '1' THEN 
          SDFCummutator_mem_btf_switch_next <= to_unsigned(16#1#, 2);
          SDFCummutator_rdEnb_xmem_next <= '1';
        END IF;
        IF xf_vld = '1' THEN 
          IF SDFCummutator_rdCnt = to_unsigned(16#7FF7#, 15) THEN 
            SDFCummutator_rdCnt_next <= to_unsigned(16#0000#, 15);
          ELSE 
            SDFCummutator_rdCnt_next <= SDFCummutator_rdCnt + to_unsigned(16#0001#, 15);
          END IF;
    ...
    CASE SDFCummutator_wrState IS
      WHEN "000" =>
        ...
        SDFCummutator_wrAddr_reg_next <= to_unsigned(16#0000#, 15);
      ...
      WHEN "001" =>
        ...
        SDFCummutator_wrEnb_xmem_next <= '0';
        IF SDFCummutator_wrAddr_reg = to_unsigned(16#7FFF#, 15) THEN 
          IF btf_vld = '1' THEN 
        ...
        ELSIF dinxTwdlf_vld = '1' THEN 
          SDFCummutator_wrState_next <= to_unsigned(16#1#, 3);
          SDFCummutator_wrAddr_reg_next <= SDFCummutator_wrAddr_reg + to_unsigned(16#0001#, 15);
          SDFCummutator_wrEnb_reg_next <= '1';
          SDFCummutator_wrData_re_reg_next <= dinXTwdlf_re_signed;
          SDFCummutator_wrData_im_reg_next <= dinXTwdlf_im_signed;
        END IF;
      WHEN "010" =>
        ...
        SDFCummutator_wrEnb_reg_next <= '0';
        SDFCummutator_wrEnb_xmem_next <= '0';
        IF SDFCummutator_wrAddr_reg = to_unsigned(16#7FF6#, 15) THEN 
          SDFCummutator_wrEnb_xmem_next <= '1';
        END IF;
        IF SDFCummutator_wrAddr_reg = to_unsigned(16#7FF7#, 15) THEN 
          SDFCummutator_wrAddr_reg_next <= SDFCummutator_wrAddr_reg + to_unsigned(16#0001#, 15);
