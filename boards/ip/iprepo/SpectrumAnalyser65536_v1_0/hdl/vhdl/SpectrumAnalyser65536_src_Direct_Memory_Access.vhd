-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_Direct_Memory_Access.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_Direct_Memory_Access
...
ENTITY SpectrumAnalyser65536_src_Direct_Memory_Access IS
...
END SpectrumAnalyser65536_src_Direct_Memory_Access;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_Direct_Memory_Access IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_DDR_Communication
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Length                          :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  FOR ALL : SpectrumAnalyser65536_src_DDR_Communication
    USE ENTITY work.SpectrumAnalyser65536_src_DDR_Communication(rtl);
...
BEGIN
  u_DDR_Communication : SpectrumAnalyser65536_src_DDR_Communication
    PORT MAP( clk => clk,
              reset => reset,
