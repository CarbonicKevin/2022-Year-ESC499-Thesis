-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_Direct_Memory_Access_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_Direct_Memory_Access_block
...
ENTITY SpectrumAnalyser65536_src_Direct_Memory_Access_block IS
...
END SpectrumAnalyser65536_src_Direct_Memory_Access_block;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_Direct_Memory_Access_block IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_Direct_Memory_Access
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Length                          :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  FOR ALL : SpectrumAnalyser65536_src_Direct_Memory_Access
    USE ENTITY work.SpectrumAnalyser65536_src_Direct_Memory_Access(rtl);
...
BEGIN
  u_Direct_Memory_Access : SpectrumAnalyser65536_src_Direct_Memory_Access
    PORT MAP( clk => clk,
              reset => reset,
