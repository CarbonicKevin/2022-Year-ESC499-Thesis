-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_axi4_stream_real_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_axi4_stream_real_slave
-- Source Path: SpectrumAnalyser65536/SpectrumAnalyser65536_axi4_stream_real_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser65536_axi4_stream_real_slave IS
...
END SpectrumAnalyser65536_axi4_stream_real_slave;


ARCHITECTURE rtl OF SpectrumAnalyser65536_axi4_stream_real_slave IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_fifo_data
    USE ENTITY work.SpectrumAnalyser65536_fifo_data(rtl);
...
BEGIN
  u_SpectrumAnalyser65536_fifo_data_inst : SpectrumAnalyser65536_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
