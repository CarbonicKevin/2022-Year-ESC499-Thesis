-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_SDFCommutator16.vhd
...
ENTITY SpectrumAnalyser65536_src_SDFCommutator16 IS
...
END SpectrumAnalyser65536_src_SDFCommutator16;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_SDFCommutator16 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL xf_im_signed                     : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL dinf_re_signed                   : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL dinf_im_signed                   : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL btf1_re_signed                   : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL btf1_im_signed                   : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL btf2_re_signed                   : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL btf2_im_signed                   : signed(31 DOWNTO 0);  -- sfix32_En15
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL SDFCummutator_out_im_next        : signed(31 DOWNTO 0);  -- sfix32_En15
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(31 DOWNTO 0);  -- sfix32_En15
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL SDFCummutator_btf1_vld_dly_next  : std_logic;
  SIGNAL wrData_re_tmp                    : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL wrData_im_tmp                    : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL xData_re                         : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL xData_im                         : signed(31 DOWNTO 0);  -- sfix32_En15
  ...
  SIGNAL dout0_re                         : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL dout0_im                         : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL xX_re_signed                     : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL xX_im                            : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL xX_im_signed                     : signed(31 DOWNTO 0);  -- sfix32_En15
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_16_1_re_tmp                 : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL dout_16_1_im_tmp                 : signed(31 DOWNTO 0);  -- sfix32_En15

BEGIN
  u_dataXMEM_re_0_16 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_16 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    ...
    END IF;
    dout_16_1_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_16_1_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_16_1_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_16_1_re <= std_logic_vector(dout_16_1_re_tmp);

  dout_16_1_im <= std_logic_vector(dout_16_1_im_tmp);
