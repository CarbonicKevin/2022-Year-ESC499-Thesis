-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_RADIX22FFT_SDF2_8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_RADIX22FFT_SDF2_8
...
ENTITY SpectrumAnalyser65536_src_RADIX22FFT_SDF2_8 IS
...
END SpectrumAnalyser65536_src_RADIX22FFT_SDF2_8;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_RADIX22FFT_SDF2_8 IS
  ...
  COMPONENT SpectrumAnalyser65536_src_SDFCommutator8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_src_SDFCommutator8
    USE ENTITY work.SpectrumAnalyser65536_src_SDFCommutator8(rtl);
...
BEGIN
  u_dataMEM_im_0_8 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_8 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 24
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_8 : SpectrumAnalyser65536_src_SDFCommutator8
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
