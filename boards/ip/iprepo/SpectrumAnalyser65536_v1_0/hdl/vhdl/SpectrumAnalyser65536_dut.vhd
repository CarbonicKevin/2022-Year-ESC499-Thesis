-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_dut
-- Source Path: SpectrumAnalyser65536/SpectrumAnalyser65536_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser65536_dut IS
...
END SpectrumAnalyser65536_dut;


ARCHITECTURE rtl OF SpectrumAnalyser65536_dut IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_Spectrum_Analyser
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_src_Spectrum_Analyser
    USE ENTITY work.SpectrumAnalyser65536_src_Spectrum_Analyser(rtl);
...
BEGIN
  u_SpectrumAnalyser65536_src_Spectrum_Analyser : SpectrumAnalyser65536_src_Spectrum_Analyser
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
