-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_Preprocessing_Window.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_Preprocessing_Window
...
ENTITY SpectrumAnalyser65536_src_Preprocessing_Window IS
...
END SpectrumAnalyser65536_src_Preprocessing_Window;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_Preprocessing_Window IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_Direct_Memory_Access_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_DualPortRAM_generic
  ...
  FOR ALL : SpectrumAnalyser65536_src_Direct_Memory_Access_block1
    USE ENTITY work.SpectrumAnalyser65536_src_Direct_Memory_Access_block1(rtl);

  FOR ALL : SpectrumAnalyser65536_src_DualPortRAM_generic
    USE ENTITY work.SpectrumAnalyser65536_src_DualPortRAM_generic(rtl);
...
BEGIN
  u_Direct_Memory_Access : SpectrumAnalyser65536_src_Direct_Memory_Access_block1
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Dual_Port_RAM_System : SpectrumAnalyser65536_src_DualPortRAM_generic
