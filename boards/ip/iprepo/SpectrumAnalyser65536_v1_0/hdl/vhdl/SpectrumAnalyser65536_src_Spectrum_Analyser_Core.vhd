-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_Spectrum_Analyser_Core.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_Spectrum_Analyser_Core
...
ENTITY SpectrumAnalyser65536_src_Spectrum_Analyser_Core IS
...
END SpectrumAnalyser65536_src_Spectrum_Analyser_Core;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_Spectrum_Analyser_Core IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_SSR_Subset_Converter
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Packet_Size                     :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  COMPONENT SpectrumAnalyser65536_src_Preprocessing_Window
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_FFT_and_Spectrum_Processing
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Units_rsvd                      :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  FOR ALL : SpectrumAnalyser65536_src_SSR_Subset_Converter
    USE ENTITY work.SpectrumAnalyser65536_src_SSR_Subset_Converter(rtl);

  FOR ALL : SpectrumAnalyser65536_src_Preprocessing_Window
    USE ENTITY work.SpectrumAnalyser65536_src_Preprocessing_Window(rtl);

  FOR ALL : SpectrumAnalyser65536_src_FFT_and_Spectrum_Processing
    USE ENTITY work.SpectrumAnalyser65536_src_FFT_and_Spectrum_Processing(rtl);
...
BEGIN
  u_SSR_Subset_Converter : SpectrumAnalyser65536_src_SSR_Subset_Converter
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Preprocessing_Window : SpectrumAnalyser65536_src_Preprocessing_Window
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_FFT_and_Spectrum_Processing : SpectrumAnalyser65536_src_FFT_and_Spectrum_Processing
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
