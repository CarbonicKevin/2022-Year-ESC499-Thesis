-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_axi_lite
-- Source Path: SpectrumAnalyser65536/SpectrumAnalyser65536_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser65536_axi_lite IS
...
END SpectrumAnalyser65536_axi_lite;


ARCHITECTURE rtl OF SpectrumAnalyser65536_axi_lite IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_addr_decoder
  ...
  COMPONENT SpectrumAnalyser65536_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : SpectrumAnalyser65536_addr_decoder
    USE ENTITY work.SpectrumAnalyser65536_addr_decoder(rtl);

  FOR ALL : SpectrumAnalyser65536_axi_lite_module
    USE ENTITY work.SpectrumAnalyser65536_axi_lite_module(rtl);
...
BEGIN
  u_SpectrumAnalyser65536_addr_decoder_inst : SpectrumAnalyser65536_addr_decoder
  ...
  u_SpectrumAnalyser65536_axi_lite_module_inst : SpectrumAnalyser65536_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
