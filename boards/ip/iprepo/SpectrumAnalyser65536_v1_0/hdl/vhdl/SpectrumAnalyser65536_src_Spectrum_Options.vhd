-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_Spectrum_Options.vhd
-- Created: 2023-03-21 14:56:42
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_Spectrum_Options
...
ENTITY SpectrumAnalyser65536_src_Spectrum_Options IS
  PORT( clk                               :   IN    std_logic;
        ...
        Data_In_re                        :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En15
        Data_In_im                        :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En15
...
END SpectrumAnalyser65536_src_Spectrum_Options;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_Spectrum_Options IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_nfp_wire_single_block
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
          );
  END COMPONENT;

  COMPONENT SpectrumAnalyser65536_src_nfp_convert_sfix_32_En15_to_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En15
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
          );
  END COMPONENT;

  COMPONENT SpectrumAnalyser65536_src_nfp_hypot_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_nfp_mul_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT SpectrumAnalyser65536_src_nfp_relop_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT SpectrumAnalyser65536_src_nfp_relop_single_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT SpectrumAnalyser65536_src_nfp_log10_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_nfp_pow10_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT SpectrumAnalyser65536_src_nfp_wire_single
  ...
  FOR ALL : SpectrumAnalyser65536_src_nfp_wire_single_block
    USE ENTITY work.SpectrumAnalyser65536_src_nfp_wire_single_block(rtl);

  FOR ALL : SpectrumAnalyser65536_src_nfp_convert_sfix_32_En15_to_single
    USE ENTITY work.SpectrumAnalyser65536_src_nfp_convert_sfix_32_En15_to_single(rtl);

  FOR ALL : SpectrumAnalyser65536_src_nfp_hypot_single
    USE ENTITY work.SpectrumAnalyser65536_src_nfp_hypot_single(rtl);

  FOR ALL : SpectrumAnalyser65536_src_nfp_mul_single
    USE ENTITY work.SpectrumAnalyser65536_src_nfp_mul_single(rtl);

  FOR ALL : SpectrumAnalyser65536_src_nfp_relop_single
    USE ENTITY work.SpectrumAnalyser65536_src_nfp_relop_single(rtl);

  FOR ALL : SpectrumAnalyser65536_src_nfp_relop_single_block
    USE ENTITY work.SpectrumAnalyser65536_src_nfp_relop_single_block(rtl);

  FOR ALL : SpectrumAnalyser65536_src_nfp_log10_single
    USE ENTITY work.SpectrumAnalyser65536_src_nfp_log10_single(rtl);

  FOR ALL : SpectrumAnalyser65536_src_nfp_pow10_single
    USE ENTITY work.SpectrumAnalyser65536_src_nfp_pow10_single(rtl);

  FOR ALL : SpectrumAnalyser65536_src_nfp_wire_single
    USE ENTITY work.SpectrumAnalyser65536_src_nfp_wire_single(rtl);
...
BEGIN
  ...
  u_nfp_wire_single : SpectrumAnalyser65536_src_nfp_wire_single_block
    PORT MAP( nfp_in => Power_Scale,  -- uint32
              nfp_out => Float_Typecast2_out1  -- single
              );

  u_spectrum_analyser_Spectrum_Analyser_Spectrum_Analyser_Spectrum_Analyser_Core_FFT_and_Spectrum_Processing_Spectrum_Options_nfp_convert_sfix_32_En15_to_single : SpectrumAnalyser65536_src_nfp_convert_sfix_32_En15_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              nfp_in => Data_In_re,  -- sfix32_En15
              nfp_out => nfp_out_1_re  -- single
              );

  u_spectrum_analyser_Spectrum_Analyser_Spectrum_Analyser_Spectrum_Analyser_Core_FFT_and_Spectrum_Processing_Spectrum_Options_nfp_convert_sfix_32_En15_to_single_1 : SpectrumAnalyser65536_src_nfp_convert_sfix_32_En15_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              nfp_in => Data_In_im,  -- sfix32_En15
              nfp_out => nfp_out_1_im  -- single
              );

  u_nfp_hypot_comp : SpectrumAnalyser65536_src_nfp_hypot_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_mul_comp : SpectrumAnalyser65536_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_mul_comp_1 : SpectrumAnalyser65536_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_wire_single_1 : SpectrumAnalyser65536_src_nfp_wire_single_block
    PORT MAP( nfp_in => Type_Scale,  -- uint32
              nfp_out => Float_Typecast1_out1  -- single
              );

  u_nfp_mul_comp_2 : SpectrumAnalyser65536_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_mul_comp_3 : SpectrumAnalyser65536_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_relop_comp : SpectrumAnalyser65536_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_relop_comp_1 : SpectrumAnalyser65536_src_nfp_relop_single_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              nfp_in1 => Multiport_Switch1_out1,  -- single
  ...
  u_nfp_log10_comp : SpectrumAnalyser65536_src_nfp_log10_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_mul_comp_4 : SpectrumAnalyser65536_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_mul_comp_5 : SpectrumAnalyser65536_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_pow10_comp : SpectrumAnalyser65536_src_nfp_pow10_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_mul_comp_6 : SpectrumAnalyser65536_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_wire_single_2 : SpectrumAnalyser65536_src_nfp_wire_single
