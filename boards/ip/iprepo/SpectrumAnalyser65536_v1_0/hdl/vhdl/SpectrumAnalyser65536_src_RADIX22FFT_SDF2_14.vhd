-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_RADIX22FFT_SDF2_14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_RADIX22FFT_SDF2_14
...
ENTITY SpectrumAnalyser65536_src_RADIX22FFT_SDF2_14 IS
...
END SpectrumAnalyser65536_src_RADIX22FFT_SDF2_14;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_RADIX22FFT_SDF2_14 IS
  ...
  COMPONENT SpectrumAnalyser65536_src_SDFCommutator14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_13_1_vld                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_src_SDFCommutator14
    USE ENTITY work.SpectrumAnalyser65536_src_SDFCommutator14(rtl);
  ...
  SIGNAL x_im                             : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL x_im_signed                      : signed(29 DOWNTO 0);  -- sfix30_En15
  SIGNAL x_im_dly                         : signed(29 DOWNTO 0);  -- sfix30_En15
  SIGNAL wrData_re                        : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL x_re                             : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL x_re_signed                      : signed(29 DOWNTO 0);  -- sfix30_En15
...
BEGIN
  u_dataMEM_im_0_14 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_14 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 2,
                 DataWidth => 30
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_14 : SpectrumAnalyser65536_src_SDFCommutator14
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  btfin_vld <= dout_13_1_vld AND proc_14_enb;
  ...
  Radix22ButterflyG2_output : PROCESS (Radix22ButterflyG2_btf1_im_reg, Radix22ButterflyG2_btf1_re_reg,
       ...
       dinVld, din_im, din_re, multiply_14_J, x_im_dly, x_re_dly, x_vld_dly)
