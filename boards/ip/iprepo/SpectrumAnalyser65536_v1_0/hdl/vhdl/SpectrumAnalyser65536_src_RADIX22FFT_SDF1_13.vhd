-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_RADIX22FFT_SDF1_13.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_RADIX22FFT_SDF1_13
...
ENTITY SpectrumAnalyser65536_src_RADIX22FFT_SDF1_13 IS
...
END SpectrumAnalyser65536_src_RADIX22FFT_SDF1_13;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_RADIX22FFT_SDF1_13 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_Complex4Multiply_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_SDFCommutator13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_13_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_src_Complex4Multiply_block4
    USE ENTITY work.SpectrumAnalyser65536_src_Complex4Multiply_block4(rtl);
  ...
  FOR ALL : SpectrumAnalyser65536_src_SDFCommutator13
    USE ENTITY work.SpectrumAnalyser65536_src_SDFCommutator13(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser65536_src_Complex4Multiply_block4
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_13 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_13 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 29
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_13 : SpectrumAnalyser65536_src_SDFCommutator13
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_13_vld_dly => din_13_vld_dly,
