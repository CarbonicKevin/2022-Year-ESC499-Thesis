-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_RADIX22FFT_CTRL1_16.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_RADIX22FFT_CTRL1_16
...
ENTITY SpectrumAnalyser65536_src_RADIX22FFT_CTRL1_16 IS
...
END SpectrumAnalyser65536_src_RADIX22FFT_CTRL1_16;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_RADIX22FFT_CTRL1_16 IS
...
BEGIN
  ...
  SDFController_output : PROCESS (SDFController_multjState, SDFController_rdAddr_reg, SDFController_rdState,
       SDFController_wrState, dinXTwdl_16_1_vld, dout_15_1_vld)
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_16_Enb <= '0';
        IF (hdlcoder_to_stdlogic(SDFController_wrState = to_unsigned(16#3#, 2)) AND dout_15_1_vld) = '1' THEN 
          SDFController_rdState_next <= to_unsigned(16#1#, 2);
          rd_16_Enb <= dinXTwdl_16_1_vld;
        END IF;
      WHEN "01" =>
        rd_16_Enb <= dinXTwdl_16_1_vld;
        IF dinXTwdl_16_1_vld = '1' THEN 
          SDFController_rdState_next <= to_unsigned(16#0#, 2);
        END IF;
      WHEN OTHERS => 
        SDFController_rdState_next <= to_unsigned(16#0#, 2);
    ...
    CASE SDFController_wrState IS
      ...
      WHEN OTHERS => 
        ...
        proc_16_enb <= '0';
    END CASE;
    rd_16_Addr <= SDFController_rdAddr_reg;
