-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_axi_lite_module
-- Source Path: SpectrumAnalyser65536/SpectrumAnalyser65536_axi_lite/SpectrumAnalyser65536_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser65536_axi_lite_module IS
...
END SpectrumAnalyser65536_axi_lite_module;


ARCHITECTURE rtl OF SpectrumAnalyser65536_axi_lite_module IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_reset_hold
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_reset_hold
    USE ENTITY work.SpectrumAnalyser65536_reset_hold(rtl);
...
BEGIN
  u_SpectrumAnalyser65536_reset_hold_inst : SpectrumAnalyser65536_reset_hold
    PORT MAP( clk => clk,
              reset => reset,
