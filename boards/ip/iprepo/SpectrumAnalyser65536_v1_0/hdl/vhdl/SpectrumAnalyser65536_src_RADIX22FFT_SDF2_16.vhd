-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_RADIX22FFT_SDF2_16.vhd
...
ENTITY SpectrumAnalyser65536_src_RADIX22FFT_SDF2_16 IS
...
END SpectrumAnalyser65536_src_RADIX22FFT_SDF2_16;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_RADIX22FFT_SDF2_16 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_SDFCommutator16
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_15_1_vld                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En15
          xf_im                           :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En15
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En15
          dinf_im                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En15
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En15
          btf1_im                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En15
          btf2_re                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En15
          btf2_im                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En15
          btfout_vld                      :   IN    std_logic;
          softReset                       :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32_En15
          wrData_im                       :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32_En15
  ...
  FOR ALL : SpectrumAnalyser65536_src_SDFCommutator16
    USE ENTITY work.SpectrumAnalyser65536_src_SDFCommutator16(rtl);

  -- Signals
  SIGNAL dout_15_1_re_signed              : signed(30 DOWNTO 0);  -- sfix31_En15
  SIGNAL din_re                           : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL dout_15_1_im_signed              : signed(30 DOWNTO 0);  -- sfix31_En15
  SIGNAL din_im                           : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL saveEnb                          : std_logic;
  SIGNAL dinVld                           : std_logic;
  SIGNAL din_re_dly1                      : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL btfin_re                         : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL din_im_dly1                      : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL btfin_im                         : signed(31 DOWNTO 0);  -- sfix32_En15
  ...
  SIGNAL btf2_im                          : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL btf2_re                          : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL btf1_im                          : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL btf1_re                          : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL dinf_im                          : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL dinf_re                          : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL xf_im                            : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL x_im                             : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL x_im_dly                         : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL wrData_im                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL wrData_im_signed                 : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL wrData_re                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL wrData_re_signed                 : signed(31 DOWNTO 0);  -- sfix32_En15
  ...
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL x_re                             : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL x_re_dly                         : signed(31 DOWNTO 0);  -- sfix32_En15
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(32 DOWNTO 0);  -- sfix33_En15
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(32 DOWNTO 0);  -- sfix33_En15
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(32 DOWNTO 0);  -- sfix33_En15
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(32 DOWNTO 0);  -- sfix33_En15
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinf_vld                         : std_logic;
  SIGNAL btfout_vld                       : std_logic;
  SIGNAL dout_16_1_re_tmp                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL dout_16_1_im_tmp                 : std_logic_vector(31 DOWNTO 0);  -- ufix32

BEGIN
  u_SDFCOMMUTATOR_16 : SpectrumAnalyser65536_src_SDFCommutator16
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_15_1_vld => dout_15_1_vld,
              xf_re => std_logic_vector(xf_re),  -- sfix32_En15
              xf_im => std_logic_vector(xf_im),  -- sfix32_En15
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix32_En15
              dinf_im => std_logic_vector(dinf_im),  -- sfix32_En15
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix32_En15
              btf1_im => std_logic_vector(btf1_im),  -- sfix32_En15
              btf2_re => std_logic_vector(btf2_re),  -- sfix32_En15
              btf2_im => std_logic_vector(btf2_im),  -- sfix32_En15
              btfout_vld => btfout_vld,
              softReset => softReset,
              wrData_re => wrData_re,  -- sfix32_En15
              wrData_im => wrData_im,  -- sfix32_En15
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_16_1_re => dout_16_1_re_tmp,  -- sfix32_En15
              dout_16_1_im => dout_16_1_im_tmp,  -- sfix32_En15
              dout_16_1_vld => dout_16_1_vld
              );

  dout_15_1_re_signed <= signed(dout_15_1_re);

  din_re <= resize(dout_15_1_re_signed, 32);

  dout_15_1_im_signed <= signed(dout_15_1_im);

  din_im <= resize(dout_15_1_im_signed, 32);

  saveEnb <=  NOT proc_16_enb;

  dinVld <= dout_15_1_vld AND saveEnb;
  ...
  mulIn_vld <= dout_15_1_vld AND proc_16_enb;
  ...
  twoLocationReg_0_output : PROCESS (rd_16_Addr, twoLocationReg_0_MEM_im_0, twoLocationReg_0_MEM_im_1,
  ...
  Radix22ButterflyG2_output : PROCESS (Radix22ButterflyG2_btf1_im_reg, Radix22ButterflyG2_btf1_re_reg,
    ...
    VARIABLE add_cast_6 : signed(32 DOWNTO 0);
  ...
  BEGIN
    ...
    IF Radix22ButterflyG2_multiply_J_dly1 = '1' THEN 
      add_cast_1 := resize(x_re_dly, 33);
      add_cast_2 := resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 33);
      Radix22ButterflyG2_btf1_re_reg_next <= add_cast_1 + add_cast_2;
      sub_cast_1 := resize(x_re_dly, 33);
      sub_cast_2 := resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 33);
      Radix22ButterflyG2_btf2_re_reg_next <= sub_cast_1 - sub_cast_2;
      add_cast_5 := resize(x_im_dly, 33);
      add_cast_6 := resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 33);
      Radix22ButterflyG2_btf2_im_reg_next <= add_cast_5 + add_cast_6;
      sub_cast_5 := resize(x_im_dly, 33);
      sub_cast_6 := resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 33);
      Radix22ButterflyG2_btf1_im_reg_next <= sub_cast_5 - sub_cast_6;
    ELSE 
      add_cast := resize(x_re_dly, 33);
      add_cast_0 := resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 33);
      Radix22ButterflyG2_btf1_re_reg_next <= add_cast + add_cast_0;
      sub_cast := resize(x_re_dly, 33);
      sub_cast_0 := resize(Radix22ButterflyG2_dinXTwdl_re_dly2, 33);
      Radix22ButterflyG2_btf2_re_reg_next <= sub_cast - sub_cast_0;
      add_cast_3 := resize(x_im_dly, 33);
      add_cast_4 := resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 33);
      Radix22ButterflyG2_btf1_im_reg_next <= add_cast_3 + add_cast_4;
      sub_cast_3 := resize(x_im_dly, 33);
      sub_cast_4 := resize(Radix22ButterflyG2_dinXTwdl_im_dly2, 33);
    ...
    Radix22ButterflyG2_multiply_J_dly1_next <= multiply_16_J;
  ...
  dinXTwdl_16_1_vld <= btfin_vld;

  dout_16_1_re <= dout_16_1_re_tmp;

  dout_16_1_im <= dout_16_1_im_tmp;
