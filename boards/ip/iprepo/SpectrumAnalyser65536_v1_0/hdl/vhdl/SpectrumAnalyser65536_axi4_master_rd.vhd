-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_axi4_master_rd.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_axi4_master_rd
-- Source Path: SpectrumAnalyser65536/SpectrumAnalyser65536_axi4_master_rd
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser65536_axi4_master_rd IS
...
END SpectrumAnalyser65536_axi4_master_rd;


ARCHITECTURE rtl OF SpectrumAnalyser65536_axi4_master_rd IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_rd_addr_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_rd_len_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_rdata_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : SpectrumAnalyser65536_rd_addr_fifo
    USE ENTITY work.SpectrumAnalyser65536_rd_addr_fifo(rtl);

  FOR ALL : SpectrumAnalyser65536_rd_len_fifo
    USE ENTITY work.SpectrumAnalyser65536_rd_len_fifo(rtl);

  FOR ALL : SpectrumAnalyser65536_rdata_fifo
    USE ENTITY work.SpectrumAnalyser65536_rdata_fifo(rtl);
...
BEGIN
  u_SpectrumAnalyser65536_rd_addr_fifo_inst : SpectrumAnalyser65536_rd_addr_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyser65536_rd_len_fifo_inst : SpectrumAnalyser65536_rd_len_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyser65536_rdata_fifo_inst : SpectrumAnalyser65536_rdata_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
