-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_SSR_Packet_Generator_Imag.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_SSR_Packet_Generator_Imag
...
ENTITY SpectrumAnalyser65536_src_SSR_Packet_Generator_Imag IS
...
END SpectrumAnalyser65536_src_SSR_Packet_Generator_Imag;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_SSR_Packet_Generator_Imag IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_TLAST_Generator
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_Frame_Dropper
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_src_TLAST_Generator
    USE ENTITY work.SpectrumAnalyser65536_src_TLAST_Generator(rtl);

  FOR ALL : SpectrumAnalyser65536_src_Frame_Dropper
    USE ENTITY work.SpectrumAnalyser65536_src_Frame_Dropper(rtl);
...
BEGIN
  u_TLAST_Generator : SpectrumAnalyser65536_src_TLAST_Generator
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Frame_Dropper : SpectrumAnalyser65536_src_Frame_Dropper
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
