-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_SSR_Deserializer_Imag.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_SSR_Deserializer_Imag
...
ENTITY SpectrumAnalyser65536_src_SSR_Deserializer_Imag IS
...
END SpectrumAnalyser65536_src_SSR_Deserializer_Imag;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_SSR_Deserializer_Imag IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser65536_src_Subsystem
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Set                             :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_HDL_FIFO_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser65536_src_Subsystem1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Set                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser65536_src_Subsystem
    USE ENTITY work.SpectrumAnalyser65536_src_Subsystem(rtl);

  FOR ALL : SpectrumAnalyser65536_src_HDL_FIFO_block
    USE ENTITY work.SpectrumAnalyser65536_src_HDL_FIFO_block(rtl);

  FOR ALL : SpectrumAnalyser65536_src_Subsystem1
    USE ENTITY work.SpectrumAnalyser65536_src_Subsystem1(rtl);

  FOR ALL : SpectrumAnalyser65536_src_SSR_to_Vector
    USE ENTITY work.SpectrumAnalyser65536_src_SSR_to_Vector(rtl);

  FOR ALL : SpectrumAnalyser65536_src_HDL_FIFO1
    USE ENTITY work.SpectrumAnalyser65536_src_HDL_FIFO1(rtl);
...
BEGIN
  u_Subsystem : SpectrumAnalyser65536_src_Subsystem
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_HDL_FIFO : SpectrumAnalyser65536_src_HDL_FIFO_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_Subsystem1 : SpectrumAnalyser65536_src_Subsystem1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              Set => Delay_out1,
  ...
  u_SSR_to_Vector : SpectrumAnalyser65536_src_SSR_to_Vector
    PORT MAP( SSR => HDL_FIFO_out1,  -- ufix128
              Vector => SSR_to_Vector_out1  -- uint16 [8]
              );

  u_HDL_FIFO1 : SpectrumAnalyser65536_src_HDL_FIFO1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
