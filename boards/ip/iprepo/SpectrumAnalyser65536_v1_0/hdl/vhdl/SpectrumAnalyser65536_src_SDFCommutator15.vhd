-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_SDFCommutator15.vhd
...
ENTITY SpectrumAnalyser65536_src_SDFCommutator15 IS
...
END SpectrumAnalyser65536_src_SDFCommutator15;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_SDFCommutator15 IS
  ...
  SIGNAL dout_15_1_re_tmp                 : signed(30 DOWNTO 0);  -- sfix31_En15
  SIGNAL dout_15_1_im_tmp                 : signed(30 DOWNTO 0);  -- sfix31_En15

BEGIN
  u_dataXMEM_re_0_15 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_15 : SpectrumAnalyser65536_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 31
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    ...
    END IF;
    dout_15_1_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_15_1_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_15_1_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_15_1_re <= std_logic_vector(dout_15_1_re_tmp);

  dout_15_1_im <= std_logic_vector(dout_15_1_im_tmp);
