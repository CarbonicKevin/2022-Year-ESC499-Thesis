-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser65536_src_nfp_convert_sfix_32_En15_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser65536_src_nfp_convert_sfix_32_En15_to_single
...
-- Options/nfp_convert_sfix_32_En15_to_singl
-- Hierarchy Level: 5
-- 
...
ENTITY SpectrumAnalyser65536_src_nfp_convert_sfix_32_En15_to_single IS
...
END SpectrumAnalyser65536_src_nfp_convert_sfix_32_En15_to_single;


ARCHITECTURE rtl OF SpectrumAnalyser65536_src_nfp_convert_sfix_32_En15_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(31 DOWNTO 0);  -- sfix32_En15
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(31 DOWNTO 0);  -- ufix32_En15
  SIGNAL Unary_Minus_cast                 : signed(32 DOWNTO 0);  -- sfix33_En15
  SIGNAL Unary_Minus_cast_1               : signed(32 DOWNTO 0);  -- sfix33_En15
  SIGNAL Unary_Minus_out1                 : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL Unary_Minus_out1_dtc             : unsigned(31 DOWNTO 0);  -- ufix32_En15
  SIGNAL Switch_out1                      : unsigned(31 DOWNTO 0);  -- ufix32_En15
...
BEGIN
  ...
  Unary_Minus_cast <= resize(Delay_out1, 33);
