-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser4096_src_RADIX22FFT_SDF2_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser4096_src_RADIX22FFT_SDF2_2
...
ENTITY SpectrumAnalyser4096_src_RADIX22FFT_SDF2_2 IS
...
END SpectrumAnalyser4096_src_RADIX22FFT_SDF2_2;


ARCHITECTURE rtl OF SpectrumAnalyser4096_src_RADIX22FFT_SDF2_2 IS
  ...
  COMPONENT SpectrumAnalyser4096_src_SDFCommutator2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser4096_src_SDFCommutator2
    USE ENTITY work.SpectrumAnalyser4096_src_SDFCommutator2(rtl);
...
BEGIN
  u_dataMEM_im_0_2 : SpectrumAnalyser4096_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_2 : SpectrumAnalyser4096_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 18
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_2 : SpectrumAnalyser4096_src_SDFCommutator2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
