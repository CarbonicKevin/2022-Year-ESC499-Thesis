-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser4096_src_nfp_convert_sfix_28_En15_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser4096_src_nfp_convert_sfix_28_En15_to_single
...
-- Options/nfp_convert_sfix_28_En15_to_singl
-- Hierarchy Level: 5
-- 
...
ENTITY SpectrumAnalyser4096_src_nfp_convert_sfix_28_En15_to_single IS
...
END SpectrumAnalyser4096_src_nfp_convert_sfix_28_En15_to_single;


ARCHITECTURE rtl OF SpectrumAnalyser4096_src_nfp_convert_sfix_28_En15_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL Delay_out1                       : signed(27 DOWNTO 0);  -- sfix28_En15
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(27 DOWNTO 0);  -- ufix28_En15
  SIGNAL Unary_Minus_cast                 : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL Unary_Minus_cast_1               : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL Unary_Minus_out1                 : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL Unary_Minus_out1_dtc             : unsigned(27 DOWNTO 0);  -- ufix28_En15
  SIGNAL Switch_out1                      : unsigned(27 DOWNTO 0);  -- ufix28_En15
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(16#0000000#, 28) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(16#0000000#, 28) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(Delay_out1, 29);
