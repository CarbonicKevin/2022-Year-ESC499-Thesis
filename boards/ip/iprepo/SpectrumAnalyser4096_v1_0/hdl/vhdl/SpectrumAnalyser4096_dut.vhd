-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser4096_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser4096_dut
-- Source Path: SpectrumAnalyser4096/SpectrumAnalyser4096_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser4096_dut IS
...
END SpectrumAnalyser4096_dut;


ARCHITECTURE rtl OF SpectrumAnalyser4096_dut IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser4096_src_Spectrum_Analyser
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser4096_src_Spectrum_Analyser
    USE ENTITY work.SpectrumAnalyser4096_src_Spectrum_Analyser(rtl);
...
BEGIN
  u_SpectrumAnalyser4096_src_Spectrum_Analyser : SpectrumAnalyser4096_src_Spectrum_Analyser
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
