-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser4096_src_SDFCommutator12.vhd
...
ENTITY SpectrumAnalyser4096_src_SDFCommutator12 IS
...
END SpectrumAnalyser4096_src_SDFCommutator12;


ARCHITECTURE rtl OF SpectrumAnalyser4096_src_SDFCommutator12 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser4096_src_SimpleDualPortRAM_generic
  ...
  FOR ALL : SpectrumAnalyser4096_src_SimpleDualPortRAM_generic
    USE ENTITY work.SpectrumAnalyser4096_src_SimpleDualPortRAM_generic(rtl);

  -- Signals
  SIGNAL xf_re_signed                     : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL xf_im_signed                     : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL dinf_re_signed                   : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL dinf_im_signed                   : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL btf1_re_signed                   : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL btf1_im_signed                   : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL btf2_re_signed                   : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL btf2_im_signed                   : signed(27 DOWNTO 0);  -- sfix28_En15
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL SDFCummutator_out_im_next        : signed(27 DOWNTO 0);  -- sfix28_En15
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(27 DOWNTO 0);  -- sfix28_En15
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL SDFCummutator_btf1_vld_dly_next  : std_logic;
  SIGNAL wrData_re_tmp                    : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL wrData_im_tmp                    : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL xData_re                         : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL xData_im                         : signed(27 DOWNTO 0);  -- sfix28_En15
  ...
  SIGNAL dout0_re                         : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL dout0_im                         : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(27 DOWNTO 0);  -- ufix28
  SIGNAL xX_re_signed                     : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL xX_im                            : std_logic_vector(27 DOWNTO 0);  -- ufix28
  SIGNAL xX_im_signed                     : signed(27 DOWNTO 0);  -- sfix28_En15
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_12_1_re_tmp                 : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL dout_12_1_im_tmp                 : signed(27 DOWNTO 0);  -- sfix28_En15

BEGIN
  u_dataXMEM_re_0_12 : SpectrumAnalyser4096_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_12 : SpectrumAnalyser4096_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 28
                 )
    PORT MAP( clk => clk,
