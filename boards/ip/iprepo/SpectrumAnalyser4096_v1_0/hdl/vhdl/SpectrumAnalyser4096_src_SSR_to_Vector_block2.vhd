-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser4096_src_SSR_to_Vector_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser4096_src_SSR_to_Vector_block2
...
ENTITY SpectrumAnalyser4096_src_SSR_to_Vector_block2 IS
  PORT( SSR                               :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
        Vector                            :   OUT   vector_of_std_logic_vector16(0 TO 7)  -- uint16 [8]
        );
END SpectrumAnalyser4096_src_SSR_to_Vector_block2;


ARCHITECTURE rtl OF SpectrumAnalyser4096_src_SSR_to_Vector_block2 IS
