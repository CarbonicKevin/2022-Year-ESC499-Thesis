-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser4096_src_RADIX22FFT_SDF2_10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser4096_src_RADIX22FFT_SDF2_10
...
ENTITY SpectrumAnalyser4096_src_RADIX22FFT_SDF2_10 IS
...
END SpectrumAnalyser4096_src_RADIX22FFT_SDF2_10;


ARCHITECTURE rtl OF SpectrumAnalyser4096_src_RADIX22FFT_SDF2_10 IS
  ...
  COMPONENT SpectrumAnalyser4096_src_SDFCommutator10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_9_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser4096_src_SDFCommutator10
    USE ENTITY work.SpectrumAnalyser4096_src_SDFCommutator10(rtl);
...
BEGIN
  u_dataMEM_im_0_10 : SpectrumAnalyser4096_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_10 : SpectrumAnalyser4096_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 2,
                 DataWidth => 26
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_10 : SpectrumAnalyser4096_src_SDFCommutator10
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
