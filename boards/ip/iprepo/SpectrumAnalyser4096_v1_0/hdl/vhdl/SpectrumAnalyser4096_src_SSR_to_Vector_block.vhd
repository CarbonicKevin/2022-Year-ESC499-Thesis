-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser4096_src_SSR_to_Vector_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser4096_src_SSR_to_Vector_block
...
ENTITY SpectrumAnalyser4096_src_SSR_to_Vector_block IS
  PORT( SSR                               :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
        Vector                            :   OUT   vector_of_std_logic_vector16(0 TO 7)  -- uint16 [8]
        );
END SpectrumAnalyser4096_src_SSR_to_Vector_block;


ARCHITECTURE rtl OF SpectrumAnalyser4096_src_SSR_to_Vector_block IS
