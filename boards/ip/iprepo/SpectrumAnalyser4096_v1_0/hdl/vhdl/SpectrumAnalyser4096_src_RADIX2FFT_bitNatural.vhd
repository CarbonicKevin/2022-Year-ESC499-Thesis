-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser4096_src_RADIX2FFT_bitNatural.vhd
...
ENTITY SpectrumAnalyser4096_src_RADIX2FFT_bitNatural IS
...
END SpectrumAnalyser4096_src_RADIX2FFT_bitNatural;


ARCHITECTURE rtl OF SpectrumAnalyser4096_src_RADIX2FFT_bitNatural IS
  ...
  SIGNAL memOut_im_signed                 : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL memOut_re                        : std_logic_vector(27 DOWNTO 0);  -- ufix28
  SIGNAL memOut_re_signed                 : signed(27 DOWNTO 0);  -- sfix28_En15
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(27 DOWNTO 0);  -- sfix28_En15
  ...
  SIGNAL dout_re1_tmp                     : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL dout_im1_tmp                     : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL startOutW                        : std_logic;
  SIGNAL endOutW                          : std_logic;

BEGIN
  u_dataMEM_im_1 : SpectrumAnalyser4096_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_1 : SpectrumAnalyser4096_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 12,
                 DataWidth => 28
                 )
    PORT MAP( clk => clk,
