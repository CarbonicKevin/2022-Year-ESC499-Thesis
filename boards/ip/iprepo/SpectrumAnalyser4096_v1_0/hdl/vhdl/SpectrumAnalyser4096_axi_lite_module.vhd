-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser4096_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser4096_axi_lite_module
-- Source Path: SpectrumAnalyser4096/SpectrumAnalyser4096_axi_lite/SpectrumAnalyser4096_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser4096_axi_lite_module IS
...
END SpectrumAnalyser4096_axi_lite_module;


ARCHITECTURE rtl OF SpectrumAnalyser4096_axi_lite_module IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser4096_reset_hold
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser4096_reset_hold
    USE ENTITY work.SpectrumAnalyser4096_reset_hold(rtl);
...
BEGIN
  u_SpectrumAnalyser4096_reset_hold_inst : SpectrumAnalyser4096_reset_hold
    PORT MAP( clk => clk,
              reset => reset,
