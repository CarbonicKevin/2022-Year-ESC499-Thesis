-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser4096_axi4_stream_imag_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser4096_axi4_stream_imag_slave
-- Source Path: SpectrumAnalyser4096/SpectrumAnalyser4096_axi4_stream_imag_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser4096_axi4_stream_imag_slave IS
...
END SpectrumAnalyser4096_axi4_stream_imag_slave;


ARCHITECTURE rtl OF SpectrumAnalyser4096_axi4_stream_imag_slave IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser4096_fifo_data_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser4096_fifo_data_block
    USE ENTITY work.SpectrumAnalyser4096_fifo_data_block(rtl);
...
BEGIN
  u_SpectrumAnalyser4096_fifo_data_inst : SpectrumAnalyser4096_fifo_data_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
