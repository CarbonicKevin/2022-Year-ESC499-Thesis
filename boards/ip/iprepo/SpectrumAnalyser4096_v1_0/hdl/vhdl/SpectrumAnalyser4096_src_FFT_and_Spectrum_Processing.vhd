-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser4096_src_FFT_and_Spectrum_Processing.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser4096_src_FFT_and_Spectrum_Processing
...
ENTITY SpectrumAnalyser4096_src_FFT_and_Spectrum_Processing IS
...
END SpectrumAnalyser4096_src_FFT_and_Spectrum_Processing;


ARCHITECTURE rtl OF SpectrumAnalyser4096_src_FFT_and_Spectrum_Processing IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser4096_src_Convert_Data
  ...
  COMPONENT SpectrumAnalyser4096_src_FFT_Core
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser4096_src_Spectrum_Options
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Units_rsvd                      :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  FOR ALL : SpectrumAnalyser4096_src_Convert_Data
    USE ENTITY work.SpectrumAnalyser4096_src_Convert_Data(rtl);

  FOR ALL : SpectrumAnalyser4096_src_FFT_Core
    USE ENTITY work.SpectrumAnalyser4096_src_FFT_Core(rtl);

  FOR ALL : SpectrumAnalyser4096_src_Spectrum_Options
    USE ENTITY work.SpectrumAnalyser4096_src_Spectrum_Options(rtl);
...
BEGIN
  u_Convert_Data : SpectrumAnalyser4096_src_Convert_Data
  ...
  u_FFT_Core : SpectrumAnalyser4096_src_FFT_Core
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Spectrum_Options : SpectrumAnalyser4096_src_Spectrum_Options
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
