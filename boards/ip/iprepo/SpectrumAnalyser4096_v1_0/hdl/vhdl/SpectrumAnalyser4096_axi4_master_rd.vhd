-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser4096_axi4_master_rd.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser4096_axi4_master_rd
-- Source Path: SpectrumAnalyser4096/SpectrumAnalyser4096_axi4_master_rd
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser4096_axi4_master_rd IS
...
END SpectrumAnalyser4096_axi4_master_rd;


ARCHITECTURE rtl OF SpectrumAnalyser4096_axi4_master_rd IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser4096_rd_addr_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser4096_rd_len_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser4096_rdata_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : SpectrumAnalyser4096_rd_addr_fifo
    USE ENTITY work.SpectrumAnalyser4096_rd_addr_fifo(rtl);

  FOR ALL : SpectrumAnalyser4096_rd_len_fifo
    USE ENTITY work.SpectrumAnalyser4096_rd_len_fifo(rtl);

  FOR ALL : SpectrumAnalyser4096_rdata_fifo
    USE ENTITY work.SpectrumAnalyser4096_rdata_fifo(rtl);
...
BEGIN
  u_SpectrumAnalyser4096_rd_addr_fifo_inst : SpectrumAnalyser4096_rd_addr_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyser4096_rd_len_fifo_inst : SpectrumAnalyser4096_rd_len_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyser4096_rdata_fifo_inst : SpectrumAnalyser4096_rdata_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
