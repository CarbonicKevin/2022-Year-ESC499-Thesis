-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_7_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_7_block1
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_7_block1 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_7_block1;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_7_block1 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_Complex4Multiply_block14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator7_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Complex4Multiply_block14
    USE ENTITY work.SpectrumAnalyserCustom_src_Complex4Multiply_block14(rtl);
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator7_block1
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator7_block1(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyserCustom_src_Complex4Multiply_block14
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_7 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_7 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 23
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_7 : SpectrumAnalyserCustom_src_SDFCommutator7_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_7_vld_dly => din_7_vld_dly,
