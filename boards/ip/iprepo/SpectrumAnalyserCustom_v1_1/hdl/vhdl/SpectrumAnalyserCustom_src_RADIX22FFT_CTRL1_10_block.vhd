-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_10_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_10_block
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_10_block IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_10_block;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_10_block IS
  ...
  SIGNAL rd_10_Addr_tmp                   : unsigned(4 DOWNTO 0);  -- ufix5
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_10_Enb <= '0';
        IF (dout_9_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#1F#, 5))) = '1' THEN 
