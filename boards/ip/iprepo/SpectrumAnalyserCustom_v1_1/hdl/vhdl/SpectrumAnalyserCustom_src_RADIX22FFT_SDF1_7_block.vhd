-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_7_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_7_block
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_7_block IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_7_block;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_7_block IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator7_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator7_block
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator7_block(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_7 : SpectrumAnalyserCustom_src_SDFCommutator7_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_7_vld_dly => din_7_vld_dly,
