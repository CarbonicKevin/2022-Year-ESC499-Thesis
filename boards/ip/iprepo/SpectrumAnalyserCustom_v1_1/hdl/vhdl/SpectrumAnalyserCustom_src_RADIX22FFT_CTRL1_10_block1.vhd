-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_10_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_10_block1
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_10_block1 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_10_block1;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_10_block1 IS
  ...
  SIGNAL rd_10_Addr_tmp                   : unsigned(5 DOWNTO 0);  -- ufix6
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_10_Enb <= '0';
        IF (dout_9_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3F#, 6))) = '1' THEN 
