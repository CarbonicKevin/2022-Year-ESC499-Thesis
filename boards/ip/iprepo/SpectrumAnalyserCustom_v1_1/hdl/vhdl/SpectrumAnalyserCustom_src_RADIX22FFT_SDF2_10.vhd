-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_10
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_10 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_10;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_10 IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_9_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator10
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator10(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_10 : SpectrumAnalyserCustom_src_SDFCommutator10
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
