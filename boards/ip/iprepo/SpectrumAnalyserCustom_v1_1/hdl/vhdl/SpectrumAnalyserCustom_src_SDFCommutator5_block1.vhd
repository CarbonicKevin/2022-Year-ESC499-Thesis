-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_SDFCommutator5_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_SDFCommutator5_block1
...
ENTITY SpectrumAnalyserCustom_src_SDFCommutator5_block1 IS
...
END SpectrumAnalyserCustom_src_SDFCommutator5_block1;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_SDFCommutator5_block1 IS
...
BEGIN
  u_dataXMEM_re_0_5 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_5 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 21
                 )
    PORT MAP( clk => clk,
