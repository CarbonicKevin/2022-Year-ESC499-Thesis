-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_13_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_13_block1
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_13_block1 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_13_block1;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_13_block1 IS
  ...
  SIGNAL rd_13_Addr_tmp                   : unsigned(2 DOWNTO 0);  -- ufix3
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_13_Enb <= '0';
        IF (dinXTwdl_13_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7#, 3))) = '1' THEN 
