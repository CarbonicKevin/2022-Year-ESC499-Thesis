-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_3_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_3_block1
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_3_block1 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_3_block1;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_3_block1 IS
  ...
  -- Signals
  SIGNAL SDFController_wrCount            : unsigned(12 DOWNTO 0);  -- ufix13
  SIGNAL SDFController_wrState            : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL SDFController_rdState            : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL SDFController_rdAddr_reg         : unsigned(12 DOWNTO 0);  -- ufix13
  ...
  SIGNAL SDFController_wrCount_next       : unsigned(12 DOWNTO 0);  -- ufix13
  SIGNAL SDFController_wrState_next       : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL SDFController_rdState_next       : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL SDFController_rdAddr_reg_next    : unsigned(12 DOWNTO 0);  -- ufix13
  ...
  SIGNAL rd_3_Addr_tmp                    : unsigned(12 DOWNTO 0);  -- ufix13
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      SDFController_wrCount <= to_unsigned(16#0000#, 13);
      SDFController_rdAddr_reg <= to_unsigned(16#0000#, 13);
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        SDFController_rdAddr_reg_next <= to_unsigned(16#0000#, 13);
        rd_3_Enb <= '0';
        IF (dinXTwdl_3_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#1FFF#, 13))) = '1' THEN 
      ...
      WHEN "01" =>
        ...
        IF dinXTwdl_3_1_vld_1 = '1' THEN 
          IF SDFController_rdAddr_reg = to_unsigned(16#1FFF#, 13) THEN 
            SDFController_rdState_next <= to_unsigned(16#2#, 2);
          END IF;
          SDFController_rdAddr_reg_next <= SDFController_rdAddr_reg + to_unsigned(16#0001#, 13);
        END IF;
      WHEN "10" =>
        rd_3_Enb <= '1';
        IF SDFController_rdAddr_reg = to_unsigned(16#1FFF#, 13) THEN 
    ...
    CASE SDFController_wrState IS
      WHEN "00" =>
        ...
        SDFController_wrCount_next <= to_unsigned(16#0000#, 13);
        SDFController_procEnb_reg_next <= '0';
        IF dinXTwdl_3_1_vld = '1' THEN 
          SDFController_wrState_next <= to_unsigned(16#1#, 2);
          SDFController_wrCount_next <= to_unsigned(16#0001#, 13);
        END IF;
      WHEN "01" =>
        SDFController_wrState_next <= to_unsigned(16#1#, 2);
        SDFController_procEnb_reg_next <= '0';
        IF dinXTwdl_3_1_vld = '1' THEN 
          IF SDFController_wrCount = to_unsigned(16#1FFF#, 13) THEN 
            SDFController_wrState_next <= to_unsigned(16#2#, 2);
            SDFController_procEnb_reg_next <= '1';
          ELSE 
            SDFController_wrState_next <= to_unsigned(16#1#, 2);
          END IF;
          SDFController_wrCount_next <= SDFController_wrCount + to_unsigned(16#0001#, 13);
        END IF;
      WHEN "10" =>
        SDFController_wrState_next <= to_unsigned(16#2#, 2);
        IF dinXTwdl_3_1_vld = '1' THEN 
      ...
      WHEN OTHERS => 
        SDFController_wrState_next <= to_unsigned(16#0#, 2);
        SDFController_wrCount_next <= to_unsigned(16#1FFF#, 13);
        SDFController_procEnb_reg_next <= '0';
    END CASE;
