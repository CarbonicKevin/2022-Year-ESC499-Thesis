-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_Complex4Multiply_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_5_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Complex4Multiply_block
    USE ENTITY work.SpectrumAnalyserCustom_src_Complex4Multiply_block(rtl);
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator5
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator5(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyserCustom_src_Complex4Multiply_block
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_5 : SpectrumAnalyserCustom_src_SDFCommutator5
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_5_vld_dly => din_5_vld_dly,
