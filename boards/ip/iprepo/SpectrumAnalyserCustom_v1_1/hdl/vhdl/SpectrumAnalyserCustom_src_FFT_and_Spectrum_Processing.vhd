-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_FFT_and_Spectrum_Processing.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_FFT_and_Spectrum_Processing
...
ENTITY SpectrumAnalyserCustom_src_FFT_and_Spectrum_Processing IS
...
END SpectrumAnalyserCustom_src_FFT_and_Spectrum_Processing;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_FFT_and_Spectrum_Processing IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_Convert_Data
  ...
  COMPONENT SpectrumAnalyserCustom_src_FFT_Core
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_Spectrum_Options
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Units_rsvd                      :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Convert_Data
    USE ENTITY work.SpectrumAnalyserCustom_src_Convert_Data(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_FFT_Core
    USE ENTITY work.SpectrumAnalyserCustom_src_FFT_Core(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_Spectrum_Options
    USE ENTITY work.SpectrumAnalyserCustom_src_Spectrum_Options(rtl);
...
BEGIN
  u_Convert_Data : SpectrumAnalyserCustom_src_Convert_Data
  ...
  u_FFT_Core : SpectrumAnalyserCustom_src_FFT_Core
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Spectrum_Options : SpectrumAnalyserCustom_src_Spectrum_Options
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
