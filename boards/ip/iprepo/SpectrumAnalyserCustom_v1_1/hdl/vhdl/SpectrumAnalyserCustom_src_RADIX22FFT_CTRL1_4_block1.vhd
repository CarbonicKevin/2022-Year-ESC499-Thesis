-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block1
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block1 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block1;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block1 IS
  ...
  SIGNAL rd_4_Addr_tmp                    : unsigned(11 DOWNTO 0);  -- ufix12
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_4_Enb <= '0';
        IF (dout_3_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#FFF#, 12))) = '1' THEN 
