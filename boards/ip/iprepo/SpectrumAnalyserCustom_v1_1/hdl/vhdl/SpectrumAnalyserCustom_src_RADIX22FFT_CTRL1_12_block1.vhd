-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_12_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_12_block1
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_12_block1 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_12_block1;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_12_block1 IS
  ...
  SIGNAL rd_12_Addr_tmp                   : unsigned(3 DOWNTO 0);  -- ufix4
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_12_Enb <= '0';
        IF (dout_11_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#F#, 4))) = '1' THEN 
