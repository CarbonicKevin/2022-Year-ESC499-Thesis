-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_14_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_14_block1
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_14_block1 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_14_block1;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_14_block1 IS
  ...
  SIGNAL rd_14_Addr_tmp                   : unsigned(1 DOWNTO 0);  -- ufix2
...
BEGIN
  ...
  SDFController_output : PROCESS (SDFController_multiply_J_reg, SDFController_multjState,
       ...
       dinXTwdl_14_1_vld, dout_13_1_vld)
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_14_Enb <= '0';
        IF (dout_13_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3#, 2))) = '1' THEN 
          SDFController_rdState_next <= to_unsigned(16#1#, 2);
        END IF;
      WHEN "01" =>
        SDFController_rdState_next <= to_unsigned(16#1#, 2);
        rd_14_Enb <= dinXTwdl_14_1_vld;
        IF dinXTwdl_14_1_vld = '1' THEN 
    ...
    CASE SDFController_wrState IS
      ...
      WHEN OTHERS => 
        ...
        SDFController_procEnb_reg_next <= '0';
    END CASE;
    rd_14_Addr_tmp <= SDFController_rdAddr_reg;
    proc_14_enb <= SDFController_procEnb_reg;
    multiply_14_J <= SDFController_multiply_J_reg;
  END PROCESS SDFController_output;


  rd_14_Addr <= std_logic_vector(rd_14_Addr_tmp);
