-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_SDFCommutator16.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_SDFCommutator16
...
ENTITY SpectrumAnalyserCustom_src_SDFCommutator16 IS
...
END SpectrumAnalyserCustom_src_SDFCommutator16;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_SDFCommutator16 IS
...
BEGIN
  u_dataXMEM_re_0_16 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_16 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
