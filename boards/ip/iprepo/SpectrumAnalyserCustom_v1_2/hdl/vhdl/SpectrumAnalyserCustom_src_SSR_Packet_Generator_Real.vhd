-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_SSR_Packet_Generator_Real.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_SSR_Packet_Generator_Real
...
ENTITY SpectrumAnalyserCustom_src_SSR_Packet_Generator_Real IS
...
END SpectrumAnalyserCustom_src_SSR_Packet_Generator_Real;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_SSR_Packet_Generator_Real IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_TLAST_Generator_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_Frame_Dropper_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_TLAST_Generator_block
    USE ENTITY work.SpectrumAnalyserCustom_src_TLAST_Generator_block(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_Frame_Dropper_block
    USE ENTITY work.SpectrumAnalyserCustom_src_Frame_Dropper_block(rtl);
...
BEGIN
  u_TLAST_Generator : SpectrumAnalyserCustom_src_TLAST_Generator_block
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Frame_Dropper : SpectrumAnalyserCustom_src_Frame_Dropper_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
