-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_Direct_Memory_Access_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_Direct_Memory_Access_block1
...
ENTITY SpectrumAnalyserCustom_src_Direct_Memory_Access_block1 IS
...
END SpectrumAnalyserCustom_src_Direct_Memory_Access_block1;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_Direct_Memory_Access_block1 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_EdgeDetection
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_DDR_Read_Controller
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_EdgeDetection
    USE ENTITY work.SpectrumAnalyserCustom_src_EdgeDetection(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_DDR_Read_Controller
    USE ENTITY work.SpectrumAnalyserCustom_src_DDR_Read_Controller(rtl);
  ...
  SIGNAL rd_len                           : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL rd_avalid                        : std_logic;

BEGIN
  u_EdgeDetection : SpectrumAnalyserCustom_src_EdgeDetection
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_DDR_Read_Controller : SpectrumAnalyserCustom_src_DDR_Read_Controller
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              ...
              rd_dvalid => rd_dvalid,
              valid_out => valid_out,
              count_out => count_out,  -- ufix17
              ready_out => ready_out,
              rd_addr => rd_addr,  -- uint32
              rd_len => rd_len,  -- ufix17
              rd_avalid => rd_avalid
              );
