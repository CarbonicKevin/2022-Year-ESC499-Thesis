...
class SpectrumAnalyser(DefaultIP):
    ...
    def __init__(self,
        ...
        self._number_samples = int(2**(self._spectrum_fftselector+12))
    ...
    def fft_size(self):
        ...
        Core in hardware.
        """
        return int(2**(self._spectrum_fftselector+12))
    ...
    def fft_size(self, fft_size):
        if fft_size in [65536, 32768, 16384, 8192, 4096]:
            ...
            self._dma_bufferaddress_1 = self._buffer[0].device_address
            self._dma_bufferaddress_2 = self._buffer[0].device_address
            self._spectrum_fftselector = int(np.log2(fft_size)-12)
    ...
    bindto = ['xilinx.com:ip:SpectrumAnalyserCustom:1.1']
