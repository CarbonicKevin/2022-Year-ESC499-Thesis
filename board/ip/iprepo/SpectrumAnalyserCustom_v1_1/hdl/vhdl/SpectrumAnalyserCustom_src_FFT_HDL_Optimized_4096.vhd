-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_FFT_HDL_Optimized_4096.vhd
...
ENTITY SpectrumAnalyserCustom_src_FFT_HDL_Optimized_4096 IS
...
END SpectrumAnalyserCustom_src_FFT_HDL_Optimized_4096;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_FFT_HDL_Optimized_4096 IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_12_1_re                    :   IN    std_logic_vector(27 DOWNTO 0);  -- sfix28_En15
          dout_12_1_im                    :   IN    std_logic_vector(27 DOWNTO 0);  -- sfix28_En15
          dout_12_1_vld                   :   IN    std_logic;
          softReset                       :   IN    std_logic;
          dout_re1                        :   OUT   std_logic_vector(27 DOWNTO 0);  -- sfix28_En15
          dout_im1                        :   OUT   std_logic_vector(27 DOWNTO 0);  -- sfix28_En15
...
BEGIN
  ...
  u_NaturalOrder_Stage : SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block1
    PORT MAP( clk => clk,
              ...
              dout_12_1_vld => dout_12_1_vld,
              softReset => softReset,
              dout_re1 => dout_re1,  -- sfix28_En15
              dout_im1 => dout_im1,  -- sfix28_En15
              dout_vld1 => dout_vld1,
              startOutS => startOutS,
              endOutS => endOutS
              );
