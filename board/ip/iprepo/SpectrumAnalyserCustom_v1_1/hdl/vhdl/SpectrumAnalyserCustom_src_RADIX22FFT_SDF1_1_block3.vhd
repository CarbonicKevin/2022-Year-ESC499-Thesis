-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block3
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block3 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block3;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block3 IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator1_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator1_block3
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator1_block3(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_1 : SpectrumAnalyserCustom_src_SDFCommutator1_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
