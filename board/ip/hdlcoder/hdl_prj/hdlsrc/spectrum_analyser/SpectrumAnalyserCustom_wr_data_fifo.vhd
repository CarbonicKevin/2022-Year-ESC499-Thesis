-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_wr_data_fifo.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_wr_data_fifo
-- Source Path: SpectrumAnalyserCustom/SpectrumAnalyserCustom_axi4_master_wr/SpectrumAnalyserCustom_wr_data_fifo
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyserCustom_wr_data_fifo IS
...
END SpectrumAnalyserCustom_wr_data_fifo;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_wr_data_fifo IS
  ...
  SIGNAL Num                              : unsigned(4 DOWNTO 0);  -- ufix5
...
BEGIN
  ...
  u_SpectrumAnalyserCustom_wr_data_fifo_classic_ram : SpectrumAnalyserCustom_SimpleDualPortRAM_generic
  ...
  w_cz <= '1' WHEN Num > to_unsigned(16#00#, 5) ELSE
      '0';
