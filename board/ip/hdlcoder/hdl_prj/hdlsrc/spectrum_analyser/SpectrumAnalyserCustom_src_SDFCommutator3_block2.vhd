-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_SDFCommutator3_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_SDFCommutator3_block2
...
ENTITY SpectrumAnalyserCustom_src_SDFCommutator3_block2 IS
...
END SpectrumAnalyserCustom_src_SDFCommutator3_block2;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_SDFCommutator3_block2 IS
...
BEGIN
  u_dataXMEM_re_0_3 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_3 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 19
                 )
    PORT MAP( clk => clk,
