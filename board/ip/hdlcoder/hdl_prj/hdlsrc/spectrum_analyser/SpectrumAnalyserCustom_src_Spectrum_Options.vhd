-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_Spectrum_Options.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_Spectrum_Options
...
ENTITY SpectrumAnalyserCustom_src_Spectrum_Options IS
...
END SpectrumAnalyserCustom_src_Spectrum_Options;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_Spectrum_Options IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_nfp_wire_single_block
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
          );
  END COMPONENT;

  COMPONENT SpectrumAnalyserCustom_src_nfp_convert_sfix_32_En15_to_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_nfp_hypot_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_nfp_mul_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT SpectrumAnalyserCustom_src_nfp_relop_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT SpectrumAnalyserCustom_src_nfp_relop_single_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT SpectrumAnalyserCustom_src_nfp_log10_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_nfp_pow10_single
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- single
  ...
  COMPONENT SpectrumAnalyserCustom_src_nfp_wire_single
  ...
  FOR ALL : SpectrumAnalyserCustom_src_nfp_wire_single_block
    USE ENTITY work.SpectrumAnalyserCustom_src_nfp_wire_single_block(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_nfp_convert_sfix_32_En15_to_single
    USE ENTITY work.SpectrumAnalyserCustom_src_nfp_convert_sfix_32_En15_to_single(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_nfp_hypot_single
    USE ENTITY work.SpectrumAnalyserCustom_src_nfp_hypot_single(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_nfp_mul_single
    USE ENTITY work.SpectrumAnalyserCustom_src_nfp_mul_single(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_nfp_relop_single
    USE ENTITY work.SpectrumAnalyserCustom_src_nfp_relop_single(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_nfp_relop_single_block
    USE ENTITY work.SpectrumAnalyserCustom_src_nfp_relop_single_block(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_nfp_log10_single
    USE ENTITY work.SpectrumAnalyserCustom_src_nfp_log10_single(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_nfp_pow10_single
    USE ENTITY work.SpectrumAnalyserCustom_src_nfp_pow10_single(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_nfp_wire_single
    USE ENTITY work.SpectrumAnalyserCustom_src_nfp_wire_single(rtl);
...
BEGIN
  ...
  u_nfp_wire_single : SpectrumAnalyserCustom_src_nfp_wire_single_block
    PORT MAP( nfp_in => Power_Scale,  -- uint32
              nfp_out => Float_Typecast2_out1  -- single
              );

  u_spectrum_analyser_Spectrum_Analyser_Spectrum_Analyser_Spectrum_Analyser_Core_FFT_and_Spectrum_Processing_Spectrum_Options_nfp_convert_sfix_32_En15_to_single : SpectrumAnalyserCustom_src_nfp_convert_sfix_32_En15_to_single
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_spectrum_analyser_Spectrum_Analyser_Spectrum_Analyser_Spectrum_Analyser_Core_FFT_and_Spectrum_Processing_Spectrum_Options_nfp_convert_sfix_32_En15_to_single_1 : SpectrumAnalyserCustom_src_nfp_convert_sfix_32_En15_to_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_hypot_comp : SpectrumAnalyserCustom_src_nfp_hypot_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_mul_comp : SpectrumAnalyserCustom_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_mul_comp_1 : SpectrumAnalyserCustom_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_wire_single_1 : SpectrumAnalyserCustom_src_nfp_wire_single_block
    PORT MAP( nfp_in => Type_Scale,  -- uint32
              nfp_out => Float_Typecast1_out1  -- single
              );

  u_nfp_mul_comp_2 : SpectrumAnalyserCustom_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_mul_comp_3 : SpectrumAnalyserCustom_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_relop_comp : SpectrumAnalyserCustom_src_nfp_relop_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_relop_comp_1 : SpectrumAnalyserCustom_src_nfp_relop_single_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              nfp_in1 => Multiport_Switch1_out1,  -- single
  ...
  u_nfp_log10_comp : SpectrumAnalyserCustom_src_nfp_log10_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_mul_comp_4 : SpectrumAnalyserCustom_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_mul_comp_5 : SpectrumAnalyserCustom_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_pow10_comp : SpectrumAnalyserCustom_src_nfp_pow10_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_mul_comp_6 : SpectrumAnalyserCustom_src_nfp_mul_single
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_nfp_wire_single_2 : SpectrumAnalyserCustom_src_nfp_wire_single
