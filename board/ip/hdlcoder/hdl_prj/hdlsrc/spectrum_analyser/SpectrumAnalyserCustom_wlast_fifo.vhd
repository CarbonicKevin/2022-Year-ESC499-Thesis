-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_wlast_fifo.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_wlast_fifo
-- Source Path: SpectrumAnalyserCustom/SpectrumAnalyserCustom_axi4_master_wr/SpectrumAnalyserCustom_wlast_fifo
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyserCustom_wlast_fifo IS
...
END SpectrumAnalyserCustom_wlast_fifo;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_wlast_fifo IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : SpectrumAnalyserCustom_SimpleDualPortRAM_singlebit
    USE ENTITY work.SpectrumAnalyserCustom_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_SpectrumAnalyserCustom_wlast_fifo_classic_ram_singlebit : SpectrumAnalyserCustom_SimpleDualPortRAM_singlebit
