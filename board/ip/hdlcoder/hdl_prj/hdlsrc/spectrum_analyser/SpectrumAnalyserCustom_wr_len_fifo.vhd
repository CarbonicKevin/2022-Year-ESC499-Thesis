-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_wr_len_fifo.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_wr_len_fifo
-- Source Path: SpectrumAnalyserCustom/SpectrumAnalyserCustom_axi4_master_wr/SpectrumAnalyserCustom_wr_len_fifo
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyserCustom_wr_len_fifo IS
...
END SpectrumAnalyserCustom_wr_len_fifo;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_wr_len_fifo IS
...
BEGIN
  ...
  u_SpectrumAnalyserCustom_wr_len_fifo_classic_ram : SpectrumAnalyserCustom_SimpleDualPortRAM_generic
