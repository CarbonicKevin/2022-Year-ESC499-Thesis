-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_4_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_4_block
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_4_block IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_4_block;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_4_block IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator4_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator4_block
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator4_block(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_4 : SpectrumAnalyserCustom_src_SDFCommutator4_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
