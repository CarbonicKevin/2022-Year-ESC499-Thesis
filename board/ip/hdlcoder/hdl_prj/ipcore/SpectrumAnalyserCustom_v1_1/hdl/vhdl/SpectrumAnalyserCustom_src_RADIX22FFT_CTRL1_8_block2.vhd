-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_8_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_8_block2
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_8_block2 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_8_block2;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_8_block2 IS
  ...
  SIGNAL rd_8_Addr_tmp                    : unsigned(7 DOWNTO 0);  -- ufix8
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_8_Enb <= '0';
        IF (dout_7_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#FF#, 8))) = '1' THEN 
