...
ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13_block2 IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_Complex4Multiply_block29
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Complex4Multiply_block29
    USE ENTITY work.SpectrumAnalyserCustom_src_Complex4Multiply_block29(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyserCustom_src_Complex4Multiply_block29
    PORT MAP( clk => clk,
              reset => reset,
