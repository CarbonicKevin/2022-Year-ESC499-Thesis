...
class SpectrumAnalyser(DefaultIP):
    ...
    def __init__(self,
        ...
        """
        self.ssr_mode = 3
        self.ssr_packetsize = 4096
        
        """Window Registers and type
        """
        self._window_packetsize = 32768
        self._window_address = 0
        self._window_transfer = 0
        
        self._window_squaresum = 32768
        self._window_sum = 32768
    ...
    bindto = ['xilinx.com:ip:SpectrumAnalyser32768:1.0']
