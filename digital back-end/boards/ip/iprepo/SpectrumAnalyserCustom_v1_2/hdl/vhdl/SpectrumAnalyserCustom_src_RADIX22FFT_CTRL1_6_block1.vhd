-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_6_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_6_block1
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_6_block1 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_6_block1;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_6_block1 IS
  ...
  SIGNAL rd_6_Addr_tmp                    : unsigned(9 DOWNTO 0);  -- ufix10
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_6_Enb <= '0';
        IF (dout_5_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3FF#, 10))) = '1' THEN 
