-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_Spectrum_Analyser_Core.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_Spectrum_Analyser_Core
...
ENTITY SpectrumAnalyserCustom_src_Spectrum_Analyser_Core IS
...
END SpectrumAnalyserCustom_src_Spectrum_Analyser_Core;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_Spectrum_Analyser_Core IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_SSR_Subset_Converter
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Packet_Size                     :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  COMPONENT SpectrumAnalyserCustom_src_Preprocessing_Window
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          ...
          rd_m2s_rd_len                   :   OUT   std_logic_vector(16 DOWNTO 0);  -- ufix17
          rd_m2s_rd_avalid                :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT SpectrumAnalyserCustom_src_FFT_and_Spectrum_Processing
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Units_rsvd                      :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SSR_Subset_Converter
    USE ENTITY work.SpectrumAnalyserCustom_src_SSR_Subset_Converter(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_Preprocessing_Window
    USE ENTITY work.SpectrumAnalyserCustom_src_Preprocessing_Window(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_FFT_and_Spectrum_Processing
    USE ENTITY work.SpectrumAnalyserCustom_src_FFT_and_Spectrum_Processing(rtl);
  ...
  SIGNAL Preprocessing_Window_out10_rd_len : std_logic_vector(16 DOWNTO 0);  -- ufix17
...
BEGIN
  u_SSR_Subset_Converter : SpectrumAnalyserCustom_src_SSR_Subset_Converter
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Preprocessing_Window : SpectrumAnalyserCustom_src_Preprocessing_Window
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              ...
              rd_m2s_rd_len => Preprocessing_Window_out10_rd_len,  -- ufix17
              rd_m2s_rd_avalid => Preprocessing_Window_out10_rd_avalid
              );

  u_FFT_and_Spectrum_Processing : SpectrumAnalyserCustom_src_FFT_and_Spectrum_Processing
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
