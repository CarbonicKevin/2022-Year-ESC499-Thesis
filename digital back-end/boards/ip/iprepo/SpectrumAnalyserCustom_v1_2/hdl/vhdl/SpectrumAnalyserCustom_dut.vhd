-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_dut
-- Source Path: SpectrumAnalyserCustom/SpectrumAnalyserCustom_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyserCustom_dut IS
...
END SpectrumAnalyserCustom_dut;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_dut IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_Spectrum_Analyser
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Spectrum_Analyser
    USE ENTITY work.SpectrumAnalyserCustom_src_Spectrum_Analyser(rtl);
...
BEGIN
  u_SpectrumAnalyserCustom_src_Spectrum_Analyser : SpectrumAnalyserCustom_src_Spectrum_Analyser
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
