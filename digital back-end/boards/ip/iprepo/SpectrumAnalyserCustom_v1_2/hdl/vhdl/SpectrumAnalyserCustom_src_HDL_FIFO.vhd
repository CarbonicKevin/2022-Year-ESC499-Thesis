-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_HDL_FIFO.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_HDL_FIFO
...
ENTITY SpectrumAnalyserCustom_src_HDL_FIFO IS
...
END SpectrumAnalyserCustom_src_HDL_FIFO;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_HDL_FIFO IS
  ...
  -- Signals
  SIGNAL fifo_front_indx                  : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL fifo_front_dir                   : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL fifo_back_indx                   : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL fifo_back_dir                    : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL fifo_sample_count                : unsigned(17 DOWNTO 0);  -- ufix18
  SIGNAL fifo_front_indx_next             : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL fifo_front_dir_next              : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL fifo_back_indx_next              : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL fifo_back_dir_next               : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL fifo_sample_count_next           : unsigned(17 DOWNTO 0);  -- ufix18
  SIGNAL fifo_out3                        : std_logic;
  SIGNAL fifo_out4                        : std_logic;
  SIGNAL fifo_write_enable                : std_logic;
  SIGNAL fifo_read_enable                 : std_logic;
  SIGNAL fifo_front_indx_temp             : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL fifo_back_indx_temp              : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL w_waddr                          : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL w_we                             : std_logic;  -- ufix1
  SIGNAL w_raddr                          : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL w_num                            : unsigned(17 DOWNTO 0);  -- ufix18
...
BEGIN
  ...
  u_HDL_FIFO_ram_generic : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 17,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      fifo_front_indx <= to_unsigned(16#00000#, 17);
      fifo_front_dir <= to_unsigned(16#00001#, 17);
      fifo_back_indx <= to_unsigned(16#00000#, 17);
      fifo_back_dir <= to_unsigned(16#00001#, 17);
      fifo_sample_count <= to_unsigned(16#00000#, 18);
  ...
  fifo_out4 <= '1' WHEN fifo_sample_count = to_unsigned(16#20000#, 18) ELSE
      '0';
  
  fifo_out3 <= '1' WHEN fifo_sample_count = to_unsigned(16#00000#, 18) ELSE
      '0';
  ...
  fifo_front_dir_next <= to_unsigned(16#00001#, 17) WHEN fifo_front_indx_temp = to_unsigned(16#1FFFF#, 17) ELSE
      to_unsigned(16#00001#, 17);
  
  fifo_back_indx_temp <= fifo_back_indx + fifo_back_dir WHEN fifo_write_enable = '1' ELSE
      fifo_back_indx;
  
  fifo_back_dir_next <= to_unsigned(16#00001#, 17) WHEN fifo_back_indx_temp = to_unsigned(16#1FFFF#, 17) ELSE
      to_unsigned(16#00001#, 17);
  
  fifo_sample_count_next <= fifo_sample_count + to_unsigned(16#00001#, 18) WHEN (fifo_write_enable AND ( NOT fifo_read_enable)) = '1' ELSE
      fifo_sample_count + to_unsigned(16#3FFFF#, 18) WHEN (( NOT fifo_write_enable) AND fifo_read_enable) = '1' ELSE
      fifo_sample_count;
  ...
  w_cz <= '1' WHEN w_num > to_unsigned(16#00000#, 18) ELSE
      '0';
