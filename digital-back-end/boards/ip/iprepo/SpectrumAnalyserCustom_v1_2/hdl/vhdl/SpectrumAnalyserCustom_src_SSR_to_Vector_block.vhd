-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_SSR_to_Vector_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_SSR_to_Vector_block
...
ENTITY SpectrumAnalyserCustom_src_SSR_to_Vector_block IS
  PORT( SSR                               :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
        Vector                            :   OUT   vector_of_std_logic_vector16(0 TO 7)  -- uint16 [8]
        );
END SpectrumAnalyserCustom_src_SSR_to_Vector_block;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_SSR_to_Vector_block IS
