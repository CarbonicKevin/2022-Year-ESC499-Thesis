-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_rd_len_fifo.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_rd_len_fifo
-- Source Path: SpectrumAnalyserCustom/SpectrumAnalyserCustom_axi4_master_rd/SpectrumAnalyserCustom_rd_len_fifo
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyserCustom_rd_len_fifo IS
...
END SpectrumAnalyserCustom_rd_len_fifo;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_rd_len_fifo IS
  ...
  SIGNAL w_waddr_1                        : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL w_waddr_unsigned                 : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL w_d2                             : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL w_out                            : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL cache_data                       : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL data_out_next                    : unsigned(16 DOWNTO 0);  -- ufix17
  SIGNAL Out_tmp                          : unsigned(16 DOWNTO 0);  -- ufix17

BEGIN
  -- us1: Upsample by 1, Sample offset 0 
  u_SpectrumAnalyserCustom_rd_len_fifo_classic_ram : SpectrumAnalyserCustom_SimpleDualPortRAM_generic
  ...
  BEGIN
    IF reset = '1' THEN
      cache_data <= to_unsigned(16#00000#, 17);
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  BEGIN
    IF reset = '1' THEN
      Out_tmp <= to_unsigned(16#00000#, 17);
    ELSIF clk'EVENT AND clk = '1' THEN
