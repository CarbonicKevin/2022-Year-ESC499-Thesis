-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_SSR_Serializer_Imag.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_SSR_Serializer_Imag
...
ENTITY SpectrumAnalyserCustom_src_SSR_Serializer_Imag IS
...
END SpectrumAnalyserCustom_src_SSR_Serializer_Imag;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_SSR_Serializer_Imag IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_SSR_to_Vector_block1
    PORT( SSR                             :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
          Vector                          :   OUT   vector_of_std_logic_vector16(0 TO 7)  -- uint16 [8]
          );
  END COMPONENT;

  COMPONENT SpectrumAnalyserCustom_src_SSR1_to_SSR8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_SSR2_to_SSR8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Data_In                         :   IN    vector_of_std_logic_vector16(0 TO 7);  -- uint16 [8]
  ...
  COMPONENT SpectrumAnalyserCustom_src_SSR4_to_SSR8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          Data_In                         :   IN    vector_of_std_logic_vector16(0 TO 7);  -- uint16 [8]
  ...
  COMPONENT SpectrumAnalyserCustom_src_Vector_to_SSR
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SSR_to_Vector_block1
    USE ENTITY work.SpectrumAnalyserCustom_src_SSR_to_Vector_block1(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_SSR1_to_SSR8
    USE ENTITY work.SpectrumAnalyserCustom_src_SSR1_to_SSR8(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_SSR2_to_SSR8
    USE ENTITY work.SpectrumAnalyserCustom_src_SSR2_to_SSR8(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_SSR4_to_SSR8
    USE ENTITY work.SpectrumAnalyserCustom_src_SSR4_to_SSR8(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_Vector_to_SSR
    USE ENTITY work.SpectrumAnalyserCustom_src_Vector_to_SSR(rtl);
...
BEGIN
  u_SSR_to_Vector : SpectrumAnalyserCustom_src_SSR_to_Vector_block1
    PORT MAP( SSR => Data_In,  -- ufix128
              Vector => SSR_to_Vector_out1  -- uint16 [8]
              );

  u_SSR1_to_SSR8 : SpectrumAnalyserCustom_src_SSR1_to_SSR8
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SSR2_to_SSR8 : SpectrumAnalyserCustom_src_SSR2_to_SSR8
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              Data_In => SSR_to_Vector_out1,  -- uint16 [8]
  ...
  u_SSR4_to_SSR8 : SpectrumAnalyserCustom_src_SSR4_to_SSR8
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              Data_In => SSR_to_Vector_out1,  -- uint16 [8]
  ...
  u_Vector_to_SSR : SpectrumAnalyserCustom_src_Vector_to_SSR
