-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_9_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_9_block
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_9_block IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_9_block;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_9_block IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator9_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_9_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator9_block
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator9_block(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_9 : SpectrumAnalyserCustom_src_SDFCommutator9_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_9_vld_dly => din_9_vld_dly,
