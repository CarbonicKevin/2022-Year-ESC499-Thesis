-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_Preprocessing_Window.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_Preprocessing_Window
...
ENTITY SpectrumAnalyserCustom_src_Preprocessing_Window IS
...
END SpectrumAnalyserCustom_src_Preprocessing_Window;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_Preprocessing_Window IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_Direct_Memory_Access_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          ...
          ram_wr_addr                     :   OUT   std_logic_vector(16 DOWNTO 0);  -- ufix17
  ...
  COMPONENT SpectrumAnalyserCustom_src_DualPortRAM_generic
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Direct_Memory_Access_block1
    USE ENTITY work.SpectrumAnalyserCustom_src_Direct_Memory_Access_block1(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_DualPortRAM_generic
    USE ENTITY work.SpectrumAnalyserCustom_src_DualPortRAM_generic(rtl);

  -- Signals
  SIGNAL Direct_Memory_Access_out1        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL count_out                        : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL valid_out                        : std_logic;
  SIGNAL ready_out                        : std_logic;
  SIGNAL Direct_Memory_Access_out5_rd_addr : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL Direct_Memory_Access_out5_rd_len : std_logic_vector(16 DOWNTO 0);  -- ufix17
...
BEGIN
  u_Direct_Memory_Access : SpectrumAnalyserCustom_src_Direct_Memory_Access_block1
    PORT MAP( clk => clk,
              reset => reset,
              ...
              ram_wr_addr => count_out,  -- ufix17
              ram_wren => valid_out,
              dma_read_ready => ready_out,
              axim_rd_m2s_rd_addr => Direct_Memory_Access_out5_rd_addr,  -- uint32
              axim_rd_m2s_rd_len => Direct_Memory_Access_out5_rd_len,  -- ufix17
              axim_rd_m2s_rd_avalid => Direct_Memory_Access_out5_rd_avalid
              );

  u_Dual_Port_RAM_System : SpectrumAnalyserCustom_src_DualPortRAM_generic
