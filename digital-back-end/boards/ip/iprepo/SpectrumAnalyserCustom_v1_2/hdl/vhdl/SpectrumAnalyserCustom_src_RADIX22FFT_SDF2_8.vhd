-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8 IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator8
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator8(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_8 : SpectrumAnalyserCustom_src_SDFCommutator8
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
