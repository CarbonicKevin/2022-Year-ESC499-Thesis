-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom
-- Source Path: SpectrumAnalyserCustom
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyserCustom IS
...
END SpectrumAnalyserCustom;


ARCHITECTURE rtl OF SpectrumAnalyserCustom IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_axi4_stream_imag_slave
  ...
  COMPONENT SpectrumAnalyserCustom_axi4_stream_real_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Real_Slave_TDATA    :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
  ...
  COMPONENT SpectrumAnalyserCustom_reset_sync
    PORT( clk                             :   IN    std_logic;  -- ufix1
  ...
  COMPONENT SpectrumAnalyserCustom_axi4_master_wr
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          AXI4_Master_Wr_AWREADY          :   IN    std_logic;  -- ufix1
          AXI4_Master_Wr_WREADY           :   IN    std_logic;  -- ufix1
  ...
  COMPONENT SpectrumAnalyserCustom_axi_lite
  ...
  COMPONENT SpectrumAnalyserCustom_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_axi4_master_rd
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          AXI4_Master_Rd_RDATA            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          AXI4_Master_Rd_RLAST            :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : SpectrumAnalyserCustom_axi4_stream_imag_slave
    USE ENTITY work.SpectrumAnalyserCustom_axi4_stream_imag_slave(rtl);

  FOR ALL : SpectrumAnalyserCustom_axi4_stream_real_slave
    USE ENTITY work.SpectrumAnalyserCustom_axi4_stream_real_slave(rtl);

  FOR ALL : SpectrumAnalyserCustom_reset_sync
    USE ENTITY work.SpectrumAnalyserCustom_reset_sync(rtl);

  FOR ALL : SpectrumAnalyserCustom_axi4_master_wr
    USE ENTITY work.SpectrumAnalyserCustom_axi4_master_wr(rtl);

  FOR ALL : SpectrumAnalyserCustom_axi_lite
    USE ENTITY work.SpectrumAnalyserCustom_axi_lite(rtl);

  FOR ALL : SpectrumAnalyserCustom_dut
    USE ENTITY work.SpectrumAnalyserCustom_dut(rtl);

  FOR ALL : SpectrumAnalyserCustom_axi4_master_rd
    USE ENTITY work.SpectrumAnalyserCustom_axi4_master_rd(rtl);
  ...
  SIGNAL axim_rd_m2s_rd_len_sig           : std_logic_vector(16 DOWNTO 0);  -- ufix17
...
BEGIN
  u_SpectrumAnalyserCustom_axi4_stream_imag_slave_inst : SpectrumAnalyserCustom_axi4_stream_imag_slave
  ...
  u_SpectrumAnalyserCustom_axi4_stream_real_slave_inst : SpectrumAnalyserCustom_axi4_stream_real_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyserCustom_reset_sync_inst : SpectrumAnalyserCustom_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_SpectrumAnalyserCustom_axi4_master_wr_inst : SpectrumAnalyserCustom_axi4_master_wr
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_SpectrumAnalyserCustom_axi_lite_inst : SpectrumAnalyserCustom_axi_lite
  ...
  u_SpectrumAnalyserCustom_dut_inst : SpectrumAnalyserCustom_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              ...
              axim_rd_m2s_rd_len => axim_rd_m2s_rd_len_sig,  -- ufix17
  ...
  u_SpectrumAnalyserCustom_axi4_master_rd_inst : SpectrumAnalyserCustom_axi4_master_rd
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              ...
              user_rd_len => axim_rd_m2s_rd_len_sig,  -- ufix17
  ...
  ip_timestamp <= unsigned'(X"8955A65A");
