...
class SpectrumAnalyser(DefaultIP):
    ...
    def __init__(self,
        ...
        """
        self.ssr_mode = 3
        self.ssr_packetsize = 8192
        
        """Window Registers and type
        """
        self._window_packetsize = 65536
        self._window_address = 0
        self._window_transfer = 0
        
        self._window_squaresum = 65536
        self._window_sum = 65536
    ...
    bindto = ['xilinx.com:ip:SpectrumAnalyser65536:1.0']
