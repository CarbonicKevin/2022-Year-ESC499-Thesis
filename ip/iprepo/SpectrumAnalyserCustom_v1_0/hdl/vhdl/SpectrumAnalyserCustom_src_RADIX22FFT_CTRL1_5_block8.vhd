-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_5_block8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_5_block8
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_5_block8 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_5_block8;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_5_block8 IS
  ...
  SIGNAL rd_5_Addr_tmp                    : unsigned(10 DOWNTO 0);  -- ufix11
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_5_Enb <= '0';
        IF (dinXTwdl_5_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7FF#, 11))) = '1' THEN 
