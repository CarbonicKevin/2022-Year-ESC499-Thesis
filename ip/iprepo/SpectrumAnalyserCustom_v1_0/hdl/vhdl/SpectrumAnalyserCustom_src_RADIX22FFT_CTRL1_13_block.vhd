-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_13_block.vhd
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_13_block IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_13_block;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_13_block IS
  ...
  SIGNAL rd_13_Addr_tmp                   : unsigned(1 DOWNTO 0);  -- ufix2
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_13_Enb <= '0';
        IF (dinXTwdl_13_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3#, 2))) = '1' THEN 
          SDFController_rdState_next <= to_unsigned(16#1#, 2);
        END IF;
      WHEN "01" =>
        SDFController_rdState_next <= to_unsigned(16#1#, 2);
        rd_13_Enb <= dinXTwdl_13_1_vld_1;
        IF dinXTwdl_13_1_vld_1 = '1' THEN 
    ...
    CASE SDFController_wrState IS
      ...
      WHEN OTHERS => 
        ...
        SDFController_procEnb_reg_next <= '0';
    END CASE;
    rd_13_Addr_tmp <= SDFController_rdAddr_reg;
    proc_13_enb <= SDFController_procEnb_reg;
    multiply_13_J <= SDFController_multiply_J_reg;
  END PROCESS SDFController_output;


  rd_13_Addr <= std_logic_vector(rd_13_Addr_tmp);
