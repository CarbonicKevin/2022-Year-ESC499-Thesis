-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block4
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block4 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block4;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block4 IS
  ...
  SIGNAL rd_4_Addr_tmp                    : unsigned(10 DOWNTO 0);  -- ufix11
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_4_Enb <= '0';
        IF (dout_3_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7FF#, 11))) = '1' THEN 
