-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8_block2.vhd
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8_block2 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8_block2;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8_block2 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator8_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator8_block2
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator8_block2(rtl);
  ...
  SIGNAL din_re_dly1                      : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL btfin_re                         : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL din_im_dly1                      : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL btfin_im                         : signed(23 DOWNTO 0);  -- sfix24_En15
  ...
  SIGNAL x_im                             : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL x_im_dly                         : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL wrData_im                        : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL wrData_im_signed                 : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL wrData_re                        : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL wrData_re_signed                 : signed(23 DOWNTO 0);  -- sfix24_En15
  ...
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL x_re                             : signed(23 DOWNTO 0);  -- sfix24_En15
...
BEGIN
  u_SDFCOMMUTATOR_8 : SpectrumAnalyserCustom_src_SDFCommutator8_block2
    PORT MAP( clk => clk,
              reset => reset,
