-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block13.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block13
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block13 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block13;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block13 IS
  ...
  SIGNAL rd_1_Addr_tmp                    : unsigned(11 DOWNTO 0);  -- ufix12
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_1_Enb <= '0';
        IF (dinXTwdl_1_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#FFF#, 12))) = '1' THEN 
