-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_SDFCommutator8_block2.vhd
...
ENTITY SpectrumAnalyserCustom_src_SDFCommutator8_block2 IS
...
END SpectrumAnalyserCustom_src_SDFCommutator8_block2;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_SDFCommutator8_block2 IS
  ...
  SIGNAL SDFCummutator_btf1_re_dly        : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL SDFCummutator_btf1_im_dly        : signed(23 DOWNTO 0);  -- sfix24
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(23 DOWNTO 0);  -- sfix24_En15
...
BEGIN
  u_dataXMEM_re_0_8 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_8 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 24
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      SDFCummutator_btf1_re_dly <= to_signed(16#000000#, 24);
      SDFCummutator_btf1_im_dly <= to_signed(16#000000#, 24);
