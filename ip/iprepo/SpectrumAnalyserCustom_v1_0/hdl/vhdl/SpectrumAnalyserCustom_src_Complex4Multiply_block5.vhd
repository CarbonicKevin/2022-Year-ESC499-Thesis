-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_Complex4Multiply_block5.vhd
...
ENTITY SpectrumAnalyserCustom_src_Complex4Multiply_block5 IS
...
END SpectrumAnalyserCustom_src_Complex4Multiply_block5;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_Complex4Multiply_block5 IS
  ...
  SIGNAL twdl_7_re_signed                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_re_reg                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_7_im_signed                 : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  twdl_7_re_signed <= signed(twdl_7_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_16_0 = '1' THEN
        twdl_re_reg <= twdl_7_re_signed;
      END IF;
    END IF;
  END PROCESS intdelay_2_process;


  twdl_7_im_signed <= signed(twdl_7_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_16_0 = '1' THEN
        ...
        dinXTwdl_7_vld <= Complex4Add_prod_vld_reg1;
