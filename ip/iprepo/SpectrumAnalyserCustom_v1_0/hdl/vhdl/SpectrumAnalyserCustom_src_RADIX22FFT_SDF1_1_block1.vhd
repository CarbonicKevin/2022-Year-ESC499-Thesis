-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block1
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block1 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block1;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block1 IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator1_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator1_block1
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator1_block1(rtl);
...
BEGIN
  u_dataMEM_im_0_1 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_1 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 13,
                 DataWidth => 17
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_1 : SpectrumAnalyserCustom_src_SDFCommutator1_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
