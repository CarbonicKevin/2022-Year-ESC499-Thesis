-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5_block8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5_block8
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5_block8 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5_block8;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5_block8 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_Complex4Multiply_block39
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator5_block8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_5_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Complex4Multiply_block39
    USE ENTITY work.SpectrumAnalyserCustom_src_Complex4Multiply_block39(rtl);
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator5_block8
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator5_block8(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyserCustom_src_Complex4Multiply_block39
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_5 : SpectrumAnalyserCustom_src_SDFCommutator5_block8
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_5_vld_dly => din_5_vld_dly,
