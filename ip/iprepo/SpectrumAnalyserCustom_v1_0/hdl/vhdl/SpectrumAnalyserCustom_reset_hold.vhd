-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_reset_hold.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_reset_hold
-- Source Path: SpectrumAnalyserCustom/SpectrumAnalyserCustom_axi_lite/SpectrumAnalyserCustom_axi_lite_module/SpectrumAnalyserCustom_reset_hold
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyserCustom_reset_hold IS
...
END SpectrumAnalyserCustom_reset_hold;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_reset_hold IS
