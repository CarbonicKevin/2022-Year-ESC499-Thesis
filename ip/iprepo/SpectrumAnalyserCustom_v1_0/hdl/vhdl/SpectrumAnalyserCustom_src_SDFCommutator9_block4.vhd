-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_SDFCommutator9_block4.vhd
...
ENTITY SpectrumAnalyserCustom_src_SDFCommutator9_block4 IS
...
END SpectrumAnalyserCustom_src_SDFCommutator9_block4;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_SDFCommutator9_block4 IS
  ...
  SIGNAL SDFCummutator_btf1_re_dly        : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL SDFCummutator_btf1_im_dly        : signed(24 DOWNTO 0);  -- sfix25
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(24 DOWNTO 0);  -- sfix25_En15
  ...
  SIGNAL dout_9_re_tmp                    : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL dout_9_im_tmp                    : signed(24 DOWNTO 0);  -- sfix25_En15

BEGIN
  u_dataXMEM_re_0_9 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_9 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 25
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      SDFCummutator_btf1_re_dly <= to_signed(16#0000000#, 25);
      SDFCummutator_btf1_im_dly <= to_signed(16#0000000#, 25);
