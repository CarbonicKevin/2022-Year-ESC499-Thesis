-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_9_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_9_block
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_9_block IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_9_block;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_9_block IS
  ...
  SIGNAL rd_9_Addr_tmp                    : unsigned(4 DOWNTO 0);  -- ufix5
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_9_Enb <= '0';
        IF (dinXTwdl_9_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#1F#, 5))) = '1' THEN 
