-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_11_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_11_block3
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_11_block3 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_11_block3;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_11_block3 IS
  ...
  SIGNAL rd_11_Addr_tmp                   : unsigned(1 DOWNTO 0);  -- ufix2
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_11_Enb <= '0';
        IF (dinXTwdl_11_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3#, 2))) = '1' THEN 
