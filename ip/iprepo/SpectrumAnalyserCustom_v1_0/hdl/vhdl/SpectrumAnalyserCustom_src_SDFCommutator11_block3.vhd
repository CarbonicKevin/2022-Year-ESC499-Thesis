-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_SDFCommutator11_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_SDFCommutator11_block3
...
ENTITY SpectrumAnalyserCustom_src_SDFCommutator11_block3 IS
...
END SpectrumAnalyserCustom_src_SDFCommutator11_block3;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_SDFCommutator11_block3 IS
...
BEGIN
  u_dataXMEM_re_0_11 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_11 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 27
                 )
    PORT MAP( clk => clk,
