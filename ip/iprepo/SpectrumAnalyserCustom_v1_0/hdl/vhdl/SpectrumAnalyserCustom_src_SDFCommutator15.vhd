-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_SDFCommutator15.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_SDFCommutator15
...
ENTITY SpectrumAnalyserCustom_src_SDFCommutator15 IS
...
END SpectrumAnalyserCustom_src_SDFCommutator15;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_SDFCommutator15 IS
...
BEGIN
  u_dataXMEM_re_0_15 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_15 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 31
                 )
    PORT MAP( clk => clk,
