-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_TWDLROM_5_1_block3.vhd
...
ENTITY SpectrumAnalyserCustom_src_TWDLROM_5_1_block3 IS
...
END SpectrumAnalyserCustom_src_TWDLROM_5_1_block3;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_TWDLROM_5_1_block3 IS
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    IF (dout_4_1_vld AND hdlcoder_to_stdlogic(Radix22TwdlMapping_cnt > to_unsigned(16#3B#, 6))) = '1' THEN 
      Radix22TwdlMapping_phase_next <= Radix22TwdlMapping_phase + to_unsigned(16#1#, 2);
    END IF;
    IF dout_4_1_vld = '1' THEN 
      Radix22TwdlMapping_cnt_next <= Radix22TwdlMapping_cnt + to_unsigned(16#04#, 6);
    END IF;
