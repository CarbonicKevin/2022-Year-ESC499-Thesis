...
-- Core/FFT HDL Optimized 256/RADIX2FFT_bitNatura
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block3 IS
  ...
  SIGNAL wrStateMachineBitNatural_wrAddrCnt : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL wrStateMachineBitNatural_wrState_next : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL wrStateMachineBitNatural_wrAddrCnt_next : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL WrEnb                            : std_logic;
  SIGNAL wrAddr                           : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL sampleIdx                        : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL rdAddr                           : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL memOut_im                        : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL memOut_im_signed                 : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL memOut_re                        : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL memOut_re_signed                 : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL rdStateMachineBitNatural_rdState : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL rdStateMachineBitNatural_rdAddrCnt : unsigned(7 DOWNTO 0);  -- ufix8
  ...
  SIGNAL rdStateMachineBitNatural_rdAddrCnt_next : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL rdStateMachineBitNatural_doutVldReg1_next : std_logic;
  SIGNAL rdStateMachineBitNatural_doutVldReg2_next : std_logic;
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(23 DOWNTO 0);  -- sfix24_En15
  ...
  SIGNAL dout_re1_tmp                     : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL dout_im1_tmp                     : signed(23 DOWNTO 0);  -- sfix24_En15
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      wrStateMachineBitNatural_wrAddrCnt <= to_unsigned(16#00#, 8);
  ...
  wrStateMachineBitNatural_output : PROCESS (dout_8_1_vld, wrStateMachineBitNatural_wrAddrCnt,
    ...
    CASE wrStateMachineBitNatural_wrState IS
      WHEN "00" =>
        IF dout_8_1_vld = '1' THEN 
          ...
          wrStateMachineBitNatural_wrAddrCnt_next <= to_unsigned(16#01#, 8);
        ELSE 
          wrStateMachineBitNatural_wrState_next <= to_unsigned(16#0#, 2);
          wrStateMachineBitNatural_wrAddrCnt_next <= to_unsigned(16#00#, 8);
        END IF;
      WHEN "01" =>
        IF dout_8_1_vld = '1' THEN 
          IF wrStateMachineBitNatural_wrAddrCnt = to_unsigned(16#FF#, 8) THEN 
            wrStateMachineBitNatural_wrAddrCnt_next <= to_unsigned(16#00#, 8);
            wrStateMachineBitNatural_wrState_next <= to_unsigned(16#2#, 2);
          ELSE 
            wrStateMachineBitNatural_wrAddrCnt_next <= wrStateMachineBitNatural_wrAddrCnt + to_unsigned(16#01#, 8);
            wrStateMachineBitNatural_wrState_next <= to_unsigned(16#1#, 2);
          END IF;
        END IF;
      WHEN "10" =>
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdStateMachineBitNatural_rdAddrCnt <= to_unsigned(16#00#, 8);
  ...
  BEGIN
    ...
    rdStateMachineBitNatural_startOutReg_next <= hdlcoder_to_stdlogic(rdStateMachineBitNatural_rdAddrCnt = to_unsigned(16#01#, 8));
    CASE rdStateMachineBitNatural_rdState IS
      WHEN "00" =>
        rdStateMachineBitNatural_doutVldReg1_next <= '0';
        IF sampleIdx >= to_unsigned(16#ED#, 8) THEN 
          rdStateMachineBitNatural_rdAddrCnt_next <= to_unsigned(16#01#, 8);
        ...
        ELSE 
          rdStateMachineBitNatural_rdAddrCnt_next <= to_unsigned(16#00#, 8);
          rdStateMachineBitNatural_rdState_next <= to_unsigned(16#0#, 2);
          rdStateMachineBitNatural_endOutReg1_next <= '0';
        END IF;
      WHEN "01" =>
        rdStateMachineBitNatural_doutVldReg1_next <= '1';
        IF rdStateMachineBitNatural_rdAddrCnt = to_unsigned(16#FF#, 8) THEN 
          rdStateMachineBitNatural_rdAddrCnt_next <= to_unsigned(16#00#, 8);
          rdStateMachineBitNatural_rdState_next <= to_unsigned(16#2#, 2);
          rdStateMachineBitNatural_endOutReg1_next <= '1';
        ELSE 
          rdStateMachineBitNatural_rdAddrCnt_next <= rdStateMachineBitNatural_rdAddrCnt + to_unsigned(16#01#, 8);
          rdStateMachineBitNatural_rdState_next <= to_unsigned(16#1#, 2);
          rdStateMachineBitNatural_endOutReg1_next <= '0';
        END IF;
      WHEN "10" =>
