-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block10.vhd
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block10 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block10;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block10 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_9_Enb <= '0';
        IF (hdlcoder_to_stdlogic(SDFController_wrState = to_unsigned(16#3#, 2)) AND dinXTwdl_9_vld) = '1' THEN 
