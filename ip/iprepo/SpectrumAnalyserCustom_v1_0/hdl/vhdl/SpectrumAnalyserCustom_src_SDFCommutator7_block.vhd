-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_SDFCommutator7_block.vhd
...
ENTITY SpectrumAnalyserCustom_src_SDFCommutator7_block IS
...
END SpectrumAnalyserCustom_src_SDFCommutator7_block;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_SDFCommutator7_block IS
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(22 DOWNTO 0);  -- sfix23_En15
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(22 DOWNTO 0);  -- sfix23_En15
  ...
  SIGNAL dout_7_re_tmp                    : signed(22 DOWNTO 0);  -- sfix23_En15
  SIGNAL dout_7_im_tmp                    : signed(22 DOWNTO 0);  -- sfix23_En15

BEGIN
  u_dataXMEM_re_0_7 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_7 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 23
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    ...
    END IF;
    dout_7_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_7_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_7_vld <= SDFOutmux_btfPipe_vld;
