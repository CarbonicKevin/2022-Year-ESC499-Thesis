-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_axi_lite
-- Source Path: SpectrumAnalyserCustom/SpectrumAnalyserCustom_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyserCustom_axi_lite IS
...
END SpectrumAnalyserCustom_axi_lite;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_axi_lite IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_addr_decoder
  ...
  COMPONENT SpectrumAnalyserCustom_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : SpectrumAnalyserCustom_addr_decoder
    USE ENTITY work.SpectrumAnalyserCustom_addr_decoder(rtl);

  FOR ALL : SpectrumAnalyserCustom_axi_lite_module
    USE ENTITY work.SpectrumAnalyserCustom_axi_lite_module(rtl);
...
BEGIN
  u_SpectrumAnalyserCustom_addr_decoder_inst : SpectrumAnalyserCustom_addr_decoder
  ...
  u_SpectrumAnalyserCustom_axi_lite_module_inst : SpectrumAnalyserCustom_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
