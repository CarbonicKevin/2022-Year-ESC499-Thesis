...
ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_15 IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_Complex4Multiply_block26
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Complex4Multiply_block26
    USE ENTITY work.SpectrumAnalyserCustom_src_Complex4Multiply_block26(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyserCustom_src_Complex4Multiply_block26
    PORT MAP( clk => clk,
              reset => reset,
