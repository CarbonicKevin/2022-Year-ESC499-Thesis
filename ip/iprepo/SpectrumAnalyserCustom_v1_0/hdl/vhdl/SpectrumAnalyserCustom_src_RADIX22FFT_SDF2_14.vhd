-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_14
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_14 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_14;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_14 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_13_1_vld                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator14
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator14(rtl);
...
BEGIN
  u_SDFCOMMUTATOR_14 : SpectrumAnalyserCustom_src_SDFCommutator14
    PORT MAP( clk => clk,
              reset => reset,
