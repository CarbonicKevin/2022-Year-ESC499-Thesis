-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_TWDLROM_3_1_block3.vhd
...
ENTITY SpectrumAnalyserCustom_src_TWDLROM_3_1_block3 IS
...
END SpectrumAnalyserCustom_src_TWDLROM_3_1_block3;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_TWDLROM_3_1_block3 IS
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    IF (dout_2_1_vld AND hdlcoder_to_stdlogic(Radix22TwdlMapping_cnt > to_unsigned(16#3E#, 6))) = '1' THEN 
