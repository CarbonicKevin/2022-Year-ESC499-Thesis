-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_Vector_to_SSR_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_Vector_to_SSR_block
...
ENTITY SpectrumAnalyserCustom_src_Vector_to_SSR_block IS
  PORT( Vector                            :   IN    vector_of_std_logic_vector16(0 TO 7);  -- uint16 [8]
        SSR                               :   OUT   std_logic_vector(127 DOWNTO 0)  -- ufix128
        );
END SpectrumAnalyserCustom_src_Vector_to_SSR_block;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_Vector_to_SSR_block IS
