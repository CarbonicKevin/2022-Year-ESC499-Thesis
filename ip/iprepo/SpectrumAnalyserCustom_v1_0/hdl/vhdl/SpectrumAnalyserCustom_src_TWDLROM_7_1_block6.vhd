-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_TWDLROM_7_1_block6.vhd
...
ENTITY SpectrumAnalyserCustom_src_TWDLROM_7_1_block6 IS
...
END SpectrumAnalyserCustom_src_TWDLROM_7_1_block6;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_TWDLROM_7_1_block6 IS
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    IF (dout_6_1_vld AND hdlcoder_to_stdlogic(Radix22TwdlMapping_cnt > to_unsigned(16#6F#, 7))) = '1' THEN 
