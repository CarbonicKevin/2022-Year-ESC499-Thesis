-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_axi_lite_module
-- Source Path: SpectrumAnalyserCustom/SpectrumAnalyserCustom_axi_lite/SpectrumAnalyserCustom_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyserCustom_axi_lite_module IS
...
END SpectrumAnalyserCustom_axi_lite_module;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_axi_lite_module IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_reset_hold
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_reset_hold
    USE ENTITY work.SpectrumAnalyserCustom_reset_hold(rtl);
  ...
  SIGNAL in_burst_out                     : std_logic;  -- ufix1
  SIGNAL soft_reset_after_hold            : std_logic;  -- ufix1
  SIGNAL soft_reset_pending_1             : std_logic;  -- ufix1

BEGIN
  u_SpectrumAnalyserCustom_reset_hold_inst : SpectrumAnalyserCustom_reset_hold
    PORT MAP( clk => clk,
              reset => reset,
              reset_in => soft_reset,  -- ufix1
              in_burst => in_burst_out,  -- ufix1
              reset_out => soft_reset_after_hold,  -- ufix1
              reset_pending => soft_reset_pending_1  -- ufix1
              );
  ...
  in_burst_out <= in_burst_axi4_master_rd OR in_burst_axi4_master_wr;

  reset_internal <= reset OR soft_reset_after_hold;

  soft_reset_pending <= soft_reset_pending_1;
