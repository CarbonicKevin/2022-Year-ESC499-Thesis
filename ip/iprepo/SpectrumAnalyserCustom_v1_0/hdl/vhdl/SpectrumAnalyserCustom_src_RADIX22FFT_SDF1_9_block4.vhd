-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_9_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_9_block4
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_9_block4 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_9_block4;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_9_block4 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_Complex4Multiply_block35
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator9_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_9_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Complex4Multiply_block35
    USE ENTITY work.SpectrumAnalyserCustom_src_Complex4Multiply_block35(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator9_block4
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator9_block4(rtl);

  -- Signals
  SIGNAL din_9_re_dly_signed              : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL din_re                           : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL din_9_im_dly_signed              : signed(23 DOWNTO 0);  -- sfix24_En15
  ...
  SIGNAL wrData_im_signed                 : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL wrData_re                        : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL wrData_re_signed                 : signed(24 DOWNTO 0);  -- sfix25_En15
  ...
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL x_re                             : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL x_im                             : signed(24 DOWNTO 0);  -- sfix25_En15
  ...
  SIGNAL dout_9_re_tmp                    : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL dout_9_im_tmp                    : std_logic_vector(24 DOWNTO 0);  -- ufix25

BEGIN
  u_MUL4 : SpectrumAnalyserCustom_src_Complex4Multiply_block35
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_9 : SpectrumAnalyserCustom_src_SDFCommutator9_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_9_vld_dly => din_9_vld_dly,
              ...
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_9_re => dout_9_re_tmp,  -- sfix25_En15
              dout_9_im => dout_9_im_tmp,  -- sfix25_En15
              dout_9_vld => dout_9_vld
              );

  din_9_re_dly_signed <= signed(din_9_re_dly);

  din_re <= resize(din_9_re_dly_signed, 25);

  din_9_im_dly_signed <= signed(din_9_im_dly);

  din_im <= resize(din_9_im_dly_signed, 25);
  ...
  Radix22ButterflyG1_add_cast <= resize(x_re, 26);
  ...
  Radix22ButterflyG1_sub_cast <= resize(x_re, 26);
  ...
  Radix22ButterflyG1_add_cast_2 <= resize(x_im, 26);
  ...
  Radix22ButterflyG1_sub_cast_2 <= resize(x_im, 26);
