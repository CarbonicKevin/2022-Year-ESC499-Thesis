-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_addr_decoder
-- Source Path: SpectrumAnalyserCustom/SpectrumAnalyserCustom_axi_lite/SpectrumAnalyserCustom_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyserCustom_addr_decoder IS
...
END SpectrumAnalyserCustom_addr_decoder;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_addr_decoder IS
