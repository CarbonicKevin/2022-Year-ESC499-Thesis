-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13_block1
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13_block1 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13_block1;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13_block1 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_Complex4Multiply_block43
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator13_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_13_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Complex4Multiply_block43
    USE ENTITY work.SpectrumAnalyserCustom_src_Complex4Multiply_block43(rtl);
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator13_block1
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator13_block1(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyserCustom_src_Complex4Multiply_block43
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_13 : SpectrumAnalyserCustom_src_SDFCommutator13_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_13_vld_dly => din_13_vld_dly,
