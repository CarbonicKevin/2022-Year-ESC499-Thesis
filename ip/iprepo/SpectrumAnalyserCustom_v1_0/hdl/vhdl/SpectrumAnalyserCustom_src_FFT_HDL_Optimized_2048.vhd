-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_FFT_HDL_Optimized_2048.vhd
...
ENTITY SpectrumAnalyserCustom_src_FFT_HDL_Optimized_2048 IS
...
END SpectrumAnalyserCustom_src_FFT_HDL_Optimized_2048;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_FFT_HDL_Optimized_2048 IS
...
BEGIN
  ...
  u_twdlROM_11 : SpectrumAnalyserCustom_src_TWDLROM_11_1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_10_1_vld => dout_10_1_vld,
  ...
  u_RADIX2 : SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
