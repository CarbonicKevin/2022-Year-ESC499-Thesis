...
-- Core/FFT HDL Optimized 128/RADIX22FFT_CTRL1_
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block IS
  ...
  SIGNAL rd_1_Addr_tmp                    : unsigned(5 DOWNTO 0);  -- ufix6
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_1_Enb <= '0';
        IF (dinXTwdl_1_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3F#, 6))) = '1' THEN 
