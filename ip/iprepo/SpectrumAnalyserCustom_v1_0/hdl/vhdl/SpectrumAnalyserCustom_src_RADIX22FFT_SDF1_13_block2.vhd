-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13_block2
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13_block2 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13_block2;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13_block2 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_Complex4Multiply_block50
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator13_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_13_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Complex4Multiply_block50
    USE ENTITY work.SpectrumAnalyserCustom_src_Complex4Multiply_block50(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator13_block2
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator13_block2(rtl);

  -- Signals
  SIGNAL din_13_re_dly_signed             : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL din_re                           : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL din_13_im_dly_signed             : signed(27 DOWNTO 0);  -- sfix28_En15
  ...
  SIGNAL dinXTwdl_13_vld_1                : std_logic;
  ...
  SIGNAL wrData_im_signed                 : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL wrData_re                        : std_logic_vector(28 DOWNTO 0);  -- ufix29
  SIGNAL wrData_re_signed                 : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL wrAddr                           : std_logic;  -- ufix1
  SIGNAL wrEnb                            : std_logic;
  SIGNAL twoLocationReg_0_MEM_re_0        : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL twoLocationReg_0_MEM_im_0        : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL twoLocationReg_0_MEM_re_1        : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL twoLocationReg_0_MEM_im_1        : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL twoLocationReg_0_dout_re_reg     : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL twoLocationReg_0_dout_im_reg     : signed(28 DOWNTO 0);  -- sfix29
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL x_re                             : signed(28 DOWNTO 0);  -- sfix29_En15
  SIGNAL x_im                             : signed(28 DOWNTO 0);  -- sfix29_En15
  ...
  SIGNAL dout_13_re_tmp                   : std_logic_vector(28 DOWNTO 0);  -- ufix29
  SIGNAL dout_13_im_tmp                   : std_logic_vector(28 DOWNTO 0);  -- ufix29

BEGIN
  u_MUL4 : SpectrumAnalyserCustom_src_Complex4Multiply_block50
    PORT MAP( clk => clk,
              reset => reset,
              ...
              dinXTwdl_13_vld => dinXTwdl_13_vld_1
              );

  u_SDFCOMMUTATOR_13 : SpectrumAnalyserCustom_src_SDFCommutator13_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_13_vld_dly => din_13_vld_dly,
              ...
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_13_re => dout_13_re_tmp,  -- sfix29_En15
              dout_13_im => dout_13_im_tmp,  -- sfix29_En15
              dout_13_vld => dout_13_vld
              );

  din_13_re_dly_signed <= signed(din_13_re_dly);

  din_re <= resize(din_13_re_dly_signed, 29);

  din_13_im_dly_signed <= signed(din_13_im_dly);

  din_im <= resize(din_13_im_dly_signed, 29);
  ...
  BEGIN
    IF reset = '1' THEN
      twoLocationReg_0_MEM_re_0 <= to_signed(16#00000000#, 29);
      twoLocationReg_0_MEM_im_0 <= to_signed(16#00000000#, 29);
      twoLocationReg_0_MEM_re_1 <= to_signed(16#00000000#, 29);
      twoLocationReg_0_MEM_im_1 <= to_signed(16#00000000#, 29);
      twoLocationReg_0_dout_re_reg <= to_signed(16#00000000#, 29);
      twoLocationReg_0_dout_im_reg <= to_signed(16#00000000#, 29);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_16_0 = '1' THEN
  ...
  twoLocationReg_0_output : PROCESS (rd_13_Addr, twoLocationReg_0_MEM_im_0, twoLocationReg_0_MEM_im_1,
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_16_0 = '1' THEN
        ...
        xf_im <= x_im;
        xf_vld <= x_vld;
        Radix22ButterflyG1_dinXtwdl_vld_dly1 <= proc_13_enb AND dinXTwdl_13_vld_1;
      END IF;
    END IF;
  END PROCESS Radix22ButterflyG1_process;

  dinxTwdlf_vld <= ( NOT proc_13_enb) AND dinXTwdl_13_vld_1;
  Radix22ButterflyG1_add_cast <= resize(x_re, 30);
  ...
  Radix22ButterflyG1_sub_cast <= resize(x_re, 30);
  ...
  Radix22ButterflyG1_add_cast_2 <= resize(x_im, 30);
  ...
  Radix22ButterflyG1_sub_cast_2 <= resize(x_im, 30);
  ...
  dout_13_re <= dout_13_re_tmp;

  dout_13_im <= dout_13_im_tmp;
