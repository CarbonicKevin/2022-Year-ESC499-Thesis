-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_7_block5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_7_block5
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_7_block5 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_7_block5;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_7_block5 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_7_Enb <= '0';
        IF (dinXTwdl_7_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3#, 2))) = '1' THEN 
