-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_SDFCommutator10.vhd
...
ENTITY SpectrumAnalyserCustom_src_SDFCommutator10 IS
...
END SpectrumAnalyserCustom_src_SDFCommutator10;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_SDFCommutator10 IS
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(25 DOWNTO 0);  -- sfix26_En15
...
BEGIN
  u_dataXMEM_re_0_10 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_10 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 26
                 )
    PORT MAP( clk => clk,
