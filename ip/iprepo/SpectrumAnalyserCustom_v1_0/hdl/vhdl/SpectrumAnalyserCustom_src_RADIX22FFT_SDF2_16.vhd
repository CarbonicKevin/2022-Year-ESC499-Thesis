-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_16.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_16
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_16 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_16;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_16 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator16
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_15_1_vld                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator16
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator16(rtl);
...
BEGIN
  u_SDFCOMMUTATOR_16 : SpectrumAnalyserCustom_src_SDFCommutator16
    PORT MAP( clk => clk,
              reset => reset,
