-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_8_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_8_block3
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_8_block3 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_8_block3;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_8_block3 IS
  ...
  SIGNAL rd_8_Addr_tmp                    : unsigned(6 DOWNTO 0);  -- ufix7
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_8_Enb <= '0';
        IF (dout_7_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7F#, 7))) = '1' THEN 
