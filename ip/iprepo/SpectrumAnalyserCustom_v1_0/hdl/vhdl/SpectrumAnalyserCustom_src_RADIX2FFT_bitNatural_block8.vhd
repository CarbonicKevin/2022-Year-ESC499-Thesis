-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block8
...
ENTITY SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block8 IS
...
END SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block8;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block8 IS
...
BEGIN
  u_dataMEM_im_1 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_1 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 16,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
