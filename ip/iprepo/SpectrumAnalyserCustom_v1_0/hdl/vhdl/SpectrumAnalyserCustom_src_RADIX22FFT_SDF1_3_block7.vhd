-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_3_block7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_3_block7
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_3_block7 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_3_block7;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_3_block7 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_Complex4Multiply_block36
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator3_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_3_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Complex4Multiply_block36
    USE ENTITY work.SpectrumAnalyserCustom_src_Complex4Multiply_block36(rtl);
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator3_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator3_block7(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyserCustom_src_Complex4Multiply_block36
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_3 : SpectrumAnalyserCustom_src_SDFCommutator3_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_3_vld_dly => din_3_vld_dly,
