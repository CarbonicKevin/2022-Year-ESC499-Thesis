...
-- Core/FFT HDL Optimized 128/RADIX2FFT_bitNatura
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block IS
  ...
  SIGNAL memOut_im_signed                 : signed(22 DOWNTO 0);  -- sfix23_En15
  SIGNAL memOut_re                        : std_logic_vector(22 DOWNTO 0);  -- ufix23
  SIGNAL memOut_re_signed                 : signed(22 DOWNTO 0);  -- sfix23_En15
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(22 DOWNTO 0);  -- sfix23_En15
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(22 DOWNTO 0);  -- sfix23_En15
  ...
  SIGNAL dout_re1_tmp                     : signed(22 DOWNTO 0);  -- sfix23_En15
  SIGNAL dout_im1_tmp                     : signed(22 DOWNTO 0);  -- sfix23_En15
