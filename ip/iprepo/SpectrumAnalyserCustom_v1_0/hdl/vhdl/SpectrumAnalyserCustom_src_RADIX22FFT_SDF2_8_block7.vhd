-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8_block7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8_block7
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8_block7 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8_block7;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_8_block7 IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator8_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator8_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator8_block7(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_8 : SpectrumAnalyserCustom_src_SDFCommutator8_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
