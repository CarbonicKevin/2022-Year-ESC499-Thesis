-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block6
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block6 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block6;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block6 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_4_Enb <= '0';
        IF (dout_3_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#1F#, 5))) = '1' THEN 
