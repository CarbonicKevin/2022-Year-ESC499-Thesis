-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_axi4_master_wr.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_axi4_master_wr
-- Source Path: SpectrumAnalyserCustom/SpectrumAnalyserCustom_axi4_master_wr
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyserCustom_axi4_master_wr IS
...
END SpectrumAnalyserCustom_axi4_master_wr;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_axi4_master_wr IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_wdata_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_wr_addr_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT SpectrumAnalyserCustom_wr_data_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT SpectrumAnalyserCustom_wr_len_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT SpectrumAnalyserCustom_wlast_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_wdata_fifo
    USE ENTITY work.SpectrumAnalyserCustom_wdata_fifo(rtl);

  FOR ALL : SpectrumAnalyserCustom_wr_addr_fifo
    USE ENTITY work.SpectrumAnalyserCustom_wr_addr_fifo(rtl);

  FOR ALL : SpectrumAnalyserCustom_wr_data_fifo
    USE ENTITY work.SpectrumAnalyserCustom_wr_data_fifo(rtl);

  FOR ALL : SpectrumAnalyserCustom_wr_len_fifo
    USE ENTITY work.SpectrumAnalyserCustom_wr_len_fifo(rtl);

  FOR ALL : SpectrumAnalyserCustom_wlast_fifo
    USE ENTITY work.SpectrumAnalyserCustom_wlast_fifo(rtl);
...
BEGIN
  u_SpectrumAnalyserCustom_wdata_fifo_inst : SpectrumAnalyserCustom_wdata_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyserCustom_wr_addr_fifo_inst : SpectrumAnalyserCustom_wr_addr_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyserCustom_wr_data_fifo_inst : SpectrumAnalyserCustom_wr_data_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyserCustom_wr_len_fifo_inst : SpectrumAnalyserCustom_wr_len_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_SpectrumAnalyserCustom_wlast_fifo_inst : SpectrumAnalyserCustom_wlast_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
