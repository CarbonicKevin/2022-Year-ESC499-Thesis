-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_FFT_HDL_Optimized_64.vhd
...
ENTITY SpectrumAnalyserCustom_src_FFT_HDL_Optimized_64 IS
...
END SpectrumAnalyserCustom_src_FFT_HDL_Optimized_64;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_FFT_HDL_Optimized_64 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_2_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_TWDLROM_3_1_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_3_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_3_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_4_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_TWDLROM_5_1_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_5_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_6_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_6_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_6_1_re                     :   IN    std_logic_vector(21 DOWNTO 0);  -- sfix22_En15
          dout_6_1_im                     :   IN    std_logic_vector(21 DOWNTO 0);  -- sfix22_En15
          dout_6_1_vld                    :   IN    std_logic;
          softReset                       :   IN    std_logic;
          dout_re1                        :   OUT   std_logic_vector(21 DOWNTO 0);  -- sfix22_En15
          dout_im1                        :   OUT   std_logic_vector(21 DOWNTO 0);  -- sfix22_En15
  ...
  FOR ALL : SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block11
    USE ENTITY work.SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block11(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block7(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block7(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_2_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_2_block7(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_TWDLROM_3_1_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_TWDLROM_3_1_block7(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_3_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_3_block7(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_3_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_3_block7(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block7(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_4_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_4_block7(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_TWDLROM_5_1_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_TWDLROM_5_1_block7(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_5_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_5_block7(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5_block7(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_6_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_6_block7(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_6_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_6_block7(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block7
    USE ENTITY work.SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block7(rtl);
...
BEGIN
  u_CTRL1_1_1 : SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block11
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDF1_1_1 : SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_1_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_CTRL2_2_1 : SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_1_1_vld => dout_1_1_vld,
  ...
  u_SDF2_2_1 : SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_2_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_1_1_re => dout_1_1_re,  -- sfix17_En15
  ...
  u_twdlROM_3_1 : SpectrumAnalyserCustom_src_TWDLROM_3_1_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_2_1_vld => dout_2_1_vld,
  ...
  u_CTRL1_3_1 : SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_3_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_SDF1_3_1 : SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_3_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_CTRL2_4_1 : SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_4_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_3_1_vld => dout_3_1_vld,
  ...
  u_SDF2_4_1 : SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_4_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_3_1_re => dout_3_1_re,  -- sfix19_En15
  ...
  u_twdlROM_5_1 : SpectrumAnalyserCustom_src_TWDLROM_5_1_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_4_1_vld => dout_4_1_vld,
  ...
  u_CTRL1_5_1 : SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_5_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_SDF1_5_1 : SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_5_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_CTRL2_6_1 : SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_6_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_5_1_vld => dout_5_1_vld,
  ...
  u_SDF2_6_1 : SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_6_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_5_1_re => dout_5_1_re,  -- sfix21_En15
  ...
  u_NaturalOrder_Stage : SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_6_1_re => dout_6_1_re,  -- sfix22_En15
              ...
              dout_6_1_vld => dout_6_1_vld,
              softReset => softReset,
              dout_re1 => dout_re1,  -- sfix22_En15
              dout_im1 => dout_im1,  -- sfix22_En15
              dout_vld1 => dout_vld1,
              startOutS => startOutS,
              endOutS => endOutS
              );
