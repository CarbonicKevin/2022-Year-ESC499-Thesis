-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block12.vhd
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block12 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block12;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block12 IS
  ...
  -- Signals
  SIGNAL SDFController_wrCount            : unsigned(14 DOWNTO 0);  -- ufix15
  SIGNAL SDFController_wrState            : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL SDFController_rdState            : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL SDFController_rdAddr_reg         : unsigned(14 DOWNTO 0);  -- ufix15
  ...
  SIGNAL SDFController_wrCount_next       : unsigned(14 DOWNTO 0);  -- ufix15
  SIGNAL SDFController_wrState_next       : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL SDFController_rdState_next       : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL SDFController_rdAddr_reg_next    : unsigned(14 DOWNTO 0);  -- ufix15
  ...
  SIGNAL rd_1_Addr_tmp                    : unsigned(14 DOWNTO 0);  -- ufix15
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      SDFController_wrCount <= to_unsigned(16#0000#, 15);
      SDFController_rdAddr_reg <= to_unsigned(16#0000#, 15);
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        SDFController_rdAddr_reg_next <= to_unsigned(16#0000#, 15);
        rd_1_Enb <= '0';
        IF (dinXTwdl_1_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7FFF#, 15))) = '1' THEN 
      ...
      WHEN "01" =>
        ...
        IF dinXTwdl_1_1_vld_1 = '1' THEN 
          IF SDFController_rdAddr_reg = to_unsigned(16#7FFF#, 15) THEN 
            SDFController_rdState_next <= to_unsigned(16#2#, 2);
          END IF;
          SDFController_rdAddr_reg_next <= SDFController_rdAddr_reg + to_unsigned(16#0001#, 15);
        END IF;
      WHEN "10" =>
        rd_1_Enb <= '1';
        IF SDFController_rdAddr_reg = to_unsigned(16#7FFF#, 15) THEN 
    ...
    CASE SDFController_wrState IS
      WHEN "00" =>
        ...
        SDFController_wrCount_next <= to_unsigned(16#0000#, 15);
        SDFController_procEnb_reg_next <= '0';
        IF dinXTwdl_1_1_vld = '1' THEN 
          SDFController_wrState_next <= to_unsigned(16#1#, 2);
          SDFController_wrCount_next <= to_unsigned(16#0001#, 15);
        END IF;
      WHEN "01" =>
        SDFController_wrState_next <= to_unsigned(16#1#, 2);
        SDFController_procEnb_reg_next <= '0';
        IF dinXTwdl_1_1_vld = '1' THEN 
          IF SDFController_wrCount = to_unsigned(16#7FFF#, 15) THEN 
            SDFController_wrState_next <= to_unsigned(16#2#, 2);
            SDFController_procEnb_reg_next <= '1';
          ELSE 
            SDFController_wrState_next <= to_unsigned(16#1#, 2);
          END IF;
          SDFController_wrCount_next <= SDFController_wrCount + to_unsigned(16#0001#, 15);
        END IF;
      WHEN "10" =>
        SDFController_wrState_next <= to_unsigned(16#2#, 2);
        IF dinXTwdl_1_1_vld = '1' THEN 
      ...
      WHEN OTHERS => 
        SDFController_wrState_next <= to_unsigned(16#0#, 2);
        SDFController_wrCount_next <= to_unsigned(16#7FFF#, 15);
        SDFController_procEnb_reg_next <= '0';
    END CASE;
