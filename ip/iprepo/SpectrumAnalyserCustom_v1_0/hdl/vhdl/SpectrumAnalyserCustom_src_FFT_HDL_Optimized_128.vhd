-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_FFT_HDL_Optimized_128.vhd
...
ENTITY SpectrumAnalyserCustom_src_FFT_HDL_Optimized_128 IS
...
END SpectrumAnalyserCustom_src_FFT_HDL_Optimized_128;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_FFT_HDL_Optimized_128 IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_7_re                       :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En15
          dout_7_im                       :   IN    std_logic_vector(22 DOWNTO 0);  -- sfix23_En15
          dout_7_vld                      :   IN    std_logic;
          softReset                       :   IN    std_logic;
          dout_re1                        :   OUT   std_logic_vector(22 DOWNTO 0);  -- sfix23_En15
          dout_im1                        :   OUT   std_logic_vector(22 DOWNTO 0);  -- sfix23_En15
  ...
  SIGNAL din_7_re_dly                     : signed(21 DOWNTO 0);  -- sfix22_En15
  ...
  SIGNAL din_7_im_dly                     : signed(21 DOWNTO 0);  -- sfix22_En15
  ...
  SIGNAL twdl_7_re                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdl_7_im                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdl_7_vld                       : std_logic;
  ...
  SIGNAL dout_7_re                        : std_logic_vector(22 DOWNTO 0);  -- ufix23
  SIGNAL dout_7_im                        : std_logic_vector(22 DOWNTO 0);  -- ufix23
...
BEGIN
  ...
  u_twdlROM_7 : SpectrumAnalyserCustom_src_TWDLROM_7_1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_6_1_vld => dout_6_1_vld,
  ...
  u_RADIX2 : SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_7_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_7_re_dly => std_logic_vector(din_7_re_dly),  -- sfix22_En15
              din_7_im_dly => std_logic_vector(din_7_im_dly),  -- sfix22_En15
              ...
              proc_7_enb => proc_7_enb,
              softReset => softReset,
              dout_7_re => dout_7_re,  -- sfix23_En15
              dout_7_im => dout_7_im,  -- sfix23_En15
  ...
  u_NaturalOrder_Stage : SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block
    PORT MAP( clk => clk,
              ...
              dout_7_vld => dout_7_vld,
              softReset => softReset,
              dout_re1 => dout_re1,  -- sfix23_En15
              dout_im1 => dout_im1,  -- sfix23_En15
              dout_vld1 => dout_vld1,
              startOutS => startOutS,
              endOutS => endOutS
              );
  ...
  din_7_re_dly <= intdelay_reg_10(2);
  ...
  din_7_im_dly <= intdelay_reg_11(2);
