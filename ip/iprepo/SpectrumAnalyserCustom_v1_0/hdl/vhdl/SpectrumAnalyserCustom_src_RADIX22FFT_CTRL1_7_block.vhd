-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_7_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_7_block
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_7_block IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_7_block;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_7_block IS
  ...
  SIGNAL rd_7_Addr_tmp                    : unsigned(6 DOWNTO 0);  -- ufix7
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_7_Enb <= '0';
        IF (dinXTwdl_7_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7F#, 7))) = '1' THEN 
