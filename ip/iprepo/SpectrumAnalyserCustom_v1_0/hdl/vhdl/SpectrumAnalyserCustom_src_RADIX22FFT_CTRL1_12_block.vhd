-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_12_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_12_block
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_12_block IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_12_block;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_12_block IS
  ...
  SIGNAL rd_12_Addr_tmp                   : unsigned(2 DOWNTO 0);  -- ufix3
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_12_Enb <= '0';
        IF (dout_11_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7#, 3))) = '1' THEN 
