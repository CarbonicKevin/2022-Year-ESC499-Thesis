-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11_block4
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11_block4 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11_block4;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11_block4 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_Complex4Multiply_block49
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator11_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_11_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Complex4Multiply_block49
    USE ENTITY work.SpectrumAnalyserCustom_src_Complex4Multiply_block49(rtl);
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator11_block4
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator11_block4(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyserCustom_src_Complex4Multiply_block49
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_11 : SpectrumAnalyserCustom_src_SDFCommutator11_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_11_vld_dly => din_11_vld_dly,
