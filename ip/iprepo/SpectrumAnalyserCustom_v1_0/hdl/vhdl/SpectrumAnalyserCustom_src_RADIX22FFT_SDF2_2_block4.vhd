-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_2_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_2_block4
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_2_block4 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_2_block4;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_2_block4 IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator2_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator2_block4
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator2_block4(rtl);
...
BEGIN
  u_dataMEM_im_0_2 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_2 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 13,
                 DataWidth => 18
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_2 : SpectrumAnalyserCustom_src_SDFCommutator2_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
