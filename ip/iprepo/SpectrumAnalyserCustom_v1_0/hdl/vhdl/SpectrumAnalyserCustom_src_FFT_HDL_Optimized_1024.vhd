-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_FFT_HDL_Optimized_1024.vhd
...
ENTITY SpectrumAnalyserCustom_src_FFT_HDL_Optimized_1024 IS
...
END SpectrumAnalyserCustom_src_FFT_HDL_Optimized_1024;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_FFT_HDL_Optimized_1024 IS
...
BEGIN
  ...
  u_NaturalOrder_Stage : SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural
    PORT MAP( clk => clk,
              ...
              dout_10_1_vld => dout_10_1_vld,
              softReset => softReset,
              dout_re1 => dout_re1,  -- sfix26_En15
              dout_im1 => dout_im1,  -- sfix26_En15
              dout_vld1 => dout_vld1,
              startOutS => startOutS,
              endOutS => endOutS
              );
