-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_SDFCommutator14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_SDFCommutator14
...
ENTITY SpectrumAnalyserCustom_src_SDFCommutator14 IS
...
END SpectrumAnalyserCustom_src_SDFCommutator14;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_SDFCommutator14 IS
...
BEGIN
  u_dataXMEM_re_0_14 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_14 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 30
                 )
    PORT MAP( clk => clk,
