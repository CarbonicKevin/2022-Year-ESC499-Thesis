-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_13 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_Complex4Multiply_block11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_13_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Complex4Multiply_block11
    USE ENTITY work.SpectrumAnalyserCustom_src_Complex4Multiply_block11(rtl);

  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator13
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator13(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyserCustom_src_Complex4Multiply_block11
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_13 : SpectrumAnalyserCustom_src_SDFCommutator13
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_13_vld_dly => din_13_vld_dly,
