-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_FFT_HDL_Optimized_256.vhd
...
ENTITY SpectrumAnalyserCustom_src_FFT_HDL_Optimized_256 IS
...
END SpectrumAnalyserCustom_src_FFT_HDL_Optimized_256;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_FFT_HDL_Optimized_256 IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_RADIX2FFT_bitNatural_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_8_1_re                     :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En15
          dout_8_1_im                     :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En15
          dout_8_1_vld                    :   IN    std_logic;
          softReset                       :   IN    std_logic;
          dout_re1                        :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En15
          dout_im1                        :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En15
  ...
  SIGNAL dout_re1                         : std_logic_vector(23 DOWNTO 0);  -- ufix24
...
BEGIN
  u_CTRL1_1_1 : SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_1_block5
    PORT MAP( clk => clk,
              reset => reset,
