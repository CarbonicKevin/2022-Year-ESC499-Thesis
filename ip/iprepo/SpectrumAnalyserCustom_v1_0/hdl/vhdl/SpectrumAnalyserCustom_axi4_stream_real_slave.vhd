-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_axi4_stream_real_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_axi4_stream_real_slave
-- Source Path: SpectrumAnalyserCustom/SpectrumAnalyserCustom_axi4_stream_real_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyserCustom_axi4_stream_real_slave IS
...
END SpectrumAnalyserCustom_axi4_stream_real_slave;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_axi4_stream_real_slave IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_fifo_data
    USE ENTITY work.SpectrumAnalyserCustom_fifo_data(rtl);
...
BEGIN
  u_SpectrumAnalyserCustom_fifo_data_inst : SpectrumAnalyserCustom_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
