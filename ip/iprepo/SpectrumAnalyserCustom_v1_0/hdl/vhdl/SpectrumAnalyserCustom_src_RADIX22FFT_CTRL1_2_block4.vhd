-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block4
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block4 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block4;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block4 IS
  ...
  SIGNAL rd_2_Addr_tmp                    : unsigned(12 DOWNTO 0);  -- ufix13
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_2_Enb <= '0';
        IF (dout_1_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#1FFF#, 13))) = '1' THEN 
