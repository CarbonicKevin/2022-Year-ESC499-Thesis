-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_10_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_10_block2
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_10_block2 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_10_block2;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF2_10_block2 IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator10_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_9_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator10_block2
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator10_block2(rtl);
...
BEGIN
  u_dataMEM_im_0_10 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_10 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 26
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_10 : SpectrumAnalyserCustom_src_SDFCommutator10_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
