-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block2
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block2 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block2;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_2_block2 IS
  ...
  SIGNAL rd_2_Addr_tmp                    : unsigned(13 DOWNTO 0);  -- ufix14
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_2_Enb <= '0';
        IF (dout_1_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3FFF#, 14))) = '1' THEN 
