-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11_block2
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11_block2 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11_block2;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11_block2 IS
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator11_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_11_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator11_block2
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator11_block2(rtl);
...
BEGIN
  ...
  u_dataMEM_im_0_11 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_11 : SpectrumAnalyserCustom_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 27
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_11 : SpectrumAnalyserCustom_src_SDFCommutator11_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_11_vld_dly => din_11_vld_dly,
