-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11 IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_SDF1_11 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyserCustom_src_Complex4Multiply_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyserCustom_src_SDFCommutator11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_11_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyserCustom_src_Complex4Multiply_block3
    USE ENTITY work.SpectrumAnalyserCustom_src_Complex4Multiply_block3(rtl);
  ...
  FOR ALL : SpectrumAnalyserCustom_src_SDFCommutator11
    USE ENTITY work.SpectrumAnalyserCustom_src_SDFCommutator11(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyserCustom_src_Complex4Multiply_block3
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_11 : SpectrumAnalyserCustom_src_SDFCommutator11
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_11_vld_dly => din_11_vld_dly,
