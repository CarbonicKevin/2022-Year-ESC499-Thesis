-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_11_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_11_block
...
ENTITY SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_11_block IS
...
END SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_11_block;


ARCHITECTURE rtl OF SpectrumAnalyserCustom_src_RADIX22FFT_CTRL1_11_block IS
  ...
  SIGNAL rd_11_Addr_tmp                   : unsigned(3 DOWNTO 0);  -- ufix4
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_11_Enb <= '0';
        IF (dinXTwdl_11_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#F#, 4))) = '1' THEN 
