...
BEGIN
  ...
  Multiport_Switch_out1_re <= FFT_HDL_Optimized_4096_out1_dtc_re WHEN Selector_unsigned = to_unsigned(16#00#, 8) ELSE
      FFT_HDL_Optimized_8192_out1_dtc_re WHEN Selector_unsigned = to_unsigned(16#01#, 8) ELSE
      FFT_HDL_Optimized_16384_out1_dtc_re WHEN Selector_unsigned = to_unsigned(16#02#, 8) ELSE
      FFT_HDL_Optimized_32768_out1_dtc_re WHEN Selector_unsigned = to_unsigned(16#03#, 8) ELSE
      FFT_HDL_Optimized_65536_out1_re_signed;
  
  Multiport_Switch_out1_im <= FFT_HDL_Optimized_4096_out1_dtc_im WHEN Selector_unsigned = to_unsigned(16#00#, 8) ELSE
      FFT_HDL_Optimized_8192_out1_dtc_im WHEN Selector_unsigned = to_unsigned(16#01#, 8) ELSE
      FFT_HDL_Optimized_16384_out1_dtc_im WHEN Selector_unsigned = to_unsigned(16#02#, 8) ELSE
      FFT_HDL_Optimized_32768_out1_dtc_im WHEN Selector_unsigned = to_unsigned(16#03#, 8) ELSE
  ...
  Multiport_Switch1_out1 <= FFT_HDL_Optimized_4096_out2 WHEN Selector_unsigned = to_unsigned(16#00#, 8) ELSE
      FFT_HDL_Optimized_8192_out2 WHEN Selector_unsigned = to_unsigned(16#01#, 8) ELSE
      FFT_HDL_Optimized_16384_out2 WHEN Selector_unsigned = to_unsigned(16#02#, 8) ELSE
      FFT_HDL_Optimized_32768_out2 WHEN Selector_unsigned = to_unsigned(16#03#, 8) ELSE
      FFT_HDL_Optimized_65536_out2;

  Start <= Multiport_Switch1_out1;

  
  Multiport_Switch2_out1 <= FFT_HDL_Optimized_4096_out3 WHEN Selector_unsigned = to_unsigned(16#00#, 8) ELSE
      FFT_HDL_Optimized_8192_out3 WHEN Selector_unsigned = to_unsigned(16#01#, 8) ELSE
      FFT_HDL_Optimized_16384_out3 WHEN Selector_unsigned = to_unsigned(16#02#, 8) ELSE
      FFT_HDL_Optimized_32768_out3 WHEN Selector_unsigned = to_unsigned(16#03#, 8) ELSE
      FFT_HDL_Optimized_65536_out3;

  End_rsvd <= Multiport_Switch2_out1;

  
  Multiport_Switch3_out1 <= FFT_HDL_Optimized_4096_out4 WHEN Selector_unsigned = to_unsigned(16#00#, 8) ELSE
      FFT_HDL_Optimized_8192_out4 WHEN Selector_unsigned = to_unsigned(16#01#, 8) ELSE
      FFT_HDL_Optimized_16384_out4 WHEN Selector_unsigned = to_unsigned(16#02#, 8) ELSE
      FFT_HDL_Optimized_32768_out4 WHEN Selector_unsigned = to_unsigned(16#03#, 8) ELSE
